# Geomagnetism Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to geomagnetism. This includes tasks such as:
- analyze samples
- interpret data
- map features
...
1. The user explicitly requests characterization in the context of geomagnetism
...
4. The work involves geomagnetism methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of geomagnetism principles and methods
...
2. **Methodology**: Follow established geomagnetism protocols and best practices
...
- Adjacent geomagnetism skills for comprehensive analysis
...
7. Stay current with geomagnetism literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: geomagnetism
