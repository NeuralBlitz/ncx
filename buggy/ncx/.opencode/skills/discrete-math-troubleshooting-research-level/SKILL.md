# Discrete Math Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to discrete-math. This includes tasks such as:
- prove theorems
- analyze functions
- compute derivatives
...
1. The user explicitly requests troubleshooting in the context of discrete-math
