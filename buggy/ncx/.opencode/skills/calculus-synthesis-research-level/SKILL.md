# Calculus Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to calculus. This includes tasks such as:
- find eigenvalues
- prove theorems
- solve equations
...
1. The user explicitly requests synthesis in the context of calculus
