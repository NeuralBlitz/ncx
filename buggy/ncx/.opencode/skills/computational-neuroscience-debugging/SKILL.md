# Computational Neuroscience Debugging Skill

## Overview
This skill enables debugging in the domain of neuroscience (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to neuroscience. This includes tasks such as:
- sequence DNA
- study interactions
- measure expression
...
1. The user explicitly requests debugging in the context of neuroscience
