# Galactic Astronomy Design Research Level Skill

## Overview
This skill enables design in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to galactic-astronomy. This includes tasks such as:
- observe objects
- detect signals
- analyze spectra
...
1. The user explicitly requests design in the context of galactic-astronomy
