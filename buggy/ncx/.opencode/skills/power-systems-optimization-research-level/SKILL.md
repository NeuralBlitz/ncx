# Power Systems Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to power-systems. This includes tasks such as:
- design components
- optimize processes
- optimize processes
...
1. The user explicitly requests optimization in the context of power-systems
