# Extragalactic Astronomy Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to extragalactic-astronomy. This includes tasks such as:
- measure distances
- model phenomena
- measure distances
...
1. The user explicitly requests estimation in the context of extragalactic-astronomy
