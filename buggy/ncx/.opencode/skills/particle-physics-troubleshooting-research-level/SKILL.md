# Particle Physics Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to particle-physics. This includes tasks such as:
- model systems
- predict behavior
- model systems
...
1. The user explicitly requests troubleshooting in the context of particle-physics
