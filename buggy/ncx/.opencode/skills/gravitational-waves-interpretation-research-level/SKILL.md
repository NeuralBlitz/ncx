# Gravitational Waves Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to gravitational-waves. This includes tasks such as:
- measure distances
- detect signals
- measure distances
...
1. The user explicitly requests interpretation in the context of gravitational-waves
