# Geochemistry Earth Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of geochemistry-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to geochemistry-earth. This includes tasks such as:
- analyze samples
- map features
- analyze samples
...
1. The user explicitly requests simulation in the context of geochemistry-earth
