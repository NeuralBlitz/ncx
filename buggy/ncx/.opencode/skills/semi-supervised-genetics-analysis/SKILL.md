# Semi Supervised Genetics Analysis Skill

## Overview
This skill enables analysis in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to genetics. This includes tasks such as:
- classify organisms
- classify organisms
- study interactions
...
1. The user explicitly requests analysis in the context of genetics
