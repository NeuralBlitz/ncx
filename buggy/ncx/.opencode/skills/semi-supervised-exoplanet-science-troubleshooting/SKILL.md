# Semi Supervised Exoplanet Science Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to exoplanet-science. This includes tasks such as:
- model phenomena
- analyze spectra
- measure distances
...
1. The user explicitly requests troubleshooting in the context of exoplanet-science
