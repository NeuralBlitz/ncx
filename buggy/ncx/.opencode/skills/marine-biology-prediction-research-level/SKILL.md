# Marine Biology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of marine-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to marine-biology. This includes tasks such as:
- sequence DNA
- sequence DNA
- classify organisms
...
1. The user explicitly requests prediction in the context of marine-biology
