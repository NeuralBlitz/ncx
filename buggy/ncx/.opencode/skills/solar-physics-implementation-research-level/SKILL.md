# Solar Physics Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to solar-physics. This includes tasks such as:
- model phenomena
- detect signals
- calculate orbits
...
1. The user explicitly requests implementation in the context of solar-physics
