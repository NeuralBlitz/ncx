# Robotics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of robotics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to robotics. This includes tasks such as:
- train models
- optimize code
- design systems
...
1. The user explicitly requests derivation in the context of robotics
