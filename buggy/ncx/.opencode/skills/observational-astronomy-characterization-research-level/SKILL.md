# Observational Astronomy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of observational-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to observational-astronomy. This includes tasks such as:
- observe objects
- measure distances
- analyze spectra
...
1. The user explicitly requests characterization in the context of observational-astronomy
...
4. The work involves observational-astronomy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of observational-astronomy principles and methods
...
2. **Methodology**: Follow established observational-astronomy protocols and best practices
...
- Adjacent observational-astronomy skills for comprehensive analysis
...
7. Stay current with observational-astronomy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: observational-astronomy
