# Zoology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to zoology. This includes tasks such as:
- study interactions
- classify organisms
- model populations
...
1. The user explicitly requests debugging in the context of zoology
