# Mathematical Physics Testing Research Level Skill

## Overview
This skill enables testing in the domain of mathematical-physics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to mathematical-physics. This includes tasks such as:
- solve equations
- solve equations
- compute derivatives
...
1. The user explicitly requests testing in the context of mathematical-physics
