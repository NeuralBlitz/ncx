# Neurophysiology Design Research Level Skill

## Overview
This skill enables design in the domain of neurophysiology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to neurophysiology. This includes tasks such as:
- measure responses
- map connections
- model circuits
...
1. The user explicitly requests design in the context of neurophysiology
