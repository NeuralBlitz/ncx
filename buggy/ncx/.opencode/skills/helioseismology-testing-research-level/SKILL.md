# Helioseismology Testing Research Level Skill

## Overview
This skill enables testing in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to helioseismology. This includes tasks such as:
- analyze spectra
- observe objects
- observe objects
...
1. The user explicitly requests testing in the context of helioseismology
