# Machine Learning Design Research Level Skill

## Overview
This skill enables design in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to machine-learning. This includes tasks such as:
- optimize code
- analyze complexity
- design systems
...
1. The user explicitly requests design in the context of machine-learning
