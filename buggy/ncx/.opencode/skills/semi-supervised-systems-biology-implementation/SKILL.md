# Semi Supervised Systems Biology Implementation Skill

## Overview
This skill enables implementation in the domain of systems-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to systems-biology. This includes tasks such as:
- classify organisms
- study interactions
- classify organisms
...
1. The user explicitly requests implementation in the context of systems-biology
