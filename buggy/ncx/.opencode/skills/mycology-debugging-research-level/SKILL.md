# Mycology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of mycology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to mycology. This includes tasks such as:
- classify organisms
- measure expression
- analyze proteins
...
1. The user explicitly requests debugging in the context of mycology
