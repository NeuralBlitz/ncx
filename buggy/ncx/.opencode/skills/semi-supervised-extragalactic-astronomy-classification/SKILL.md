# Semi Supervised Extragalactic Astronomy Classification Skill

## Overview
This skill enables classification in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to extragalactic-astronomy. This includes tasks such as:
- detect signals
- measure distances
- model phenomena
...
1. The user explicitly requests classification in the context of extragalactic-astronomy
