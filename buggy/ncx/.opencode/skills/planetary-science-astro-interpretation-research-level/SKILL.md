# Planetary Science Astro Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to planetary-science-astro. This includes tasks such as:
- model phenomena
- analyze spectra
- measure distances
...
1. The user explicitly requests interpretation in the context of planetary-science-astro
