# Stellar Astronomy Design Research Level Skill

## Overview
This skill enables design in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to stellar-astronomy. This includes tasks such as:
- model phenomena
- calculate orbits
- model phenomena
...
1. The user explicitly requests design in the context of stellar-astronomy
