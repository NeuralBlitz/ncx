# Meteorology Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of meteorology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to meteorology. This includes tasks such as:
- interpret data
- analyze samples
- map features
...
1. The user explicitly requests measurement in the context of meteorology
