# Stellar Astronomy Testing Research Level Skill

## Overview
This skill enables testing in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to stellar-astronomy. This includes tasks such as:
- model phenomena
- observe objects
- detect signals
...
1. The user explicitly requests testing in the context of stellar-astronomy
