# Unsupervised Tectonics Synthesis Skill

## Overview
This skill enables synthesis in the domain of tectonics (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
