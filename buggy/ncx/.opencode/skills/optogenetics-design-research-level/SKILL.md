# Optogenetics Design Research Level Skill

## Overview
This skill enables design in the domain of optogenetics (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to optogenetics. This includes tasks such as:
- model circuits
- map connections
- study behavior
...
1. The user explicitly requests design in the context of optogenetics
