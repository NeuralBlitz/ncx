# Mineralogy Verification Research Level Skill

## Overview
This skill enables verification in the domain of mineralogy (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to mineralogy. This includes tasks such as:
- map features
- interpret data
- measure properties
...
1. The user explicitly requests verification in the context of mineralogy
