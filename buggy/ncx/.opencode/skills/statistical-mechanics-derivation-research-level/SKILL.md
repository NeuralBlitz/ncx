# Statistical Mechanics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of statistical-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to statistical-mechanics. This includes tasks such as:
- analyze motion
- measure quantities
- model systems
...
1. The user explicitly requests derivation in the context of statistical-mechanics
