# Petrology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to petrology. This includes tasks such as:
- model processes
- predict events
- interpret data
...
1. The user explicitly requests characterization in the context of petrology
...
4. The work involves petrology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of petrology principles and methods
...
2. **Methodology**: Follow established petrology protocols and best practices
...
- Adjacent petrology skills for comprehensive analysis
...
7. Stay current with petrology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: petrology
