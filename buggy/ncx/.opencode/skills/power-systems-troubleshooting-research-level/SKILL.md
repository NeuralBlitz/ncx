# Power Systems Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to power-systems. This includes tasks such as:
- analyze structures
- analyze structures
- design components
...
1. The user explicitly requests troubleshooting in the context of power-systems
