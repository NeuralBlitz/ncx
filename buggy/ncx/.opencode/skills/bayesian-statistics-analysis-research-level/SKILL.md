# Bayesian Statistics Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of bayesian-statistics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to bayesian-statistics. This includes tasks such as:
- analyze datasets
- extract features
- predict outcomes
...
1. The user explicitly requests analysis in the context of bayesian-statistics
