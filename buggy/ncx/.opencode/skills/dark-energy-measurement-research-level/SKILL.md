# Dark Energy Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to dark-energy. This includes tasks such as:
- analyze spectra
- measure distances
- detect signals
...
1. The user explicitly requests measurement in the context of dark-energy
