# Astrophotography Verification Research Level Skill

## Overview
This skill enables verification in the domain of astrophotography (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to astrophotography. This includes tasks such as:
- model phenomena
- detect signals
- measure distances
...
1. The user explicitly requests verification in the context of astrophotography
