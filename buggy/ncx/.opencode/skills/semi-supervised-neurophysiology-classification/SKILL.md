# Semi Supervised Neurophysiology Classification Skill

## Overview
This skill enables classification in the domain of neurophysiology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to neurophysiology. This includes tasks such as:
- measure responses
- model circuits
...
1. The user explicitly requests classification in the context of neurophysiology
