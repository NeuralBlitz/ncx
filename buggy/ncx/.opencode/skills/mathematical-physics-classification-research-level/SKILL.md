# Mathematical Physics Classification Research Level Skill

## Overview
This skill enables classification in the domain of mathematical-physics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to mathematical-physics. This includes tasks such as:
- find eigenvalues
- solve equations
- compute derivatives
...
1. The user explicitly requests classification in the context of mathematical-physics
