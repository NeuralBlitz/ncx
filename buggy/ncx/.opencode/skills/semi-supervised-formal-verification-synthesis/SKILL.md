# Semi Supervised Formal Verification Synthesis Skill

## Overview
This skill enables synthesis in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to formal-verification. This includes tasks such as:
- design systems
- debug programs
...
1. The user explicitly requests synthesis in the context of formal-verification
