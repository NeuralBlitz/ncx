# Semi Supervised Differential Equations Synthesis Skill

## Overview
This skill enables synthesis in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to differential-equations. This includes tasks such as:
- prove theorems
- analyze functions
- calculate integrals
...
1. The user explicitly requests synthesis in the context of differential-equations
