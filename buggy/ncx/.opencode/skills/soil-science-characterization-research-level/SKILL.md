# Soil Science Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to soil-science. This includes tasks such as:
- model processes
- interpret data
- model processes
...
1. The user explicitly requests characterization in the context of soil-science
...
4. The work involves soil-science methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of soil-science principles and methods
...
2. **Methodology**: Follow established soil-science protocols and best practices
...
- Adjacent soil-science skills for comprehensive analysis
...
7. Stay current with soil-science literature and methods
