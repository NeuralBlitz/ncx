# Molecular Neuroscience Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of molecular-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to molecular-neuroscience. This includes tasks such as:
- study behavior
- map connections
- measure responses
...
1. The user explicitly requests characterization in the context of molecular-neuroscience
