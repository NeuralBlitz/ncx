# Semi Supervised Particle Physics Prediction Skill

## Overview
This skill enables prediction in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to particle-physics. This includes tasks such as:
- calculate forces
...
1. The user explicitly requests prediction in the context of particle-physics
