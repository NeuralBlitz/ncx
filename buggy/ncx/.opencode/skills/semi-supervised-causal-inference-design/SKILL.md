# Semi Supervised Causal Inference Design Skill

## Overview
This skill enables design in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to causal-inference. This includes tasks such as:
- test hypotheses
- analyze datasets
- visualize data
...
1. The user explicitly requests design in the context of causal-inference
