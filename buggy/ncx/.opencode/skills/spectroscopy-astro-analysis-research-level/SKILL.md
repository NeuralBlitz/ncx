# Spectroscopy Astro Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to spectroscopy-astro. This includes tasks such as:
- observe objects
- observe objects
- model phenomena
...
1. The user explicitly requests analysis in the context of spectroscopy-astro
