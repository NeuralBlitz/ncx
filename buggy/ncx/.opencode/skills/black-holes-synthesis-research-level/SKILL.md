# Black Holes Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to black-holes. This includes tasks such as:
- detect signals
- analyze spectra
- observe objects
...
1. The user explicitly requests synthesis in the context of black-holes
