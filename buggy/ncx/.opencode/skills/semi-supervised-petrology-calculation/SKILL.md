# Semi Supervised Petrology Calculation Skill

## Overview
This skill enables calculation in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to petrology. This includes tasks such as:
- analyze samples
- interpret data
- model processes
...
1. The user explicitly requests calculation in the context of petrology
