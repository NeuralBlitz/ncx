# Glaciology Testing Intermediate Skill

## Overview
This skill enables testing in the domain of glaciology (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.
