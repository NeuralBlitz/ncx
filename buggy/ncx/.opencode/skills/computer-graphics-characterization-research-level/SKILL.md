# Computer Graphics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of computer-graphics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to computer-graphics. This includes tasks such as:
- design systems
- optimize code
- debug programs
...
1. The user explicitly requests characterization in the context of computer-graphics
...
4. The work involves computer-graphics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of computer-graphics principles and methods
...
2. **Methodology**: Follow established computer-graphics protocols and best practices
...
- Adjacent computer-graphics skills for comprehensive analysis
...
7. Stay current with computer-graphics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: computer-science
- Subdiscipline: computer-graphics
