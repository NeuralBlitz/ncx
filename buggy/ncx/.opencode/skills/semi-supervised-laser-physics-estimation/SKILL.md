# Semi Supervised Laser Physics Estimation Skill

## Overview
This skill enables estimation in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to laser-physics. This includes tasks such as:
- measure quantities
- measure quantities
- model systems
...
1. The user explicitly requests estimation in the context of laser-physics
