# Computer Graphics Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of computer-graphics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to computer-graphics. This includes tasks such as:
- optimize code
- design systems
- analyze complexity
...
1. The user explicitly requests synthesis in the context of computer-graphics
