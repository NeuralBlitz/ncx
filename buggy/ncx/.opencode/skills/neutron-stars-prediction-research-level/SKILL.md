# Neutron Stars Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to neutron-stars. This includes tasks such as:
- observe objects
- detect signals
- model phenomena
...
1. The user explicitly requests prediction in the context of neutron-stars
