# Semi Supervised Biophysics Debugging Skill

## Overview
This skill enables debugging in the domain of biophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to biophysics. This includes tasks such as:
...
1. The user explicitly requests debugging in the context of biophysics
