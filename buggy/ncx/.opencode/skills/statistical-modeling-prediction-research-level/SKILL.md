# Statistical Modeling Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to statistical-modeling. This includes tasks such as:
- test hypotheses
- extract features
- visualize data
...
1. The user explicitly requests prediction in the context of statistical-modeling
