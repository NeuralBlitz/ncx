# Fluid Mechanics Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of fluid-mechanics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to fluid-mechanics. This includes tasks such as:
- validate designs
- design components
- analyze structures
...
1. The user explicitly requests calculation in the context of fluid-mechanics
