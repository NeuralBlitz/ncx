# Feature Engineering Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to feature-engineering. This includes tasks such as:
- build models
- test hypotheses
- build models
...
1. The user explicitly requests prediction in the context of feature-engineering
