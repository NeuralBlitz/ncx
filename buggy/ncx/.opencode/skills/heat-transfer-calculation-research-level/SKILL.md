# Heat Transfer Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to heat-transfer. This includes tasks such as:
- design components
- analyze structures
- design components
...
1. The user explicitly requests calculation in the context of heat-transfer
