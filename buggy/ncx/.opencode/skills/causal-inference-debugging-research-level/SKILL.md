# Causal Inference Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to causal-inference. This includes tasks such as:
- build models
- test hypotheses
- predict outcomes
...
1. The user explicitly requests debugging in the context of causal-inference
