# Particle Physics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to particle-physics. This includes tasks such as:
- model systems
- analyze motion
- measure quantities
...
1. The user explicitly requests simulation in the context of particle-physics
