# Semi Supervised Experimental Design Measurement Skill

## Overview
This skill enables measurement in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to experimental-design. This includes tasks such as:
- visualize data
- extract features
- extract features
...
1. The user explicitly requests measurement in the context of experimental-design
