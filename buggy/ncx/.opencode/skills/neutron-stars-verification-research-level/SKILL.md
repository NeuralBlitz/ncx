# Neutron Stars Verification Research Level Skill

## Overview
This skill enables verification in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to neutron-stars. This includes tasks such as:
- measure distances
- detect signals
- measure distances
...
1. The user explicitly requests verification in the context of neutron-stars
