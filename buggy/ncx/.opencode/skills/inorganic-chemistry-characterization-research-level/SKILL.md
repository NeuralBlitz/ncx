# Inorganic Chemistry Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of inorganic-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to inorganic-chemistry. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of inorganic-chemistry
...
4. The work involves inorganic-chemistry methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of inorganic-chemistry principles and methods
...
2. **Methodology**: Follow established inorganic-chemistry protocols and best practices
...
- Adjacent inorganic-chemistry skills for comprehensive analysis
...
7. Stay current with inorganic-chemistry literature and methods
