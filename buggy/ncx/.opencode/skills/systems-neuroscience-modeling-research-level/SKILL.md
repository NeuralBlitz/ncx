# Systems Neuroscience Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of systems-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to systems-neuroscience. This includes tasks such as:
- map connections
...
1. The user explicitly requests modeling in the context of systems-neuroscience
