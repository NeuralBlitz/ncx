# Feature Engineering Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to feature-engineering. This includes tasks such as:
- build models
- analyze datasets
- visualize data
...
1. The user explicitly requests derivation in the context of feature-engineering
