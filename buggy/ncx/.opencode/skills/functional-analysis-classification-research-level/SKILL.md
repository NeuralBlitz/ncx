# Functional Analysis Classification Research Level Skill

## Overview
This skill enables classification in the domain of functional-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to functional-analysis. This includes tasks such as:
- compute derivatives
- find eigenvalues
- analyze functions
...
1. The user explicitly requests classification in the context of functional-analysis
