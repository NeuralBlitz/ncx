# Number Theory Classification Research Level Skill

## Overview
This skill enables classification in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to number-theory. This includes tasks such as:
- solve equations
- compute derivatives
- compute derivatives
...
1. The user explicitly requests classification in the context of number-theory
