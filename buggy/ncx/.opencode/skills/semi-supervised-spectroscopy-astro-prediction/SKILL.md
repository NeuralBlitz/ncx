# Semi Supervised Spectroscopy Astro Prediction Skill

## Overview
This skill enables prediction in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to spectroscopy-astro. This includes tasks such as:
- detect signals
- detect signals
- analyze spectra
...
1. The user explicitly requests prediction in the context of spectroscopy-astro
