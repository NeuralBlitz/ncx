# Electromagnetism Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of electromagnetism (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to electromagnetism. This includes tasks such as:
- predict behavior
- analyze motion
- predict behavior
...
1. The user explicitly requests estimation in the context of electromagnetism
