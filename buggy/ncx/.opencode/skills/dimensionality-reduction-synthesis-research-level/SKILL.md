# Dimensionality Reduction Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of dimensionality-reduction (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to dimensionality-reduction. This includes tasks such as:
- build models
- test hypotheses
- test hypotheses
...
1. The user explicitly requests synthesis in the context of dimensionality-reduction
