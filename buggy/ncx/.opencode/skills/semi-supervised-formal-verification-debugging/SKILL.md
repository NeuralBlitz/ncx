# Semi Supervised Formal Verification Debugging Skill

## Overview
This skill enables debugging in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to formal-verification. This includes tasks such as:
- debug programs
- design systems
...
1. The user explicitly requests debugging in the context of formal-verification
