# Topology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of topology (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to topology. This includes tasks such as:
- solve equations
- compute derivatives
- analyze functions
...
1. The user explicitly requests simulation in the context of topology
