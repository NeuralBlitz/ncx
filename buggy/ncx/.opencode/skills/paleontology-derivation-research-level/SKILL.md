# Paleontology Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of paleontology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to paleontology. This includes tasks such as:
- interpret data
- analyze samples
- measure properties
...
1. The user explicitly requests derivation in the context of paleontology
