# Probability Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to probability. This includes tasks such as:
- calculate integrals
- find eigenvalues
- calculate integrals
...
1. The user explicitly requests characterization in the context of probability
...
4. The work involves probability methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of probability principles and methods
...
2. **Methodology**: Follow established probability protocols and best practices
...
- Adjacent probability skills for comprehensive analysis
...
7. Stay current with probability literature and methods

## Version Information
- Complexity Level: research-level
- Domain: mathematics
- Subdiscipline: probability
