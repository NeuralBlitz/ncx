# Cognitive Neuroscience Testing Research Level Skill

## Overview
This skill enables testing in the domain of cognitive-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to cognitive-neuroscience. This includes tasks such as:
- study behavior
- study behavior
- measure responses
...
1. The user explicitly requests testing in the context of cognitive-neuroscience
