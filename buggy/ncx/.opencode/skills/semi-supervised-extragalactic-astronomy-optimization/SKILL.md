# Semi Supervised Extragalactic Astronomy Optimization Skill

## Overview
This skill enables optimization in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to extragalactic-astronomy. This includes tasks such as:
- measure distances
- analyze spectra
- measure distances
...
1. The user explicitly requests optimization in the context of extragalactic-astronomy
