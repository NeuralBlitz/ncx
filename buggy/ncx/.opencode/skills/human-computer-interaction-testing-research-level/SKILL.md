# Human Computer Interaction Testing Research Level Skill

## Overview
This skill enables testing in the domain of human-computer-interaction (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to human-computer-interaction. This includes tasks such as:
- design systems
...
1. The user explicitly requests testing in the context of human-computer-interaction
