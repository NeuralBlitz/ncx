# Probability Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to probability. This includes tasks such as:
- analyze functions
- compute derivatives
- prove theorems
...
1. The user explicitly requests analysis in the context of probability
