# Laser Physics Validation Research Level Skill

## Overview
This skill enables validation in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to laser-physics. This includes tasks such as:
- measure quantities
- calculate forces
- measure quantities
...
1. The user explicitly requests validation in the context of laser-physics
