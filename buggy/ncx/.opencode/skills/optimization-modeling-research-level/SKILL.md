# Optimization Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of optimization (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to optimization. This includes tasks such as:
- solve equations
- analyze functions
- compute derivatives
...
1. The user explicitly requests modeling in the context of optimization
