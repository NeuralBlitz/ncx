# Electromagnetism Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of electromagnetism (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to electromagnetism. This includes tasks such as:
- predict behavior
- predict behavior
- model systems
...
1. The user explicitly requests prediction in the context of electromagnetism
