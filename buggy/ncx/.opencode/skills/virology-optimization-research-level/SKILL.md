# Virology Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of virology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to virology. This includes tasks such as:
- model populations
- analyze proteins
- classify organisms
...
1. The user explicitly requests optimization in the context of virology
