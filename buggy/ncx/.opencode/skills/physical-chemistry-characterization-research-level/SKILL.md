# Physical Chemistry Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of physical-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to physical-chemistry. This includes tasks such as:
- predict reactions
...
1. The user explicitly requests characterization in the context of physical-chemistry
...
4. The work involves physical-chemistry methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of physical-chemistry principles and methods
...
2. **Methodology**: Follow established physical-chemistry protocols and best practices
...
- Adjacent physical-chemistry skills for comprehensive analysis
...
7. Stay current with physical-chemistry literature and methods
