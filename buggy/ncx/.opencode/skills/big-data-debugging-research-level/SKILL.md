# Big Data Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of big-data (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to big-data. This includes tasks such as:
- analyze datasets
- build models
- test hypotheses
...
1. The user explicitly requests debugging in the context of big-data
