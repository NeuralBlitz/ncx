# Semi Supervised Environmental Engineering Measurement Skill

## Overview
This skill enables measurement in the domain of environmental-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to environmental-engineering. This includes tasks such as:
- analyze structures
- validate designs
...
1. The user explicitly requests measurement in the context of environmental-engineering
