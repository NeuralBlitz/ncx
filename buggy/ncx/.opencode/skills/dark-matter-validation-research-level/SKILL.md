# Dark Matter Validation Research Level Skill

## Overview
This skill enables validation in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to dark-matter. This includes tasks such as:
- detect signals
- detect signals
- model phenomena
...
1. The user explicitly requests validation in the context of dark-matter
