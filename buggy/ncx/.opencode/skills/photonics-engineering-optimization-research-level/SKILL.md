# Photonics Engineering Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of photonics-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to photonics-engineering. This includes tasks such as:
- analyze structures
- test prototypes
- analyze structures
...
1. The user explicitly requests optimization in the context of photonics-engineering
