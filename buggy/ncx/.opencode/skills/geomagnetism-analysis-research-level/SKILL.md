# Geomagnetism Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to geomagnetism. This includes tasks such as:
- map features
- map features
- predict events
...
1. The user explicitly requests analysis in the context of geomagnetism
