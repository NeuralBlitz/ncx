# Data Mining Validation Research Level Skill

## Overview
This skill enables validation in the domain of data-mining (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to data-mining. This includes tasks such as:
- extract features
- visualize data
- test hypotheses
...
1. The user explicitly requests validation in the context of data-mining
