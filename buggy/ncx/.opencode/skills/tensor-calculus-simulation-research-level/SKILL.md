# Tensor Calculus Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to tensor-calculus. This includes tasks such as:
- compute derivatives
- find eigenvalues
- analyze functions
...
1. The user explicitly requests simulation in the context of tensor-calculus
