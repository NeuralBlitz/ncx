# Compiler Design Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of compiler-design (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.
...
1. The user explicitly requests prediction in the context of compiler-design
