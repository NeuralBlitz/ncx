# Parametric Astrometry Verification Skill

## Overview
This skill enables verification in the domain of astrometry (astronomy). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.
