# Computational Biology Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of computational-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to computational-biology. This includes tasks such as:
- study interactions
- classify organisms
- analyze proteins
...
1. The user explicitly requests analysis in the context of computational-biology
