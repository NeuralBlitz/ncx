# Natural Language Processing Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of natural-language-processing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to natural-language-processing. This includes tasks such as:
- design systems
- analyze complexity
- optimize code
...
1. The user explicitly requests synthesis in the context of natural-language-processing
