# Genetics Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to genetics. This includes tasks such as:
- measure expression
- sequence DNA
- sequence DNA
...
1. The user explicitly requests calculation in the context of genetics
