# Stochastic Complex Analysis Verification Skill

## Overview
This skill enables verification in the domain of complex-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to complex-analysis. This includes tasks such as:
- analyze functions
- prove theorems
- compute derivatives
...
1. The user explicitly requests verification in the context of complex-analysis
