# Atmospheric Science Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of atmospheric-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to atmospheric-science. This includes tasks such as:
- measure properties
- predict events
- predict events
...
1. The user explicitly requests implementation in the context of atmospheric-science
