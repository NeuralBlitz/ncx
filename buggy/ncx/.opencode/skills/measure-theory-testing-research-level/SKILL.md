# Measure Theory Testing Research Level Skill

## Overview
This skill enables testing in the domain of measure-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to measure-theory. This includes tasks such as:
- calculate integrals
- prove theorems
- analyze functions
...
1. The user explicitly requests testing in the context of measure-theory
