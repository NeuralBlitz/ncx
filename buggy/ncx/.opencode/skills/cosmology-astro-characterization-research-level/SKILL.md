# Cosmology Astro Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to cosmology-astro. This includes tasks such as:
- calculate orbits
- measure distances
- observe objects
...
1. The user explicitly requests characterization in the context of cosmology-astro
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves cosmology-astro methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of cosmology-astro principles and methods
...
2. **Methodology**: Follow established cosmology-astro protocols and best practices
...
- Adjacent cosmology-astro skills for comprehensive analysis
...
7. Stay current with cosmology-astro literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: cosmology-astro
