# Programming Languages Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of programming-languages (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to programming-languages. This includes tasks such as:
- analyze complexity
- design systems
...
1. The user explicitly requests estimation in the context of programming-languages
