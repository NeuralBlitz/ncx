# Data Pipelines Design Research Level Skill

## Overview
This skill enables design in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to data-pipelines. This includes tasks such as:
- build models
- predict outcomes
- test hypotheses
...
1. The user explicitly requests design in the context of data-pipelines
