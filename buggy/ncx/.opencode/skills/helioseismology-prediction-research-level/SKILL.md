# Helioseismology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to helioseismology. This includes tasks such as:
- detect signals
- analyze spectra
- observe objects
...
1. The user explicitly requests prediction in the context of helioseismology
