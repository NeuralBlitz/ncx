# Galactic Astronomy Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to galactic-astronomy. This includes tasks such as:
- calculate orbits
- observe objects
- analyze spectra
...
1. The user explicitly requests estimation in the context of galactic-astronomy
