# Number Theory Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to number-theory. This includes tasks such as:
- find eigenvalues
- find eigenvalues
- solve equations
...
1. The user explicitly requests characterization in the context of number-theory
