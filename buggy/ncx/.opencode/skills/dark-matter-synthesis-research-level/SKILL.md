# Dark Matter Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to dark-matter. This includes tasks such as:
- analyze spectra
- calculate orbits
- analyze spectra
...
1. The user explicitly requests synthesis in the context of dark-matter
