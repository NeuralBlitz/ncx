# Quantum Chemistry Verification Research Level Skill

## Overview
This skill enables verification in the domain of quantum-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to quantum-chemistry. This includes tasks such as:
- analyze spectra
- predict reactions
- analyze spectra
...
1. The user explicitly requests verification in the context of quantum-chemistry
