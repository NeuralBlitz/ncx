# Dark Matter Design Research Level Skill

## Overview
This skill enables design in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to dark-matter. This includes tasks such as:
- analyze spectra
- model phenomena
- detect signals
...
1. The user explicitly requests design in the context of dark-matter
