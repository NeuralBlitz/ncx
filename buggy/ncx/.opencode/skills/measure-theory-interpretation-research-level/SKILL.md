# Measure Theory Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of measure-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to measure-theory. This includes tasks such as:
- prove theorems
- prove theorems
- compute derivatives
...
1. The user explicitly requests interpretation in the context of measure-theory
