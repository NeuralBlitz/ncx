# Unsupervised Power Systems Design Skill

## Overview
This skill enables design in the domain of power-systems (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
