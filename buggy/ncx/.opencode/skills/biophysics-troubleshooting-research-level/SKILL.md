# Biophysics Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of biophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to biophysics. This includes tasks such as:
- predict behavior
- analyze motion
- calculate forces
...
1. The user explicitly requests troubleshooting in the context of biophysics
