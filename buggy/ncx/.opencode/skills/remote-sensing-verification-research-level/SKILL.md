# Remote Sensing Verification Research Level Skill

## Overview
This skill enables verification in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to remote-sensing. This includes tasks such as:
- model processes
- measure properties
- interpret data
...
1. The user explicitly requests verification in the context of remote-sensing
