# Galactic Astronomy Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to galactic-astronomy. This includes tasks such as:
- measure distances
- model phenomena
- detect signals
...
1. The user explicitly requests debugging in the context of galactic-astronomy
