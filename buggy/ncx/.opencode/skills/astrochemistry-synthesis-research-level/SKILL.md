# Astrochemistry Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of astrochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to astrochemistry. This includes tasks such as:
- predict reactions
- optimize yields
- analyze spectra
...
1. The user explicitly requests synthesis in the context of astrochemistry
