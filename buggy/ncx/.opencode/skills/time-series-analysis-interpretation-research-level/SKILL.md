# Time Series Analysis Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to time-series-analysis. This includes tasks such as:
- predict outcomes
- test hypotheses
- build models
...
1. The user explicitly requests interpretation in the context of time-series-analysis
