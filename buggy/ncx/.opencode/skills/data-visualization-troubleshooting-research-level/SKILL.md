# Data Visualization Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of data-visualization (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to data-visualization. This includes tasks such as:
- visualize data
- build models
- visualize data
...
1. The user explicitly requests troubleshooting in the context of data-visualization
