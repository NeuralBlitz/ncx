# Plasma Physics Classification Research Level Skill

## Overview
This skill enables classification in the domain of plasma-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to plasma-physics. This includes tasks such as:
- predict behavior
- model systems
- analyze motion
...
1. The user explicitly requests classification in the context of plasma-physics
