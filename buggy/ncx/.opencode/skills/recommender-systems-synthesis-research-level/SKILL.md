# Recommender Systems Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of recommender-systems (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to recommender-systems. This includes tasks such as:
- visualize data
- predict outcomes
- visualize data
...
1. The user explicitly requests synthesis in the context of recommender-systems
