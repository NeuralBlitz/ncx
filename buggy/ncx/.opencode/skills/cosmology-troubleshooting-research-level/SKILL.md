# Cosmology Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of cosmology (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to cosmology. This includes tasks such as:
- model systems
- calculate forces
- predict behavior
...
1. The user explicitly requests troubleshooting in the context of cosmology
