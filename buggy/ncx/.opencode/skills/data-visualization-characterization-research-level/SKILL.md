# Data Visualization Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of data-visualization (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to data-visualization. This includes tasks such as:
- build models
- build models
- visualize data
...
1. The user explicitly requests characterization in the context of data-visualization
...
4. The work involves data-visualization methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of data-visualization principles and methods
...
2. **Methodology**: Follow established data-visualization protocols and best practices
...
- Adjacent data-visualization skills for comprehensive analysis
...
7. Stay current with data-visualization literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: data-visualization
