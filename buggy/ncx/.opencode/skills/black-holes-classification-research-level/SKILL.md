# Black Holes Classification Research Level Skill

## Overview
This skill enables classification in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to black-holes. This includes tasks such as:
- analyze spectra
- calculate orbits
- analyze spectra
...
1. The user explicitly requests classification in the context of black-holes
