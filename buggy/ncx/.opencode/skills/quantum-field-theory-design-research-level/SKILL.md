# Quantum Field Theory Design Research Level Skill

## Overview
This skill enables design in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to quantum-field-theory. This includes tasks such as:
- measure quantities
- analyze motion
- measure quantities
...
1. The user explicitly requests design in the context of quantum-field-theory
