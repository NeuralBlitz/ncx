# Data Pipelines Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to data-pipelines. This includes tasks such as:
- visualize data
- build models
- visualize data
...
1. The user explicitly requests synthesis in the context of data-pipelines
