# Topology Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of topology (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to topology. This includes tasks such as:
- analyze functions
- solve equations
- find eigenvalues
...
1. The user explicitly requests measurement in the context of topology
