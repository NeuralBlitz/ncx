# Laser Physics Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to laser-physics. This includes tasks such as:
- predict behavior
- predict behavior
- model systems
...
1. The user explicitly requests calculation in the context of laser-physics
