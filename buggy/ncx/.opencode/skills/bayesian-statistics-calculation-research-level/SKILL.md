# Bayesian Statistics Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of bayesian-statistics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to bayesian-statistics. This includes tasks such as:
- test hypotheses
- build models
- test hypotheses
...
1. The user explicitly requests calculation in the context of bayesian-statistics
