# Extragalactic Astronomy Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to extragalactic-astronomy. This includes tasks such as:
- model phenomena
- detect signals
- model phenomena
...
1. The user explicitly requests modeling in the context of extragalactic-astronomy
