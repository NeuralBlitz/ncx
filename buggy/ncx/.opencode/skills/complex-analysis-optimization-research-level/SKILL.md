# Complex Analysis Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of complex-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to complex-analysis. This includes tasks such as:
- compute derivatives
- analyze functions
- prove theorems
...
1. The user explicitly requests optimization in the context of complex-analysis
