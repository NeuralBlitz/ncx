# Remote Sensing Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to remote-sensing. This includes tasks such as:
- analyze samples
- analyze samples
- model processes
...
1. The user explicitly requests measurement in the context of remote-sensing
