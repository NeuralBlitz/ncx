# Compiler Design Design Research Level Skill

## Overview
This skill enables design in the domain of compiler-design (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to compiler-design. This includes tasks such as:
- design systems
- optimize code
- debug programs
...
1. The user explicitly requests design in the context of compiler-design
