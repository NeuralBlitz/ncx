# Geomagnetism Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to geomagnetism. This includes tasks such as:
- predict events
- predict events
- map features
...
1. The user explicitly requests simulation in the context of geomagnetism
