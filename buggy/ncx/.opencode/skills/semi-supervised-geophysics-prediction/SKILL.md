# Semi Supervised Geophysics Prediction Skill

## Overview
This skill enables prediction in the domain of geophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to geophysics. This includes tasks such as:
- model systems
- predict behavior
- measure quantities
...
1. The user explicitly requests prediction in the context of geophysics
