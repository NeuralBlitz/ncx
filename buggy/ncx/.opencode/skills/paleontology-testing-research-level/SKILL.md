# Paleontology Testing Research Level Skill

## Overview
This skill enables testing in the domain of paleontology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to paleontology. This includes tasks such as:
- model processes
- interpret data
- model processes
...
1. The user explicitly requests testing in the context of paleontology
