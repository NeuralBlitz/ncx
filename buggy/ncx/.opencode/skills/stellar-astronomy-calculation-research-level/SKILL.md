# Stellar Astronomy Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to stellar-astronomy. This includes tasks such as:
- analyze spectra
- analyze spectra
- model phenomena
...
1. The user explicitly requests calculation in the context of stellar-astronomy
