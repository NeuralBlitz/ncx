# Differential Equations Verification Research Level Skill

## Overview
This skill enables verification in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to differential-equations. This includes tasks such as:
- analyze functions
- calculate integrals
- prove theorems
...
1. The user explicitly requests verification in the context of differential-equations
