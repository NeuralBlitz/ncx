# Gravitational Waves Testing Research Level Skill

## Overview
This skill enables testing in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to gravitational-waves. This includes tasks such as:
- calculate orbits
- analyze spectra
- detect signals
...
1. The user explicitly requests testing in the context of gravitational-waves
