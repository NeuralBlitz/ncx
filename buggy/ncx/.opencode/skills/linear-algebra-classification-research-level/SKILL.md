# Linear Algebra Classification Research Level Skill

## Overview
This skill enables classification in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to linear-algebra. This includes tasks such as:
- prove theorems
- calculate integrals
- analyze functions
...
1. The user explicitly requests classification in the context of linear-algebra
