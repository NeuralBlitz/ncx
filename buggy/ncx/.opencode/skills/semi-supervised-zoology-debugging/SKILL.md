# Semi Supervised Zoology Debugging Skill

## Overview
This skill enables debugging in the domain of zoology (biology). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
