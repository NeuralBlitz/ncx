# Cognitive Neuroscience Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of cognitive-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to cognitive-neuroscience. This includes tasks such as:
- measure responses
- map connections
...
1. The user explicitly requests implementation in the context of cognitive-neuroscience
