# Cognitive Neuroscience Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of cognitive-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to cognitive-neuroscience. This includes tasks such as:
- map connections
- study behavior
- model circuits
...
1. The user explicitly requests measurement in the context of cognitive-neuroscience
