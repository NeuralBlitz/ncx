# Human Computer Interaction Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of human-computer-interaction (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to human-computer-interaction. This includes tasks such as:
- train models
- debug programs
- optimize code
...
1. The user explicitly requests characterization in the context of human-computer-interaction
...
4. The work involves human-computer-interaction methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of human-computer-interaction principles and methods
...
2. **Methodology**: Follow established human-computer-interaction protocols and best practices
...
- Adjacent human-computer-interaction skills for comprehensive analysis
...
7. Stay current with human-computer-interaction literature and methods

## Version Information
- Complexity Level: research-level
- Domain: computer-science
- Subdiscipline: human-computer-interaction
