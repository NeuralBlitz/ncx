# Glaciology Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to glaciology. This includes tasks such as:
- model processes
- measure properties
- predict events
...
1. The user explicitly requests analysis in the context of glaciology
