# Quantum Mechanics Verification Research Level Skill

## Overview
This skill enables verification in the domain of quantum-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to quantum-mechanics. This includes tasks such as:
- measure quantities
- model systems
- calculate forces
...
1. The user explicitly requests verification in the context of quantum-mechanics
