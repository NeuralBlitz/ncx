# Observational Astronomy Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of observational-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to observational-astronomy. This includes tasks such as:
- measure distances
- analyze spectra
- detect signals
...
1. The user explicitly requests simulation in the context of observational-astronomy
