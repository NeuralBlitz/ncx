# Electromagnetism Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of electromagnetism (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to electromagnetism. This includes tasks such as:
- calculate forces
- analyze motion
- predict behavior
...
1. The user explicitly requests modeling in the context of electromagnetism
