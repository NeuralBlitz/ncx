# Semi Supervised Surface Chemistry Calculation Skill

## Overview
This skill enables calculation in the domain of surface-chemistry (chemistry). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.
