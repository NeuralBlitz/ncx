# Semi Supervised Extragalactic Astronomy Analysis Skill

## Overview
This skill enables analysis in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to extragalactic-astronomy. This includes tasks such as:
- analyze spectra
- observe objects
- observe objects
...
1. The user explicitly requests analysis in the context of extragalactic-astronomy
