# Semi Supervised Atmospheric Science Analysis Skill

## Overview
This skill enables analysis in the domain of atmospheric-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to atmospheric-science. This includes tasks such as:
- analyze samples
- analyze samples
- measure properties
...
1. The user explicitly requests analysis in the context of atmospheric-science
