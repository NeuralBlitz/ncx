# Functional Analysis Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of functional-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to functional-analysis. This includes tasks such as:
- calculate integrals
- prove theorems
- find eigenvalues
...
1. The user explicitly requests characterization in the context of functional-analysis
...
4. The work involves functional-analysis methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of functional-analysis principles and methods
...
2. **Methodology**: Follow established functional-analysis protocols and best practices
...
- Adjacent functional-analysis skills for comprehensive analysis
...
7. Stay current with functional-analysis literature and methods

## Version Information
- Complexity Level: research-level
- Domain: mathematics
- Subdiscipline: functional-analysis
