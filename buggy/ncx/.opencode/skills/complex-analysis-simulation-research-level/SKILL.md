# Complex Analysis Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of complex-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to complex-analysis. This includes tasks such as:
- prove theorems
- find eigenvalues
- compute derivatives
...
1. The user explicitly requests simulation in the context of complex-analysis
