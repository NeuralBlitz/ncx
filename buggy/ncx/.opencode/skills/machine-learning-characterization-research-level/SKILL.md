# Machine Learning Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to machine-learning. This includes tasks such as:
- design systems
...
1. The user explicitly requests characterization in the context of machine-learning
...
4. The work involves machine-learning methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of machine-learning principles and methods
...
2. **Methodology**: Follow established machine-learning protocols and best practices
...
- Adjacent machine-learning skills for comprehensive analysis
...
7. Stay current with machine-learning literature and methods
