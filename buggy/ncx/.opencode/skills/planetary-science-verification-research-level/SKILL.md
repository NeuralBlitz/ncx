# Planetary Science Verification Research Level Skill

## Overview
This skill enables verification in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to planetary-science. This includes tasks such as:
- analyze samples
- model processes
- predict events
...
1. The user explicitly requests verification in the context of planetary-science
