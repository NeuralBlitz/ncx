# Machine Learning Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to machine-learning. This includes tasks such as:
- optimize code
- train models
- design systems
...
1. The user explicitly requests synthesis in the context of machine-learning
