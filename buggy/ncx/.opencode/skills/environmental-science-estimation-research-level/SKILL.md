# Environmental Science Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of environmental-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to environmental-science. This includes tasks such as:
- measure properties
- map features
- model processes
...
1. The user explicitly requests estimation in the context of environmental-science
