# Semi Supervised Particle Physics Measurement Skill

## Overview
This skill enables measurement in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to particle-physics. This includes tasks such as:
- measure quantities
- calculate forces
- predict behavior
...
1. The user explicitly requests measurement in the context of particle-physics
