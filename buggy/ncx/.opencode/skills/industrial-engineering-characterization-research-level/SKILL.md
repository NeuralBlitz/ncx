# Industrial Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of industrial-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to industrial-engineering. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of industrial-engineering
...
4. The work involves industrial-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of industrial-engineering principles and methods
...
2. **Methodology**: Follow established industrial-engineering protocols and best practices
...
- Adjacent industrial-engineering skills for comprehensive analysis
...
7. Stay current with industrial-engineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: industrial-engineering
