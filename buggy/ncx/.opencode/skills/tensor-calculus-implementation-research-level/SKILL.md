# Tensor Calculus Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to tensor-calculus. This includes tasks such as:
- solve equations
- compute derivatives
- analyze functions
...
1. The user explicitly requests implementation in the context of tensor-calculus
