# Solar Physics Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to solar-physics. This includes tasks such as:
- detect signals
- analyze spectra
- observe objects
...
1. The user explicitly requests troubleshooting in the context of solar-physics
