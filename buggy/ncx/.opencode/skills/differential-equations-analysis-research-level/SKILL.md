# Differential Equations Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to differential-equations. This includes tasks such as:
- prove theorems
- find eigenvalues
- calculate integrals
...
1. The user explicitly requests analysis in the context of differential-equations
