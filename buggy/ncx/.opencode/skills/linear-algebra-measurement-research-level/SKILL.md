# Linear Algebra Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to linear-algebra. This includes tasks such as:
- calculate integrals
- compute derivatives
- find eigenvalues
...
1. The user explicitly requests measurement in the context of linear-algebra
