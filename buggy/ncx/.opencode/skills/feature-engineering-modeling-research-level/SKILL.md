# Feature Engineering Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to feature-engineering. This includes tasks such as:
- visualize data
- analyze datasets
- build models
...
1. The user explicitly requests modeling in the context of feature-engineering
