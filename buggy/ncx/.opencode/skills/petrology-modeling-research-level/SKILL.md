# Petrology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to petrology. This includes tasks such as:
- predict events
- map features
- interpret data
...
1. The user explicitly requests modeling in the context of petrology
