# Petrology Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to petrology. This includes tasks such as:
- predict events
- measure properties
- model processes
...
1. The user explicitly requests optimization in the context of petrology
