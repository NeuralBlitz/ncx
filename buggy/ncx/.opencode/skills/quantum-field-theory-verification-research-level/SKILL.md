# Quantum Field Theory Verification Research Level Skill

## Overview
This skill enables verification in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to quantum-field-theory. This includes tasks such as:
- model systems
- calculate forces
- predict behavior
...
1. The user explicitly requests verification in the context of quantum-field-theory
