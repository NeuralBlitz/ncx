# Environmental Science Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of environmental-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to environmental-science. This includes tasks such as:
- model processes
- predict events
- measure properties
...
1. The user explicitly requests debugging in the context of environmental-science
