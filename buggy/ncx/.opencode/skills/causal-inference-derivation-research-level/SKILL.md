# Causal Inference Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to causal-inference. This includes tasks such as:
- extract features
- visualize data
- analyze datasets
...
1. The user explicitly requests derivation in the context of causal-inference
