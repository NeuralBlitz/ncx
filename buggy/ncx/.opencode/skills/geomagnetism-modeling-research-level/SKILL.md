# Geomagnetism Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to geomagnetism. This includes tasks such as:
- predict events
- model processes
- model processes
...
1. The user explicitly requests modeling in the context of geomagnetism
