# Data Pipelines Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to data-pipelines. This includes tasks such as:
- build models
- extract features
- predict outcomes
...
1. The user explicitly requests simulation in the context of data-pipelines
