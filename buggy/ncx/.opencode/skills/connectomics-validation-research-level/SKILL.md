# Connectomics Validation Research Level Skill

## Overview
This skill enables validation in the domain of connectomics (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to connectomics. This includes tasks such as:
...
1. The user explicitly requests validation in the context of connectomics
