# Astrometry Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of astrometry (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to astrometry. This includes tasks such as:
- observe objects
- detect signals
- detect signals
...
1. The user explicitly requests simulation in the context of astrometry
