# Electrochemistry Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of electrochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to electrochemistry. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of electrochemistry
...
4. The work involves electrochemistry methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of electrochemistry principles and methods
...
2. **Methodology**: Follow established electrochemistry protocols and best practices
...
- Adjacent electrochemistry skills for comprehensive analysis
...
7. Stay current with electrochemistry literature and methods

## Version Information
- Complexity Level: research-level
- Domain: chemistry
- Subdiscipline: electrochemistry
