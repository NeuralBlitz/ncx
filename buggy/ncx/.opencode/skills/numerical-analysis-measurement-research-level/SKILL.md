# Numerical Analysis Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to numerical-analysis. This includes tasks such as:
- calculate integrals
- prove theorems
- find eigenvalues
...
1. The user explicitly requests measurement in the context of numerical-analysis
