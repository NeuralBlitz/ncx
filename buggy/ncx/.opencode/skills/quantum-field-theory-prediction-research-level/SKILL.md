# Quantum Field Theory Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to quantum-field-theory. This includes tasks such as:
- calculate forces
- measure quantities
- model systems
...
1. The user explicitly requests prediction in the context of quantum-field-theory
