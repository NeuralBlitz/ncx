# Predictive Analytics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to predictive-analytics. This includes tasks such as:
- analyze datasets
- predict outcomes
- extract features
...
1. The user explicitly requests characterization in the context of predictive-analytics
...
4. The work involves predictive-analytics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of predictive-analytics principles and methods
...
2. **Methodology**: Follow established predictive-analytics protocols and best practices
...
- Adjacent predictive-analytics skills for comprehensive analysis
...
7. Stay current with predictive-analytics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: predictive-analytics
