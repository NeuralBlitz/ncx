# Cybersecurity Verification Research Level Skill

## Overview
This skill enables verification in the domain of cybersecurity (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to cybersecurity. This includes tasks such as:
- design systems
- analyze complexity
- train models
...
1. The user explicitly requests verification in the context of cybersecurity
