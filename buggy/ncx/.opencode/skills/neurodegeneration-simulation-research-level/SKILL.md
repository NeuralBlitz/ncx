# Neurodegeneration Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of neurodegeneration (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to neurodegeneration. This includes tasks such as:
- map connections
- study behavior
- study behavior
...
1. The user explicitly requests simulation in the context of neurodegeneration
