# Number Theory Validation Research Level Skill

## Overview
This skill enables validation in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to number-theory. This includes tasks such as:
- compute derivatives
- prove theorems
- find eigenvalues
...
1. The user explicitly requests validation in the context of number-theory
