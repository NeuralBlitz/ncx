# Laser Physics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to laser-physics. This includes tasks such as:
- calculate forces
...
1. The user explicitly requests characterization in the context of laser-physics
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves laser-physics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of laser-physics principles and methods
...
2. **Methodology**: Follow established laser-physics protocols and best practices
...
- Adjacent laser-physics skills for comprehensive analysis
...
7. Stay current with laser-physics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: laser-physics
