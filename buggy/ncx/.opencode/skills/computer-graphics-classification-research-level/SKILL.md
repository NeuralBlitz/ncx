# Computer Graphics Classification Research Level Skill

## Overview
This skill enables classification in the domain of computer-graphics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to computer-graphics. This includes tasks such as:
- debug programs
- design systems
- optimize code
...
1. The user explicitly requests classification in the context of computer-graphics
