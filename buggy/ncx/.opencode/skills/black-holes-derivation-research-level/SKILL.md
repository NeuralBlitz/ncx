# Black Holes Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to black-holes. This includes tasks such as:
- measure distances
- model phenomena
- observe objects
...
1. The user explicitly requests derivation in the context of black-holes
