# Computer Networks Verification Research Level Skill

## Overview
This skill enables verification in the domain of computer-networks (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to computer-networks. This includes tasks such as:
- debug programs
- design systems
- train models
...
1. The user explicitly requests verification in the context of computer-networks
