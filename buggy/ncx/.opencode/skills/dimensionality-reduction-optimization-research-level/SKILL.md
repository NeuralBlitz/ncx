# Dimensionality Reduction Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of dimensionality-reduction (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to dimensionality-reduction. This includes tasks such as:
- visualize data
- analyze datasets
- visualize data
...
1. The user explicitly requests optimization in the context of dimensionality-reduction
