# Marine Biology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of marine-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to marine-biology. This includes tasks such as:
- classify organisms
- model populations
- study interactions
...
1. The user explicitly requests characterization in the context of marine-biology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be genetic data
4. The work involves marine-biology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of marine-biology principles and methods
...
2. **Methodology**: Follow established marine-biology protocols and best practices
...
- Adjacent marine-biology skills for comprehensive analysis
...
7. Stay current with marine-biology literature and methods
