# Spectroscopy Astro Verification Research Level Skill

## Overview
This skill enables verification in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to spectroscopy-astro. This includes tasks such as:
- calculate orbits
- model phenomena
- detect signals
...
1. The user explicitly requests verification in the context of spectroscopy-astro
