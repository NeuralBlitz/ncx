# Radio Astronomy Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to radio-astronomy. This includes tasks such as:
- observe objects
- observe objects
- measure distances
...
1. The user explicitly requests modeling in the context of radio-astronomy
