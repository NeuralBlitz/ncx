# Manufacturing Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of manufacturing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to manufacturing. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of manufacturing
...
4. The work involves manufacturing methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of manufacturing principles and methods
...
2. **Methodology**: Follow established manufacturing protocols and best practices
...
- Adjacent manufacturing skills for comprehensive analysis
...
7. Stay current with manufacturing literature and methods
