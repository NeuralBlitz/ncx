# Neuroanatomy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of neuroanatomy (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to neuroanatomy. This includes tasks such as:
- study behavior
...
1. The user explicitly requests characterization in the context of neuroanatomy
2. The task requires research-level-level understanding of neuroscience principles
3. The output needs to be neural data
4. The work involves neuroanatomy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of neuroanatomy principles and methods
...
2. **Methodology**: Follow established neuroanatomy protocols and best practices
...
- Adjacent neuroanatomy skills for comprehensive analysis
...
7. Stay current with neuroanatomy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: neuroscience
- Subdiscipline: neuroanatomy
