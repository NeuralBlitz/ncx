# Neutron Stars Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to neutron-stars. This includes tasks such as:
- calculate orbits
- measure distances
- detect signals
...
1. The user explicitly requests derivation in the context of neutron-stars
