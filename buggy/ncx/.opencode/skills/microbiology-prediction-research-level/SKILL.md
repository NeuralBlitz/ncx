# Microbiology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of microbiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to microbiology. This includes tasks such as:
- classify organisms
- measure expression
- study interactions
...
1. The user explicitly requests prediction in the context of microbiology
