# Experimental Design Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to experimental-design. This includes tasks such as:
- predict outcomes
- test hypotheses
- build models
...
1. The user explicitly requests implementation in the context of experimental-design
