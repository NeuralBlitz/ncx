# Topology Design Research Level Skill

## Overview
This skill enables design in the domain of topology (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to topology. This includes tasks such as:
- solve equations
- compute derivatives
- calculate integrals
...
1. The user explicitly requests design in the context of topology
