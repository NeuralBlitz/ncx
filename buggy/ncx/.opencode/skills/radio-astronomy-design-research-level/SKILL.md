# Radio Astronomy Design Research Level Skill

## Overview
This skill enables design in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to radio-astronomy. This includes tasks such as:
- observe objects
- analyze spectra
- analyze spectra
...
1. The user explicitly requests design in the context of radio-astronomy
