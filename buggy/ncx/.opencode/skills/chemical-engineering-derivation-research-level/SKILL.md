# Chemical Engineering Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of chemical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to chemical-engineering. This includes tasks such as:
- design components
- validate designs
- optimize processes
...
1. The user explicitly requests derivation in the context of chemical-engineering
