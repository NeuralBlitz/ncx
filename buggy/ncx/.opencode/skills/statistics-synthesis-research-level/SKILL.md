# Statistics Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of statistics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to statistics. This includes tasks such as:
- calculate integrals
- prove theorems
- analyze functions
...
1. The user explicitly requests synthesis in the context of statistics
