# Big Data Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of big-data (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to big-data. This includes tasks such as:
- visualize data
- test hypotheses
- test hypotheses
...
1. The user explicitly requests prediction in the context of big-data
