# Recommender Systems Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of recommender-systems (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to recommender-systems. This includes tasks such as:
- analyze datasets
- analyze datasets
- test hypotheses
...
1. The user explicitly requests modeling in the context of recommender-systems
