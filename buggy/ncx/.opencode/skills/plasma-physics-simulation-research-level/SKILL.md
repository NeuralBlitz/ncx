# Plasma Physics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of plasma-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to plasma-physics. This includes tasks such as:
- predict behavior
- measure quantities
- predict behavior
...
1. The user explicitly requests simulation in the context of plasma-physics
