# Numerical Analysis Testing Research Level Skill

## Overview
This skill enables testing in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to numerical-analysis. This includes tasks such as:
- prove theorems
- solve equations
- calculate integrals
...
1. The user explicitly requests testing in the context of numerical-analysis
