# Planetary Science Astro Testing Research Level Skill

## Overview
This skill enables testing in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to planetary-science-astro. This includes tasks such as:
- calculate orbits
- observe objects
- analyze spectra
...
1. The user explicitly requests testing in the context of planetary-science-astro
