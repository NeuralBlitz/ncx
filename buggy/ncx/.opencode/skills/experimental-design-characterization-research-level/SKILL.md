# Experimental Design Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to experimental-design. This includes tasks such as:
- extract features
- analyze datasets
- analyze datasets
...
1. The user explicitly requests characterization in the context of experimental-design
...
4. The work involves experimental-design methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of experimental-design principles and methods
...
2. **Methodology**: Follow established experimental-design protocols and best practices
...
- Adjacent experimental-design skills for comprehensive analysis
...
7. Stay current with experimental-design literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: experimental-design
