# Remote Sensing Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to remote-sensing. This includes tasks such as:
- analyze samples
- interpret data
- interpret data
...
1. The user explicitly requests characterization in the context of remote-sensing
...
4. The work involves remote-sensing methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of remote-sensing principles and methods
...
2. **Methodology**: Follow established remote-sensing protocols and best practices
...
- Adjacent remote-sensing skills for comprehensive analysis
...
7. Stay current with remote-sensing literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: remote-sensing
