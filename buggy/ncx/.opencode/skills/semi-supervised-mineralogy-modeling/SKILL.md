# Semi Supervised Mineralogy Modeling Skill

## Overview
This skill enables modeling in the domain of mineralogy (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to mineralogy. This includes tasks such as:
- analyze samples
- measure properties
- model processes
...
1. The user explicitly requests modeling in the context of mineralogy
