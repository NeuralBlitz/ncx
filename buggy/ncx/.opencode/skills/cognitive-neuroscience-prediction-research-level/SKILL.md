# Cognitive Neuroscience Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of cognitive-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to cognitive-neuroscience. This includes tasks such as:
- map connections
...
1. The user explicitly requests prediction in the context of cognitive-neuroscience
