# Semi Supervised Climate Science Interpretation Skill

## Overview
This skill enables interpretation in the domain of climate-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to climate-science. This includes tasks such as:
- measure properties
- analyze samples
- measure properties
...
1. The user explicitly requests interpretation in the context of climate-science
