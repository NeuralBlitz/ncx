# Cosmology Astro Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to cosmology-astro. This includes tasks such as:
- calculate orbits
- detect signals
- calculate orbits
...
1. The user explicitly requests measurement in the context of cosmology-astro
