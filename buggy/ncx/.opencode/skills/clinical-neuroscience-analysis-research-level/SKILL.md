# Clinical Neuroscience Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of clinical-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to clinical-neuroscience. This includes tasks such as:
- study behavior
- model circuits
- measure responses
...
1. The user explicitly requests analysis in the context of clinical-neuroscience
