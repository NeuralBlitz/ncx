# Quantum Field Theory Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to quantum-field-theory. This includes tasks such as:
- calculate forces
- measure quantities
- analyze motion
...
1. The user explicitly requests derivation in the context of quantum-field-theory
