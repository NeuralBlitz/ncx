# Functional Analysis Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of functional-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to functional-analysis. This includes tasks such as:
- analyze functions
- compute derivatives
- solve equations
...
1. The user explicitly requests optimization in the context of functional-analysis
