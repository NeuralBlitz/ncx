# Probability Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to probability. This includes tasks such as:
- prove theorems
- analyze functions
- prove theorems
...
1. The user explicitly requests derivation in the context of probability
