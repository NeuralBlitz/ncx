# Heat Transfer Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to heat-transfer. This includes tasks such as:
- design components
- optimize processes
- optimize processes
...
1. The user explicitly requests interpretation in the context of heat-transfer
