# Spectroscopy Astro Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to spectroscopy-astro. This includes tasks such as:
- measure distances
- measure distances
- model phenomena
...
1. The user explicitly requests interpretation in the context of spectroscopy-astro
