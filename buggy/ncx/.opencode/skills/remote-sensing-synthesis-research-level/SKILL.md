# Remote Sensing Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to remote-sensing. This includes tasks such as:
- interpret data
- interpret data
- measure properties
...
1. The user explicitly requests synthesis in the context of remote-sensing
