# Nuclear Engineering Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of nuclear-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to nuclear-engineering. This includes tasks such as:
- validate designs
- optimize processes
- analyze structures
...
1. The user explicitly requests estimation in the context of nuclear-engineering
