# Operating Systems Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of operating-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to operating-systems. This includes tasks such as:
- analyze complexity
- debug programs
- train models
...
1. The user explicitly requests optimization in the context of operating-systems
