# Condensed Matter Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of condensed-matter (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to condensed-matter. This includes tasks such as:
- model systems
- analyze motion
...
1. The user explicitly requests characterization in the context of condensed-matter
...
4. The work involves condensed-matter methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of condensed-matter principles and methods
...
2. **Methodology**: Follow established condensed-matter protocols and best practices
...
- Adjacent condensed-matter skills for comprehensive analysis
...
7. Stay current with condensed-matter literature and methods
