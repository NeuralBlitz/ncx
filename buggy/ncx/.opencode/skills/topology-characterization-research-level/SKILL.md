# Topology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of topology (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to topology. This includes tasks such as:
- prove theorems
- analyze functions
- solve equations
...
1. The user explicitly requests characterization in the context of topology
