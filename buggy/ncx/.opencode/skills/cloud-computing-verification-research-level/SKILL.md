# Cloud Computing Verification Research Level Skill

## Overview
This skill enables verification in the domain of cloud-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to cloud-computing. This includes tasks such as:
- train models
- optimize code
- optimize code
...
1. The user explicitly requests verification in the context of cloud-computing
