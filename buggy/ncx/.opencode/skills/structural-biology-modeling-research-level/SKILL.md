# Structural Biology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of structural-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to structural-biology. This includes tasks such as:
- model populations
- study interactions
- classify organisms
...
1. The user explicitly requests modeling in the context of structural-biology
