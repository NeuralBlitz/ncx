# Cybersecurity Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of cybersecurity (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to cybersecurity. This includes tasks such as:
- train models
- design systems
- debug programs
...
1. The user explicitly requests troubleshooting in the context of cybersecurity
