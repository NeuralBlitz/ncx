# Aerospace Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of aerospace-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to aerospace-engineering. This includes tasks such as:
- validate designs
- optimize processes
- test prototypes
...
1. The user explicitly requests characterization in the context of aerospace-engineering
