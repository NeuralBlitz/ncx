# Semi Supervised Oceanography Testing Skill

## Overview
This skill enables testing in the domain of oceanography (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to oceanography. This includes tasks such as:
- predict events
- predict events
- measure properties
...
1. The user explicitly requests testing in the context of oceanography
