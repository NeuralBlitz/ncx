# Semi Supervised Systems Biology Classification Skill

## Overview
This skill enables classification in the domain of systems-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to systems-biology. This includes tasks such as:
- classify organisms
- sequence DNA
- measure expression
...
1. The user explicitly requests classification in the context of systems-biology
