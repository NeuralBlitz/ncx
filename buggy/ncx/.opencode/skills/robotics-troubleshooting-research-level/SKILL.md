# Robotics Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of robotics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to robotics. This includes tasks such as:
- debug programs
- debug programs
- analyze complexity
...
1. The user explicitly requests troubleshooting in the context of robotics
