# Fluid Mechanics Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of fluid-mechanics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to fluid-mechanics. This includes tasks such as:
- design components
- validate designs
- design components
...
1. The user explicitly requests prediction in the context of fluid-mechanics
