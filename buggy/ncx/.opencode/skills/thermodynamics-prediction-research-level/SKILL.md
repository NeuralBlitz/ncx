# Thermodynamics Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of thermodynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to thermodynamics. This includes tasks such as:
- calculate forces
- measure quantities
- predict behavior
...
1. The user explicitly requests prediction in the context of thermodynamics
