# Geophysics Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of geophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to geophysics. This includes tasks such as:
- measure quantities
- calculate forces
- measure quantities
...
1. The user explicitly requests synthesis in the context of geophysics
