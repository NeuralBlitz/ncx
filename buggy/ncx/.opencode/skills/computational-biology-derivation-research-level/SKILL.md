# Computational Biology Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of computational-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to computational-biology. This includes tasks such as:
- classify organisms
- study interactions
- classify organisms
...
1. The user explicitly requests derivation in the context of computational-biology
