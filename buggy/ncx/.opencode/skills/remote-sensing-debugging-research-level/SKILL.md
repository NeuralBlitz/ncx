# Remote Sensing Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to remote-sensing. This includes tasks such as:
- map features
- interpret data
- predict events
...
1. The user explicitly requests debugging in the context of remote-sensing
