# Geochemistry Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of geochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to geochemistry. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of geochemistry
...
4. The work involves geochemistry methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of geochemistry principles and methods
...
2. **Methodology**: Follow established geochemistry protocols and best practices
...
- Adjacent geochemistry skills for comprehensive analysis
...
7. Stay current with geochemistry literature and methods

## Version Information
- Complexity Level: research-level
- Domain: chemistry
- Subdiscipline: geochemistry
