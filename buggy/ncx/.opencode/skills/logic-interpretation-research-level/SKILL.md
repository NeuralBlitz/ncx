# Logic Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of logic (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to logic. This includes tasks such as:
- find eigenvalues
- compute derivatives
- compute derivatives
...
1. The user explicitly requests interpretation in the context of logic
