# Measure Theory Design Research Level Skill

## Overview
This skill enables design in the domain of measure-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to measure-theory. This includes tasks such as:
- find eigenvalues
- calculate integrals
- solve equations
...
1. The user explicitly requests design in the context of measure-theory
