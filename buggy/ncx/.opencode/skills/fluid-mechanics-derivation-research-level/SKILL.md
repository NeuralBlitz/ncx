# Fluid Mechanics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of fluid-mechanics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to fluid-mechanics. This includes tasks such as:
- analyze structures
- design components
- test prototypes
...
1. The user explicitly requests derivation in the context of fluid-mechanics
