# Genetics Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to genetics. This includes tasks such as:
- analyze proteins
- sequence DNA
- study interactions
...
1. The user explicitly requests debugging in the context of genetics
