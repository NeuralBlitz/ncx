# Semi Supervised Neurophysiology Derivation Skill

## Overview
This skill enables derivation in the domain of neurophysiology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to neurophysiology. This includes tasks such as:
- study behavior
- study behavior
- map connections
...
1. The user explicitly requests derivation in the context of neurophysiology
