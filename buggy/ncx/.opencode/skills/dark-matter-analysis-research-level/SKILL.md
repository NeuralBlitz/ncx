# Dark Matter Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to dark-matter. This includes tasks such as:
- analyze spectra
- calculate orbits
- analyze spectra
...
1. The user explicitly requests analysis in the context of dark-matter
