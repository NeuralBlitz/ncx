# Optimization Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of optimization (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to optimization. This includes tasks such as:
- solve equations
- analyze functions
- analyze functions
...
1. The user explicitly requests characterization in the context of optimization
...
4. The work involves optimization methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of optimization principles and methods
...
2. **Methodology**: Follow established optimization protocols and best practices
...
- Adjacent optimization skills for comprehensive analysis
...
7. Stay current with optimization literature and methods
