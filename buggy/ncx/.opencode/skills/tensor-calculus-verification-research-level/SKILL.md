# Tensor Calculus Verification Research Level Skill

## Overview
This skill enables verification in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to tensor-calculus. This includes tasks such as:
- solve equations
- compute derivatives
- compute derivatives
...
1. The user explicitly requests verification in the context of tensor-calculus
