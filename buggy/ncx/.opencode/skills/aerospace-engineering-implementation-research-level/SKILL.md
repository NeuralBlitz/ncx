# Aerospace Engineering Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of aerospace-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to aerospace-engineering. This includes tasks such as:
- test prototypes
- test prototypes
- design components
...
1. The user explicitly requests implementation in the context of aerospace-engineering
