# Particle Physics Verification Research Level Skill

## Overview
This skill enables verification in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to particle-physics. This includes tasks such as:
- calculate forces
- model systems
- analyze motion
...
1. The user explicitly requests verification in the context of particle-physics
