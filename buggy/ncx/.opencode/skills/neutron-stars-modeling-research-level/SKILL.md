# Neutron Stars Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to neutron-stars. This includes tasks such as:
- analyze spectra
- calculate orbits
- observe objects
...
1. The user explicitly requests modeling in the context of neutron-stars
