# Synthetic Biology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of synthetic-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to synthetic-biology. This includes tasks such as:
- sequence DNA
- sequence DNA
- sequence DNA
...
1. The user explicitly requests prediction in the context of synthetic-biology
