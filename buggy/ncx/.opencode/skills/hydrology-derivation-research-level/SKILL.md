# Hydrology Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of hydrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to hydrology. This includes tasks such as:
- measure properties
- predict events
- map features
...
1. The user explicitly requests derivation in the context of hydrology
