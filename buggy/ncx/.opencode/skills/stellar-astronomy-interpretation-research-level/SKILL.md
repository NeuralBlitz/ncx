# Stellar Astronomy Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to stellar-astronomy. This includes tasks such as:
- detect signals
- analyze spectra
- observe objects
...
1. The user explicitly requests interpretation in the context of stellar-astronomy
