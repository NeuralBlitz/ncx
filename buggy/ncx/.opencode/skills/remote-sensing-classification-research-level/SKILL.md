# Remote Sensing Classification Research Level Skill

## Overview
This skill enables classification in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to remote-sensing. This includes tasks such as:
- measure properties
- measure properties
- map features
...
1. The user explicitly requests classification in the context of remote-sensing
