# Semi Supervised Gravitational Waves Synthesis Skill

## Overview
This skill enables synthesis in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to gravitational-waves. This includes tasks such as:
- model phenomena
- measure distances
- model phenomena
...
1. The user explicitly requests synthesis in the context of gravitational-waves
