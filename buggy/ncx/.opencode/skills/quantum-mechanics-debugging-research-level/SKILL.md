# Quantum Mechanics Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of quantum-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to quantum-mechanics. This includes tasks such as:
- analyze motion
- predict behavior
...
1. The user explicitly requests debugging in the context of quantum-mechanics
