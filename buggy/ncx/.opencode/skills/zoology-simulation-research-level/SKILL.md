# Zoology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to zoology. This includes tasks such as:
- sequence DNA
- classify organisms
- sequence DNA
...
1. The user explicitly requests simulation in the context of zoology
