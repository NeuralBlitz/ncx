# Statistical Mechanics Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of statistical-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to statistical-mechanics. This includes tasks such as:
- model systems
- measure quantities
- measure quantities
...
1. The user explicitly requests synthesis in the context of statistical-mechanics
