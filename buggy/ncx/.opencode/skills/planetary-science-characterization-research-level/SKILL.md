# Planetary Science Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to planetary-science. This includes tasks such as:
- interpret data
- measure properties
- interpret data
...
1. The user explicitly requests characterization in the context of planetary-science
...
4. The work involves planetary-science methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of planetary-science principles and methods
...
2. **Methodology**: Follow established planetary-science protocols and best practices
...
- Adjacent planetary-science skills for comprehensive analysis
...
7. Stay current with planetary-science literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: planetary-science
