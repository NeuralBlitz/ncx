# Ecology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of ecology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to ecology. This includes tasks such as:
- analyze proteins
- analyze proteins
- measure expression
...
1. The user explicitly requests characterization in the context of ecology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be phylogenetic trees
4. The work involves ecology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of ecology principles and methods
...
2. **Methodology**: Follow established ecology protocols and best practices
...
- Adjacent ecology skills for comprehensive analysis
...
7. Stay current with ecology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: ecology
