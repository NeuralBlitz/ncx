# Manufacturing Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of manufacturing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to manufacturing. This includes tasks such as:
- analyze structures
- test prototypes
- design components
...
1. The user explicitly requests interpretation in the context of manufacturing
