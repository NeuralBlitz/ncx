# Algebraic Geometry Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of algebraic-geometry (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to algebraic-geometry. This includes tasks such as:
- find eigenvalues
- prove theorems
- prove theorems
...
1. The user explicitly requests calculation in the context of algebraic-geometry
