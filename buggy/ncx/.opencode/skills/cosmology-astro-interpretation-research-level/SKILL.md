# Cosmology Astro Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to cosmology-astro. This includes tasks such as:
- detect signals
- detect signals
- analyze spectra
...
1. The user explicitly requests interpretation in the context of cosmology-astro
