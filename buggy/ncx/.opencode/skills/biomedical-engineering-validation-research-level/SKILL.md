# Biomedical Engineering Validation Research Level Skill

## Overview
This skill enables validation in the domain of biomedical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to biomedical-engineering. This includes tasks such as:
- optimize processes
- test prototypes
- design components
...
1. The user explicitly requests validation in the context of biomedical-engineering
