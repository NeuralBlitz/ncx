# Molecular Biology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of molecular-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to molecular-biology. This includes tasks such as:
- model populations
- analyze proteins
- classify organisms
...
1. The user explicitly requests prediction in the context of molecular-biology
