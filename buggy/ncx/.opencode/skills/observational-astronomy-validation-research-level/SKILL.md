# Observational Astronomy Validation Research Level Skill

## Overview
This skill enables validation in the domain of observational-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to observational-astronomy. This includes tasks such as:
- model phenomena
- analyze spectra
- detect signals
...
1. The user explicitly requests validation in the context of observational-astronomy
