# Planetary Science Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to planetary-science. This includes tasks such as:
- measure properties
- predict events
- interpret data
...
1. The user explicitly requests troubleshooting in the context of planetary-science
