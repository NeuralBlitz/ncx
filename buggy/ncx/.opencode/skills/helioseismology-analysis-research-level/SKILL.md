# Helioseismology Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to helioseismology. This includes tasks such as:
- calculate orbits
- measure distances
- observe objects
...
1. The user explicitly requests analysis in the context of helioseismology
