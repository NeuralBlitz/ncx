# Neutron Stars Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to neutron-stars. This includes tasks such as:
- detect signals
- observe objects
- detect signals
...
1. The user explicitly requests analysis in the context of neutron-stars
