# Computer Vision Testing Research Level Skill

## Overview
This skill enables testing in the domain of computer-vision (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to computer-vision. This includes tasks such as:
- debug programs
- analyze complexity
- debug programs
...
1. The user explicitly requests testing in the context of computer-vision
