# Predictive Analytics Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to predictive-analytics. This includes tasks such as:
- build models
- test hypotheses
- predict outcomes
...
1. The user explicitly requests modeling in the context of predictive-analytics
