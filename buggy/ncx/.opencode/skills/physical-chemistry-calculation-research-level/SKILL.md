# Physical Chemistry Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of physical-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to physical-chemistry. This includes tasks such as:
- analyze spectra
...
1. The user explicitly requests calculation in the context of physical-chemistry
