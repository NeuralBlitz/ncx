# Multivariate Logic Verification Skill

## Overview
This skill enables verification in the domain of logic (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to logic. This includes tasks such as:
- find eigenvalues
- find eigenvalues
- prove theorems
...
1. The user explicitly requests verification in the context of logic
