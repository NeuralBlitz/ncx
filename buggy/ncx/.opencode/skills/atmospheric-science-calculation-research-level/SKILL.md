# Atmospheric Science Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of atmospheric-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to atmospheric-science. This includes tasks such as:
- model processes
- map features
- map features
...
1. The user explicitly requests calculation in the context of atmospheric-science
