# Statistics Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of statistics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to statistics. This includes tasks such as:
- compute derivatives
- analyze functions
- analyze functions
...
1. The user explicitly requests estimation in the context of statistics
