# Extragalactic Astronomy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to extragalactic-astronomy. This includes tasks such as:
- model phenomena
- detect signals
- measure distances
...
1. The user explicitly requests characterization in the context of extragalactic-astronomy
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves extragalactic-astronomy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of extragalactic-astronomy principles and methods
...
2. **Methodology**: Follow established extragalactic-astronomy protocols and best practices
...
- Adjacent extragalactic-astronomy skills for comprehensive analysis
...
7. Stay current with extragalactic-astronomy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: extragalactic-astronomy
