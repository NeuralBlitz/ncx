# Geochemistry Earth Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of geochemistry-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to geochemistry-earth. This includes tasks such as:
- map features
- map features
- map features
...
1. The user explicitly requests debugging in the context of geochemistry-earth
