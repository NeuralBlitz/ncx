# Semi Supervised Functional Analysis Synthesis Skill

## Overview
This skill enables synthesis in the domain of functional-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to functional-analysis. This includes tasks such as:
- prove theorems
- compute derivatives
- analyze functions
...
1. The user explicitly requests synthesis in the context of functional-analysis
