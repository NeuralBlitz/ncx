# Marine Biology Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of marine-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to marine-biology. This includes tasks such as:
- measure expression
- analyze proteins
- model populations
...
1. The user explicitly requests derivation in the context of marine-biology
