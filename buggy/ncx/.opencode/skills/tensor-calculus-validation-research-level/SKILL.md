# Tensor Calculus Validation Research Level Skill

## Overview
This skill enables validation in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to tensor-calculus. This includes tasks such as:
- prove theorems
- calculate integrals
- find eigenvalues
...
1. The user explicitly requests validation in the context of tensor-calculus
