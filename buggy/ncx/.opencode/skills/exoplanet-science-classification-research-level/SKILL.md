# Exoplanet Science Classification Research Level Skill

## Overview
This skill enables classification in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to exoplanet-science. This includes tasks such as:
- observe objects
- measure distances
- measure distances
...
1. The user explicitly requests classification in the context of exoplanet-science
