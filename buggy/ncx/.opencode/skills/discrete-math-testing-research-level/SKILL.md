# Discrete Math Testing Research Level Skill

## Overview
This skill enables testing in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to discrete-math. This includes tasks such as:
- find eigenvalues
- calculate integrals
- analyze functions
...
1. The user explicitly requests testing in the context of discrete-math
