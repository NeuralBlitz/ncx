# Spectroscopy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of spectroscopy (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to spectroscopy. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of spectroscopy
...
4. The work involves spectroscopy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of spectroscopy principles and methods
...
2. **Methodology**: Follow established spectroscopy protocols and best practices
...
- Adjacent spectroscopy skills for comprehensive analysis
...
7. Stay current with spectroscopy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: chemistry
- Subdiscipline: spectroscopy
