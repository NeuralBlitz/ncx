# Linear Algebra Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to linear-algebra. This includes tasks such as:
- analyze functions
- prove theorems
- find eigenvalues
...
1. The user explicitly requests modeling in the context of linear-algebra
