# Probability Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to probability. This includes tasks such as:
- find eigenvalues
- analyze functions
- solve equations
...
1. The user explicitly requests measurement in the context of probability
