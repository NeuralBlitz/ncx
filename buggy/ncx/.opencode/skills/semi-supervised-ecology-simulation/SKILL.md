# Semi Supervised Ecology Simulation Skill

## Overview
This skill enables simulation in the domain of ecology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to ecology. This includes tasks such as:
- model populations
- measure expression
- measure expression
...
1. The user explicitly requests simulation in the context of ecology
