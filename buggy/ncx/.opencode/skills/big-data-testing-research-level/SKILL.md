# Big Data Testing Research Level Skill

## Overview
This skill enables testing in the domain of big-data (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to big-data. This includes tasks such as:
- extract features
- visualize data
- build models
...
1. The user explicitly requests testing in the context of big-data
