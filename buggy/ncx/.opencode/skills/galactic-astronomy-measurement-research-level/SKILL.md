# Galactic Astronomy Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to galactic-astronomy. This includes tasks such as:
- detect signals
- observe objects
- measure distances
...
1. The user explicitly requests measurement in the context of galactic-astronomy
