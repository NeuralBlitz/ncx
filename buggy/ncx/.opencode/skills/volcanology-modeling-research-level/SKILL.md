# Volcanology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of volcanology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to volcanology. This includes tasks such as:
- measure properties
- analyze samples
- predict events
...
1. The user explicitly requests modeling in the context of volcanology
