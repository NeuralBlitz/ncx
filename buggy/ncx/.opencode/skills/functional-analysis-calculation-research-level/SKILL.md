# Functional Analysis Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of functional-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to functional-analysis. This includes tasks such as:
- compute derivatives
- analyze functions
- prove theorems
...
1. The user explicitly requests calculation in the context of functional-analysis
