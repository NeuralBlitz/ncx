# Helioseismology Classification Research Level Skill

## Overview
This skill enables classification in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to helioseismology. This includes tasks such as:
- observe objects
- model phenomena
- measure distances
...
1. The user explicitly requests classification in the context of helioseismology
