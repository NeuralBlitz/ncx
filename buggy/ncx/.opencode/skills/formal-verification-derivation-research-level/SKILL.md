# Formal Verification Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to formal-verification. This includes tasks such as:
- design systems
- design systems
- train models
...
1. The user explicitly requests derivation in the context of formal-verification
