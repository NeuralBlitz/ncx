# Radio Astronomy Verification Research Level Skill

## Overview
This skill enables verification in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to radio-astronomy. This includes tasks such as:
- analyze spectra
- calculate orbits
- measure distances
...
1. The user explicitly requests verification in the context of radio-astronomy
