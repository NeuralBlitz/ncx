# Semi Supervised Recommender Systems Prediction Skill

## Overview
This skill enables prediction in the domain of recommender-systems (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to recommender-systems. This includes tasks such as:
- visualize data
- analyze datasets
- build models
...
1. The user explicitly requests prediction in the context of recommender-systems
