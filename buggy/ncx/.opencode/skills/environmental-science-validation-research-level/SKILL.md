# Environmental Science Validation Research Level Skill

## Overview
This skill enables validation in the domain of environmental-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to environmental-science. This includes tasks such as:
- interpret data
- interpret data
- predict events
...
1. The user explicitly requests validation in the context of environmental-science
