# Dimensionality Reduction Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of dimensionality-reduction (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to dimensionality-reduction. This includes tasks such as:
- visualize data
- test hypotheses
- build models
...
1. The user explicitly requests derivation in the context of dimensionality-reduction
