# Discrete Math Classification Research Level Skill

## Overview
This skill enables classification in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to discrete-math. This includes tasks such as:
- analyze functions
- prove theorems
- calculate integrals
...
1. The user explicitly requests classification in the context of discrete-math
