# Radio Astronomy Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to radio-astronomy. This includes tasks such as:
- analyze spectra
- model phenomena
- analyze spectra
...
1. The user explicitly requests debugging in the context of radio-astronomy
