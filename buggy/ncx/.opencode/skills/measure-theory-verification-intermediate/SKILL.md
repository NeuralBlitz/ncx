# Measure Theory Verification Intermediate Skill

## Overview
This skill enables verification in the domain of measure-theory (mathematics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to measure-theory. This includes tasks such as:
- compute derivatives
- solve equations
- find eigenvalues
...
1. The user explicitly requests verification in the context of measure-theory
