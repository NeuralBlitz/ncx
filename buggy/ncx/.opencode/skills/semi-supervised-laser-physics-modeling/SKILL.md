# Semi Supervised Laser Physics Modeling Skill

## Overview
This skill enables modeling in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to laser-physics. This includes tasks such as:
- analyze motion
- calculate forces
- calculate forces
...
1. The user explicitly requests modeling in the context of laser-physics
