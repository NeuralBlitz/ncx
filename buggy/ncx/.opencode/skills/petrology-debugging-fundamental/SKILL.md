# Petrology Debugging Fundamental Skill

## Overview
This skill enables debugging in the domain of petrology (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
