# Algebra Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to algebra. This includes tasks such as:
- calculate integrals
- calculate integrals
- compute derivatives
...
1. The user explicitly requests derivation in the context of algebra
