# Galactic Astronomy Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to galactic-astronomy. This includes tasks such as:
- observe objects
- model phenomena
- detect signals
...
1. The user explicitly requests modeling in the context of galactic-astronomy
