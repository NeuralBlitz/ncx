# Deterministic Botany Interpretation Skill

## Overview
This skill enables interpretation in the domain of botany (biology). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
