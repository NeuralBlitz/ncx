# Programming Languages Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of programming-languages (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to programming-languages. This includes tasks such as:
- analyze complexity
- debug programs
- debug programs
...
1. The user explicitly requests synthesis in the context of programming-languages
