# Helioseismology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to helioseismology. This includes tasks such as:
- calculate orbits
- observe objects
- observe objects
...
1. The user explicitly requests modeling in the context of helioseismology
