# Semi Supervised Planetary Science Analysis Skill

## Overview
This skill enables analysis in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to planetary-science. This includes tasks such as:
- measure properties
- map features
- analyze samples
...
1. The user explicitly requests analysis in the context of planetary-science
