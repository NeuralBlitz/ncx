# Experimental Design Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to experimental-design. This includes tasks such as:
- analyze datasets
- visualize data
- predict outcomes
...
1. The user explicitly requests interpretation in the context of experimental-design
