# Ecology Validation Research Level Skill

## Overview
This skill enables validation in the domain of ecology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to ecology. This includes tasks such as:
- study interactions
- analyze proteins
- study interactions
...
1. The user explicitly requests validation in the context of ecology
