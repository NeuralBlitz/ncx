# Catalysis Design Research Level Skill

## Overview
This skill enables design in the domain of catalysis (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to catalysis. This includes tasks such as:
- optimize yields
- predict reactions
- analyze spectra
...
1. The user explicitly requests design in the context of catalysis
