# Spectroscopy Astro Testing Research Level Skill

## Overview
This skill enables testing in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to spectroscopy-astro. This includes tasks such as:
- measure distances
- detect signals
- calculate orbits
...
1. The user explicitly requests testing in the context of spectroscopy-astro
