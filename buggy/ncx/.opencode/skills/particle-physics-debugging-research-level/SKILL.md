# Particle Physics Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to particle-physics. This includes tasks such as:
- measure quantities
- predict behavior
- measure quantities
...
1. The user explicitly requests debugging in the context of particle-physics
