# Cosmology Astro Verification Research Level Skill

## Overview
This skill enables verification in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to cosmology-astro. This includes tasks such as:
- analyze spectra
- detect signals
- model phenomena
...
1. The user explicitly requests verification in the context of cosmology-astro
