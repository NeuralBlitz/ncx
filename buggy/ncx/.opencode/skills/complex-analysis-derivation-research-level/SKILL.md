# Complex Analysis Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of complex-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to complex-analysis. This includes tasks such as:
- analyze functions
- prove theorems
- prove theorems
...
1. The user explicitly requests derivation in the context of complex-analysis
