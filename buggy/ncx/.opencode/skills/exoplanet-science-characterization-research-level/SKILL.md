# Exoplanet Science Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to exoplanet-science. This includes tasks such as:
- detect signals
- measure distances
- measure distances
...
1. The user explicitly requests characterization in the context of exoplanet-science
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be astronomical data
4. The work involves exoplanet-science methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of exoplanet-science principles and methods
...
2. **Methodology**: Follow established exoplanet-science protocols and best practices
...
- Adjacent exoplanet-science skills for comprehensive analysis
...
7. Stay current with exoplanet-science literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: exoplanet-science
