# Deterministic Particle Physics Design Skill

## Overview
This skill enables design in the domain of particle-physics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.
