# Big Data Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of big-data (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to big-data. This includes tasks such as:
- test hypotheses
- visualize data
- analyze datasets
...
1. The user explicitly requests derivation in the context of big-data
