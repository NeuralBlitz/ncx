# Developmental Neuroscience Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of developmental-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to developmental-neuroscience. This includes tasks such as:
- model circuits
- map connections
...
1. The user explicitly requests derivation in the context of developmental-neuroscience
