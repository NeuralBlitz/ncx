# Volcanology Verification Research Level Skill

## Overview
This skill enables verification in the domain of volcanology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to volcanology. This includes tasks such as:
- interpret data
- interpret data
- analyze samples
...
1. The user explicitly requests verification in the context of volcanology
