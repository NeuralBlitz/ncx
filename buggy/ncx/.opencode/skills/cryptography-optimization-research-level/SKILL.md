# Cryptography Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of cryptography (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to cryptography. This includes tasks such as:
- prove theorems
- calculate integrals
- analyze functions
...
1. The user explicitly requests optimization in the context of cryptography
