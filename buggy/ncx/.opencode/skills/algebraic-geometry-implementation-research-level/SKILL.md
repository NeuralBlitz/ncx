# Algebraic Geometry Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of algebraic-geometry (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to algebraic-geometry. This includes tasks such as:
- find eigenvalues
- compute derivatives
- find eigenvalues
...
1. The user explicitly requests implementation in the context of algebraic-geometry
