# Programming Languages Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of programming-languages (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to programming-languages. This includes tasks such as:
- optimize code
- debug programs
- train models
...
1. The user explicitly requests modeling in the context of programming-languages
