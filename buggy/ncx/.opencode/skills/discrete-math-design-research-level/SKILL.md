# Discrete Math Design Research Level Skill

## Overview
This skill enables design in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to discrete-math. This includes tasks such as:
- solve equations
- analyze functions
- compute derivatives
...
1. The user explicitly requests design in the context of discrete-math
