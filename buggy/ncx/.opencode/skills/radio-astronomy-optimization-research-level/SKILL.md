# Radio Astronomy Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to radio-astronomy. This includes tasks such as:
- calculate orbits
- calculate orbits
- calculate orbits
...
1. The user explicitly requests optimization in the context of radio-astronomy
