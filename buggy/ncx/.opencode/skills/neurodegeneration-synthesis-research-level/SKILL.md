# Neurodegeneration Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of neurodegeneration (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to neurodegeneration. This includes tasks such as:
- map connections
...
1. The user explicitly requests synthesis in the context of neurodegeneration
