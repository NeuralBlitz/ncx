# Thermodynamics Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of thermodynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to thermodynamics. This includes tasks such as:
- measure quantities
- measure quantities
- analyze motion
...
1. The user explicitly requests interpretation in the context of thermodynamics
