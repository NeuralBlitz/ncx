# Dark Matter Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to dark-matter. This includes tasks such as:
- observe objects
- measure distances
- calculate orbits
...
1. The user explicitly requests implementation in the context of dark-matter
