# Cryptography Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of cryptography (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to cryptography. This includes tasks such as:
- solve equations
- find eigenvalues
- compute derivatives
...
1. The user explicitly requests troubleshooting in the context of cryptography
