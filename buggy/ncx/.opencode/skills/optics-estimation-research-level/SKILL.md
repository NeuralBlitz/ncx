# Optics Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to optics. This includes tasks such as:
- calculate forces
- analyze motion
- calculate forces
...
1. The user explicitly requests estimation in the context of optics
