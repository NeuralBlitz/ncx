# Dark Energy Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to dark-energy. This includes tasks such as:
- model phenomena
- measure distances
- analyze spectra
...
1. The user explicitly requests prediction in the context of dark-energy
