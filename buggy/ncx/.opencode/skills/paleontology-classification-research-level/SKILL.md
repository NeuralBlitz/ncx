# Paleontology Classification Research Level Skill

## Overview
This skill enables classification in the domain of paleontology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to paleontology. This includes tasks such as:
- interpret data
- measure properties
- interpret data
...
1. The user explicitly requests classification in the context of paleontology
