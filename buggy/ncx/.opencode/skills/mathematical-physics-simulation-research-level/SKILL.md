# Mathematical Physics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of mathematical-physics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to mathematical-physics. This includes tasks such as:
- solve equations
- find eigenvalues
- compute derivatives
...
1. The user explicitly requests simulation in the context of mathematical-physics
