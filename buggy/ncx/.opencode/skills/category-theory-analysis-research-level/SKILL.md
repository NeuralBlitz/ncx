# Category Theory Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of category-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to category-theory. This includes tasks such as:
- compute derivatives
- compute derivatives
- prove theorems
...
1. The user explicitly requests analysis in the context of category-theory
