# Spectroscopy Astro Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to spectroscopy-astro. This includes tasks such as:
- observe objects
- detect signals
- observe objects
...
1. The user explicitly requests measurement in the context of spectroscopy-astro
