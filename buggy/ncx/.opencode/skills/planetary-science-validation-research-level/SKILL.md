# Planetary Science Validation Research Level Skill

## Overview
This skill enables validation in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to planetary-science. This includes tasks such as:
- measure properties
- measure properties
- analyze samples
...
1. The user explicitly requests validation in the context of planetary-science
