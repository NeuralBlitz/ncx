# Functional Analysis Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of functional-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to functional-analysis. This includes tasks such as:
- compute derivatives
- compute derivatives
- compute derivatives
...
1. The user explicitly requests analysis in the context of functional-analysis
