# Semi Supervised Synthetic Biology Modeling Skill

## Overview
This skill enables modeling in the domain of synthetic-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to synthetic-biology. This includes tasks such as:
- model populations
- measure expression
- measure expression
...
1. The user explicitly requests modeling in the context of synthetic-biology
