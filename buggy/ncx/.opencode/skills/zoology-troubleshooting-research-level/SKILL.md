# Zoology Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to zoology. This includes tasks such as:
- sequence DNA
- measure expression
- model populations
...
1. The user explicitly requests troubleshooting in the context of zoology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be genetic data
4. The work involves zoology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of zoology principles and methods
...
2. **Methodology**: Follow established zoology protocols and best practices
...
- Adjacent zoology skills for comprehensive analysis
...
7. Stay current with zoology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: zoology
