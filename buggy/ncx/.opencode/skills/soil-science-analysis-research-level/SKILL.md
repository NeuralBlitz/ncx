# Soil Science Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to soil-science. This includes tasks such as:
- predict events
- analyze samples
- analyze samples
...
1. The user explicitly requests analysis in the context of soil-science
