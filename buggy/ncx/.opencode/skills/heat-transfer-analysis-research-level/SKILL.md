# Heat Transfer Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to heat-transfer. This includes tasks such as:
- test prototypes
- design components
- design components
...
1. The user explicitly requests analysis in the context of heat-transfer
