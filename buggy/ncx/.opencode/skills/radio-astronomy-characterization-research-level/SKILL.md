# Radio Astronomy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to radio-astronomy. This includes tasks such as:
- calculate orbits
- measure distances
- calculate orbits
...
1. The user explicitly requests characterization in the context of radio-astronomy
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves radio-astronomy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of radio-astronomy principles and methods
...
2. **Methodology**: Follow established radio-astronomy protocols and best practices
...
- Adjacent radio-astronomy skills for comprehensive analysis
...
7. Stay current with radio-astronomy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: radio-astronomy
