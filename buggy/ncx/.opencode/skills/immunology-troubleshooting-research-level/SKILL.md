# Immunology Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of immunology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to immunology. This includes tasks such as:
- sequence DNA
- measure expression
- measure expression
...
1. The user explicitly requests troubleshooting in the context of immunology
