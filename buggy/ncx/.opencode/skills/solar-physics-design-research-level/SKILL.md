# Solar Physics Design Research Level Skill

## Overview
This skill enables design in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to solar-physics. This includes tasks such as:
- model phenomena
- model phenomena
- analyze spectra
...
1. The user explicitly requests design in the context of solar-physics
