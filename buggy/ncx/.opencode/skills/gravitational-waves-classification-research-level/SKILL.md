# Gravitational Waves Classification Research Level Skill

## Overview
This skill enables classification in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to gravitational-waves. This includes tasks such as:
- detect signals
- analyze spectra
- detect signals
...
1. The user explicitly requests classification in the context of gravitational-waves
