# Nanotechnology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of nanotechnology (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to nanotechnology. This includes tasks such as:
- validate designs
- optimize processes
...
1. The user explicitly requests characterization in the context of nanotechnology
