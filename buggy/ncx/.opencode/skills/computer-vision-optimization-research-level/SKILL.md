# Computer Vision Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of computer-vision (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to computer-vision. This includes tasks such as:
- debug programs
- train models
- design systems
...
1. The user explicitly requests optimization in the context of computer-vision
