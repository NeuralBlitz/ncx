# Predictive Analytics Validation Research Level Skill

## Overview
This skill enables validation in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to predictive-analytics. This includes tasks such as:
- analyze datasets
- test hypotheses
- build models
...
1. The user explicitly requests validation in the context of predictive-analytics
