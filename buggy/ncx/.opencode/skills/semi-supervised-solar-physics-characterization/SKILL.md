# Semi Supervised Solar Physics Characterization Skill

## Overview
This skill enables characterization in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to solar-physics. This includes tasks such as:
- observe objects
- measure distances
- observe objects
...
1. The user explicitly requests characterization in the context of solar-physics
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves solar-physics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of solar-physics principles and methods
...
2. **Methodology**: Follow established solar-physics protocols and best practices
...
- Adjacent solar-physics skills for comprehensive analysis
...
7. Stay current with solar-physics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: solar-physics
