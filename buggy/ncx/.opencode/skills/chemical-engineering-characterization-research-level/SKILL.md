# Chemical Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of chemical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to chemical-engineering. This includes tasks such as:
- design components
- optimize processes
- optimize processes
...
1. The user explicitly requests characterization in the context of chemical-engineering
