# Data Visualization Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of data-visualization (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to data-visualization. This includes tasks such as:
- extract features
- visualize data
- visualize data
...
1. The user explicitly requests estimation in the context of data-visualization
