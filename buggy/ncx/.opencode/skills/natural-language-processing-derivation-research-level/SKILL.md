# Natural Language Processing Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of natural-language-processing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to natural-language-processing. This includes tasks such as:
- train models
- design systems
- analyze complexity
...
1. The user explicitly requests derivation in the context of natural-language-processing
