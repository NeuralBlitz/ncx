# Electrochemistry Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of electrochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to electrochemistry. This includes tasks such as:
- optimize yields
...
1. The user explicitly requests estimation in the context of electrochemistry
