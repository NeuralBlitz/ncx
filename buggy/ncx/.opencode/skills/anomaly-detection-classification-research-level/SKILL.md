# Anomaly Detection Classification Research Level Skill

## Overview
This skill enables classification in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to anomaly-detection. This includes tasks such as:
- analyze datasets
- test hypotheses
- predict outcomes
...
1. The user explicitly requests classification in the context of anomaly-detection
