# Time Series Analysis Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to time-series-analysis. This includes tasks such as:
- test hypotheses
- predict outcomes
- build models
...
1. The user explicitly requests prediction in the context of time-series-analysis
