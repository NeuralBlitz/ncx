# Anomaly Detection Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to anomaly-detection. This includes tasks such as:
- analyze datasets
- build models
- test hypotheses
...
1. The user explicitly requests interpretation in the context of anomaly-detection
