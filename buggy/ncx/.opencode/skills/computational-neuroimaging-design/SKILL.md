# Computational Neuroimaging Design Skill

## Overview
This skill enables design in the domain of neuroimaging (neuroscience). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.
