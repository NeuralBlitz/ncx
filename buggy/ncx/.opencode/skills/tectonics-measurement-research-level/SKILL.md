# Tectonics Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of tectonics (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to tectonics. This includes tasks such as:
- interpret data
- measure properties
- map features
...
1. The user explicitly requests measurement in the context of tectonics
