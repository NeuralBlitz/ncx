# Glaciology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to glaciology. This includes tasks such as:
- model processes
- model processes
- analyze samples
...
1. The user explicitly requests characterization in the context of glaciology
...
4. The work involves glaciology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of glaciology principles and methods
...
2. **Methodology**: Follow established glaciology protocols and best practices
...
- Adjacent glaciology skills for comprehensive analysis
...
7. Stay current with glaciology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: glaciology
