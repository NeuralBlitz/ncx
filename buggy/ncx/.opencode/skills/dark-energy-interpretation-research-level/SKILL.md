# Dark Energy Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to dark-energy. This includes tasks such as:
- model phenomena
- measure distances
- detect signals
...
1. The user explicitly requests interpretation in the context of dark-energy
