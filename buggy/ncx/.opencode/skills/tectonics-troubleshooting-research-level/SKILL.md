# Tectonics Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of tectonics (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to tectonics. This includes tasks such as:
- map features
- map features
- analyze samples
...
1. The user explicitly requests troubleshooting in the context of tectonics
