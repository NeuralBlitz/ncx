# Fluid Dynamics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of fluid-dynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to fluid-dynamics. This includes tasks such as:
- analyze motion
- measure quantities
- measure quantities
...
1. The user explicitly requests simulation in the context of fluid-dynamics
