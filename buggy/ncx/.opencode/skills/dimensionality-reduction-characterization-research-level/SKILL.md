# Dimensionality Reduction Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of dimensionality-reduction (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to dimensionality-reduction. This includes tasks such as:
- visualize data
- predict outcomes
- predict outcomes
...
1. The user explicitly requests characterization in the context of dimensionality-reduction
