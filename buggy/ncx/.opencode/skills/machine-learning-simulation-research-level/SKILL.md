# Machine Learning Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to machine-learning. This includes tasks such as:
- debug programs
...
1. The user explicitly requests simulation in the context of machine-learning
