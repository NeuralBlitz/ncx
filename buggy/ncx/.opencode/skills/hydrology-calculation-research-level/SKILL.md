# Hydrology Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of hydrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to hydrology. This includes tasks such as:
- map features
- analyze samples
- predict events
...
1. The user explicitly requests calculation in the context of hydrology
