# Semi Supervised Quantum Computing Debugging Skill

## Overview
This skill enables debugging in the domain of quantum-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to quantum-computing. This includes tasks such as:
- debug programs
- design systems
- train models
...
1. The user explicitly requests debugging in the context of quantum-computing
