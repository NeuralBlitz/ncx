# Semi Supervised Parasitology Interpretation Skill

## Overview
This skill enables interpretation in the domain of parasitology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to parasitology. This includes tasks such as:
- sequence DNA
- model populations
- analyze proteins
...
1. The user explicitly requests interpretation in the context of parasitology
