# Spectroscopy Astro Classification Research Level Skill

## Overview
This skill enables classification in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to spectroscopy-astro. This includes tasks such as:
- measure distances
- model phenomena
- model phenomena
...
1. The user explicitly requests classification in the context of spectroscopy-astro
