# Formal Verification Validation Research Level Skill

## Overview
This skill enables validation in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to formal-verification. This includes tasks such as:
- design systems
- optimize code
- train models
...
1. The user explicitly requests validation in the context of formal-verification
