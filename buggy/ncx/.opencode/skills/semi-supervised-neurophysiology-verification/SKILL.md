# Semi Supervised Neurophysiology Verification Skill

## Overview
This skill enables verification in the domain of neurophysiology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to neurophysiology. This includes tasks such as:
- model circuits
- measure responses
- measure responses
...
1. The user explicitly requests verification in the context of neurophysiology
