# Semi Supervised Spectroscopy Astro Derivation Skill

## Overview
This skill enables derivation in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to spectroscopy-astro. This includes tasks such as:
- model phenomena
- detect signals
- calculate orbits
...
1. The user explicitly requests derivation in the context of spectroscopy-astro
