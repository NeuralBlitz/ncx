# Volcanology Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of volcanology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to volcanology. This includes tasks such as:
- model processes
- analyze samples
- predict events
...
1. The user explicitly requests analysis in the context of volcanology
