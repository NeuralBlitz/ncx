# Systems Biology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of systems-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to systems-biology. This includes tasks such as:
- model populations
- analyze proteins
- model populations
...
1. The user explicitly requests characterization in the context of systems-biology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be genetic data
4. The work involves systems-biology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of systems-biology principles and methods
...
2. **Methodology**: Follow established systems-biology protocols and best practices
...
- Adjacent systems-biology skills for comprehensive analysis
...
7. Stay current with systems-biology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: systems-biology
