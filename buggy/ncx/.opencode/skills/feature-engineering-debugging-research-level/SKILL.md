# Feature Engineering Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to feature-engineering. This includes tasks such as:
- extract features
- extract features
- test hypotheses
...
1. The user explicitly requests debugging in the context of feature-engineering
