# Extragalactic Astronomy Testing Research Level Skill

## Overview
This skill enables testing in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to extragalactic-astronomy. This includes tasks such as:
- analyze spectra
- detect signals
- model phenomena
...
1. The user explicitly requests testing in the context of extragalactic-astronomy
