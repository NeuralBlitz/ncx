# Tensor Calculus Design Research Level Skill

## Overview
This skill enables design in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to tensor-calculus. This includes tasks such as:
- calculate integrals
- analyze functions
- analyze functions
...
1. The user explicitly requests design in the context of tensor-calculus
