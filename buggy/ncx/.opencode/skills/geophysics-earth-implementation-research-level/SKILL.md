# Geophysics Earth Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to geophysics-earth. This includes tasks such as:
- measure properties
- map features
- analyze samples
...
1. The user explicitly requests implementation in the context of geophysics-earth
