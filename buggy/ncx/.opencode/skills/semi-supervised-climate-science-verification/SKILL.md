# Semi Supervised Climate Science Verification Skill

## Overview
This skill enables verification in the domain of climate-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to climate-science. This includes tasks such as:
- measure properties
- predict events
- model processes
...
1. The user explicitly requests verification in the context of climate-science
