# Causal Inference Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to causal-inference. This includes tasks such as:
- visualize data
- build models
- predict outcomes
...
1. The user explicitly requests implementation in the context of causal-inference
