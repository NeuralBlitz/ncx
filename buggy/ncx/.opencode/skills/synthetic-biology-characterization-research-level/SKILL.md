# Synthetic Biology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of synthetic-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to synthetic-biology. This includes tasks such as:
- measure expression
- classify organisms
- sequence DNA
...
1. The user explicitly requests characterization in the context of synthetic-biology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be phylogenetic trees
4. The work involves synthetic-biology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of synthetic-biology principles and methods
...
2. **Methodology**: Follow established synthetic-biology protocols and best practices
...
- Adjacent synthetic-biology skills for comprehensive analysis
...
7. Stay current with synthetic-biology literature and methods
