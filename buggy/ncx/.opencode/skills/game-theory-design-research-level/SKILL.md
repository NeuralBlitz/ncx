# Game Theory Design Research Level Skill

## Overview
This skill enables design in the domain of game-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to game-theory. This includes tasks such as:
- prove theorems
- calculate integrals
- find eigenvalues
...
1. The user explicitly requests design in the context of game-theory
