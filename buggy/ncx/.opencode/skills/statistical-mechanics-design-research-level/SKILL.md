# Statistical Mechanics Design Research Level Skill

## Overview
This skill enables design in the domain of statistical-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to statistical-mechanics. This includes tasks such as:
- measure quantities
- analyze motion
- model systems
...
1. The user explicitly requests design in the context of statistical-mechanics
