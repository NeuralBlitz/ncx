# Differential Equations Classification Research Level Skill

## Overview
This skill enables classification in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to differential-equations. This includes tasks such as:
- calculate integrals
- compute derivatives
- analyze functions
...
1. The user explicitly requests classification in the context of differential-equations
