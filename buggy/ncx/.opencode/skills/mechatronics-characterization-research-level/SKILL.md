# Mechatronics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of mechatronics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to mechatronics. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of mechatronics
...
4. The work involves mechatronics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of mechatronics principles and methods
...
2. **Methodology**: Follow established mechatronics protocols and best practices
...
- Adjacent mechatronics skills for comprehensive analysis
...
7. Stay current with mechatronics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: mechatronics
