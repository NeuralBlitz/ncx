# Neutron Stars Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to neutron-stars. This includes tasks such as:
- observe objects
- detect signals
- model phenomena
...
1. The user explicitly requests debugging in the context of neutron-stars
