# Microbiology Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of microbiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to microbiology. This includes tasks such as:
- model populations
- analyze proteins
- study interactions
...
1. The user explicitly requests troubleshooting in the context of microbiology
