# Semi Supervised Category Theory Debugging Skill

## Overview
This skill enables debugging in the domain of category-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to category-theory. This includes tasks such as:
- analyze functions
- prove theorems
- prove theorems
...
1. The user explicitly requests debugging in the context of category-theory
