# Differential Equations Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to differential-equations. This includes tasks such as:
- solve equations
- solve equations
- solve equations
...
1. The user explicitly requests simulation in the context of differential-equations
