# Petrology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to petrology. This includes tasks such as:
- model processes
- model processes
- interpret data
...
1. The user explicitly requests prediction in the context of petrology
