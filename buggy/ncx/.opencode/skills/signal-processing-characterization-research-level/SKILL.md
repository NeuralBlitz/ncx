# Signal Processing Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of signal-processing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to signal-processing. This includes tasks such as:
- validate designs
- test prototypes
- validate designs
...
1. The user explicitly requests characterization in the context of signal-processing
...
4. The work involves signal-processing methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of signal-processing principles and methods
...
2. **Methodology**: Follow established signal-processing protocols and best practices
...
- Adjacent signal-processing skills for comprehensive analysis
...
7. Stay current with signal-processing literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: signal-processing
