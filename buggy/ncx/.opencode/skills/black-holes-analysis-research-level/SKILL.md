# Black Holes Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to black-holes. This includes tasks such as:
- analyze spectra
- detect signals
- detect signals
...
1. The user explicitly requests analysis in the context of black-holes
