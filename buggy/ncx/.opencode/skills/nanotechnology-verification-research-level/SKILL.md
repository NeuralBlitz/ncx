# Nanotechnology Verification Research Level Skill

## Overview
This skill enables verification in the domain of nanotechnology (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to nanotechnology. This includes tasks such as:
- validate designs
- test prototypes
- design components
...
1. The user explicitly requests verification in the context of nanotechnology
