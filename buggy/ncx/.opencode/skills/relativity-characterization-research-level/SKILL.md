# Relativity Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of relativity (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to relativity. This includes tasks such as:
- analyze motion
- measure quantities
- analyze motion
...
1. The user explicitly requests characterization in the context of relativity
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves relativity methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of relativity principles and methods
...
2. **Methodology**: Follow established relativity protocols and best practices
...
- Adjacent relativity skills for comprehensive analysis
...
7. Stay current with relativity literature and methods
