# Differential Equations Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to differential-equations. This includes tasks such as:
- compute derivatives
- calculate integrals
- compute derivatives
...
1. The user explicitly requests derivation in the context of differential-equations
