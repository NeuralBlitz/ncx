# Ecology Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of ecology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to ecology. This includes tasks such as:
- model populations
- sequence DNA
- study interactions
...
1. The user explicitly requests interpretation in the context of ecology
