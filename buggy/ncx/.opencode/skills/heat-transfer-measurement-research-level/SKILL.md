# Heat Transfer Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to heat-transfer. This includes tasks such as:
- optimize processes
- design components
- optimize processes
...
1. The user explicitly requests measurement in the context of heat-transfer
