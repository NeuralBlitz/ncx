# Classical Mechanics Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of classical-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to classical-mechanics. This includes tasks such as:
- model systems
- analyze motion
- calculate forces
...
1. The user explicitly requests synthesis in the context of classical-mechanics
