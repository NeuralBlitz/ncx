# Meteorology Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of meteorology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to meteorology. This includes tasks such as:
- map features
- map features
- predict events
...
1. The user explicitly requests optimization in the context of meteorology
