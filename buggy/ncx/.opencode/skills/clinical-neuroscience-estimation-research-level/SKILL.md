# Clinical Neuroscience Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of clinical-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to clinical-neuroscience. This includes tasks such as:
- measure responses
...
1. The user explicitly requests estimation in the context of clinical-neuroscience
