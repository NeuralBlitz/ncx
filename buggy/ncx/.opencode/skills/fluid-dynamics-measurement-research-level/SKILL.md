# Fluid Dynamics Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of fluid-dynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to fluid-dynamics. This includes tasks such as:
- measure quantities
- model systems
- calculate forces
...
1. The user explicitly requests measurement in the context of fluid-dynamics
