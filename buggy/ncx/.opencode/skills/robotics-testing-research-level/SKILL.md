# Robotics Testing Research Level Skill

## Overview
This skill enables testing in the domain of robotics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to robotics. This includes tasks such as:
- train models
- design systems
- analyze complexity
...
1. The user explicitly requests testing in the context of robotics
