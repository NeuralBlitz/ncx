# Radio Astronomy Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to radio-astronomy. This includes tasks such as:
- measure distances
- detect signals
- measure distances
...
1. The user explicitly requests prediction in the context of radio-astronomy
