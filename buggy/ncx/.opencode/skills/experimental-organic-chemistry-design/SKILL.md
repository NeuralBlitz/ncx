# Experimental Organic Chemistry Design Skill

## Overview
This skill enables design in the domain of organic-chemistry (chemistry). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
