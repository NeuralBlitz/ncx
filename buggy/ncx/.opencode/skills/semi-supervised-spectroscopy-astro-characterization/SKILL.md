# Semi Supervised Spectroscopy Astro Characterization Skill

## Overview
This skill enables characterization in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to spectroscopy-astro. This includes tasks such as:
- detect signals
- model phenomena
- analyze spectra
...
1. The user explicitly requests characterization in the context of spectroscopy-astro
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves spectroscopy-astro methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of spectroscopy-astro principles and methods
...
2. **Methodology**: Follow established spectroscopy-astro protocols and best practices
...
- Adjacent spectroscopy-astro skills for comprehensive analysis
...
7. Stay current with spectroscopy-astro literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: spectroscopy-astro
