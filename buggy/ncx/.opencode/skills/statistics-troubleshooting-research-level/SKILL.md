# Statistics Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of statistics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to statistics. This includes tasks such as:
- prove theorems
- analyze functions
- prove theorems
...
1. The user explicitly requests troubleshooting in the context of statistics
