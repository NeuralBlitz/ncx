# Game Theory Validation Research Level Skill

## Overview
This skill enables validation in the domain of game-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to game-theory. This includes tasks such as:
- solve equations
- compute derivatives
- compute derivatives
...
1. The user explicitly requests validation in the context of game-theory
