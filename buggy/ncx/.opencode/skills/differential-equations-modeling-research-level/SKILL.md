# Differential Equations Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to differential-equations. This includes tasks such as:
- solve equations
- compute derivatives
- solve equations
...
1. The user explicitly requests modeling in the context of differential-equations
