# Soil Science Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to soil-science. This includes tasks such as:
- measure properties
- measure properties
- map features
...
1. The user explicitly requests calculation in the context of soil-science
