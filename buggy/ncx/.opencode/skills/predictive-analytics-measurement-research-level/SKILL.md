# Predictive Analytics Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to predictive-analytics. This includes tasks such as:
- predict outcomes
- test hypotheses
- extract features
...
1. The user explicitly requests measurement in the context of predictive-analytics
