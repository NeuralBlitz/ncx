# Remote Sensing Design Research Level Skill

## Overview
This skill enables design in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to remote-sensing. This includes tasks such as:
- model processes
- model processes
- predict events
...
1. The user explicitly requests design in the context of remote-sensing
