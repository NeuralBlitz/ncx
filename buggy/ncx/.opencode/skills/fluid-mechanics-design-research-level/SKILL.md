# Fluid Mechanics Design Research Level Skill

## Overview
This skill enables design in the domain of fluid-mechanics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to fluid-mechanics. This includes tasks such as:
- design components
- test prototypes
...
1. The user explicitly requests design in the context of fluid-mechanics
