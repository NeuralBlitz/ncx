# Functional Analysis Design Research Level Skill

## Overview
This skill enables design in the domain of functional-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to functional-analysis. This includes tasks such as:
- compute derivatives
- calculate integrals
- prove theorems
...
1. The user explicitly requests design in the context of functional-analysis
