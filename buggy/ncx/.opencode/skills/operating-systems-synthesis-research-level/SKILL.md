# Operating Systems Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of operating-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to operating-systems. This includes tasks such as:
- optimize code
- optimize code
- design systems
...
1. The user explicitly requests synthesis in the context of operating-systems
