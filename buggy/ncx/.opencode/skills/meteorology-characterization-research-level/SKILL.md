# Meteorology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of meteorology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to meteorology. This includes tasks such as:
- map features
- interpret data
- analyze samples
...
1. The user explicitly requests characterization in the context of meteorology
...
4. The work involves meteorology methodologies or techniques
...
2. **Methodology**: Follow established meteorology protocols and best practices
...
7. Stay current with meteorology literature and methods
