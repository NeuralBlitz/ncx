# Predictive Analytics Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to predictive-analytics. This includes tasks such as:
- analyze datasets
- analyze datasets
- analyze datasets
...
1. The user explicitly requests optimization in the context of predictive-analytics
