# Stellar Astronomy Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to stellar-astronomy. This includes tasks such as:
- calculate orbits
- calculate orbits
- model phenomena
...
1. The user explicitly requests estimation in the context of stellar-astronomy
