# Power Systems Testing Research Level Skill

## Overview
This skill enables testing in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to power-systems. This includes tasks such as:
- optimize processes
- optimize processes
- design components
...
1. The user explicitly requests testing in the context of power-systems
