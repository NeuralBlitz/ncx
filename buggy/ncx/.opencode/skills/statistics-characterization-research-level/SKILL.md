# Statistics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of statistics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to statistics. This includes tasks such as:
- analyze functions
- find eigenvalues
- find eigenvalues
...
1. The user explicitly requests characterization in the context of statistics
...
4. The work involves statistics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of statistics principles and methods
...
2. **Methodology**: Follow established statistics protocols and best practices
...
- Adjacent statistics skills for comprehensive analysis
...
7. Stay current with statistics literature and methods
