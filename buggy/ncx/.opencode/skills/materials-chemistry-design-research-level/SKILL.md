# Materials Chemistry Design Research Level Skill

## Overview
This skill enables design in the domain of materials-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to materials-chemistry. This includes tasks such as:
- predict reactions
- analyze spectra
- predict reactions
...
1. The user explicitly requests design in the context of materials-chemistry
