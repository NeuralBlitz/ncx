# Gravitational Waves Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to gravitational-waves. This includes tasks such as:
- detect signals
- analyze spectra
- model phenomena
...
1. The user explicitly requests simulation in the context of gravitational-waves
