# Semi Supervised Photonics Debugging Skill

## Overview
This skill enables debugging in the domain of photonics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to photonics. This includes tasks such as:
- model systems
- predict behavior
- predict behavior
...
1. The user explicitly requests debugging in the context of photonics
