# Mycology Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of mycology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to mycology. This includes tasks such as:
- classify organisms
- classify organisms
- model populations
...
1. The user explicitly requests estimation in the context of mycology
