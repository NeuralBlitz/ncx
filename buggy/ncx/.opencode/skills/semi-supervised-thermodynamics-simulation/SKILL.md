# Semi Supervised Thermodynamics Simulation Skill

## Overview
This skill enables simulation in the domain of thermodynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to thermodynamics. This includes tasks such as:
- model systems
- calculate forces
- model systems
...
1. The user explicitly requests simulation in the context of thermodynamics
