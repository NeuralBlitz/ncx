# Machine Learning Classification Research Level Skill

## Overview
This skill enables classification in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to machine-learning. This includes tasks such as:
...
1. The user explicitly requests classification in the context of machine-learning
