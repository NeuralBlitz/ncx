# Electrical Engineering Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of electrical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to electrical-engineering. This includes tasks such as:
- optimize processes
- design components
- optimize processes
...
1. The user explicitly requests analysis in the context of electrical-engineering
