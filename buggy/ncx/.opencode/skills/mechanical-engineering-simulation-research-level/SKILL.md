# Mechanical Engineering Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of mechanical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to mechanical-engineering. This includes tasks such as:
- optimize processes
- validate designs
- optimize processes
...
1. The user explicitly requests simulation in the context of mechanical-engineering
