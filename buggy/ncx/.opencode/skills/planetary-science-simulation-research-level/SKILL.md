# Planetary Science Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to planetary-science. This includes tasks such as:
- predict events
- measure properties
- predict events
...
1. The user explicitly requests simulation in the context of planetary-science
