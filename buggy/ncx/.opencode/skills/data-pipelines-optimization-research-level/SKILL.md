# Data Pipelines Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to data-pipelines. This includes tasks such as:
- test hypotheses
- visualize data
- test hypotheses
...
1. The user explicitly requests optimization in the context of data-pipelines
