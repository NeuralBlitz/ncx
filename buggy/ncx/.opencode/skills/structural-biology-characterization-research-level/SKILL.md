# Structural Biology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of structural-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to structural-biology. This includes tasks such as:
- sequence DNA
- study interactions
- model populations
...
1. The user explicitly requests characterization in the context of structural-biology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be genetic data
4. The work involves structural-biology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of structural-biology principles and methods
...
2. **Methodology**: Follow established structural-biology protocols and best practices
...
- Adjacent structural-biology skills for comprehensive analysis
...
7. Stay current with structural-biology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: structural-biology
