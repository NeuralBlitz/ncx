# Planetary Science Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to planetary-science. This includes tasks such as:
- measure properties
- analyze samples
- map features
...
1. The user explicitly requests debugging in the context of planetary-science
