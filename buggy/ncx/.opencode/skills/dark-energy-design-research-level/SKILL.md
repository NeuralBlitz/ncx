# Dark Energy Design Research Level Skill

## Overview
This skill enables design in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to dark-energy. This includes tasks such as:
- measure distances
- model phenomena
- calculate orbits
...
1. The user explicitly requests design in the context of dark-energy
