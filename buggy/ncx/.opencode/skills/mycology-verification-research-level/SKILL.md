# Mycology Verification Research Level Skill

## Overview
This skill enables verification in the domain of mycology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to mycology. This includes tasks such as:
- study interactions
- sequence DNA
- measure expression
...
1. The user explicitly requests verification in the context of mycology
