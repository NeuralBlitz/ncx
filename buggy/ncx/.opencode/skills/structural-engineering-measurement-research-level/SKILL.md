# Structural Engineering Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of structural-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to structural-engineering. This includes tasks such as:
- validate designs
- analyze structures
- test prototypes
...
1. The user explicitly requests measurement in the context of structural-engineering
