# Observational Astronomy Classification Research Level Skill

## Overview
This skill enables classification in the domain of observational-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to observational-astronomy. This includes tasks such as:
- detect signals
- calculate orbits
- calculate orbits
...
1. The user explicitly requests classification in the context of observational-astronomy
