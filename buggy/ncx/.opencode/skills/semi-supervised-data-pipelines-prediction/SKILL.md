# Semi Supervised Data Pipelines Prediction Skill

## Overview
This skill enables prediction in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to data-pipelines. This includes tasks such as:
- predict outcomes
- visualize data
- extract features
...
1. The user explicitly requests prediction in the context of data-pipelines
