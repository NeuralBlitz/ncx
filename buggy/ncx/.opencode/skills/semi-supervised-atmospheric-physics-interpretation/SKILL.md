# Semi Supervised Atmospheric Physics Interpretation Skill

## Overview
This skill enables interpretation in the domain of atmospheric-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to atmospheric-physics. This includes tasks such as:
- calculate forces
...
1. The user explicitly requests interpretation in the context of atmospheric-physics
