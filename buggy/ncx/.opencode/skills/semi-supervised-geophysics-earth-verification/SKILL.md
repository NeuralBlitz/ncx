# Semi Supervised Geophysics Earth Verification Skill

## Overview
This skill enables verification in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to geophysics-earth. This includes tasks such as:
- interpret data
- measure properties
- predict events
...
1. The user explicitly requests verification in the context of geophysics-earth
