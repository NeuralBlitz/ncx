# Semi Supervised Computational Neuroscience Optimization Skill

## Overview
This skill enables optimization in the domain of computational-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to computational-neuroscience. This includes tasks such as:
- model circuits
- study behavior
- map connections
...
1. The user explicitly requests optimization in the context of computational-neuroscience
