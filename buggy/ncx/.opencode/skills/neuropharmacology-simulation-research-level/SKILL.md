# Neuropharmacology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of neuropharmacology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to neuropharmacology. This includes tasks such as:
- measure responses
- measure responses
- study behavior
...
1. The user explicitly requests simulation in the context of neuropharmacology
