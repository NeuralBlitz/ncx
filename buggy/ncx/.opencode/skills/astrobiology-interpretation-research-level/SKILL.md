# Astrobiology Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of astrobiology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to astrobiology. This includes tasks such as:
- calculate orbits
- calculate orbits
- calculate orbits
...
1. The user explicitly requests interpretation in the context of astrobiology
