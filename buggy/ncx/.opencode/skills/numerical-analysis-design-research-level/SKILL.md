# Numerical Analysis Design Research Level Skill

## Overview
This skill enables design in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to numerical-analysis. This includes tasks such as:
- analyze functions
- calculate integrals
- analyze functions
...
1. The user explicitly requests design in the context of numerical-analysis
