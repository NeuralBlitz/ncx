# Time Series Analysis Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to time-series-analysis. This includes tasks such as:
- test hypotheses
- extract features
- predict outcomes
...
1. The user explicitly requests analysis in the context of time-series-analysis
