# Nuclear Engineering Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of nuclear-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to nuclear-engineering. This includes tasks such as:
- design components
- analyze structures
- design components
...
1. The user explicitly requests derivation in the context of nuclear-engineering
