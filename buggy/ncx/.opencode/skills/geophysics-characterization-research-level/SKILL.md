# Geophysics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of geophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to geophysics. This includes tasks such as:
- predict behavior
- measure quantities
- predict behavior
...
1. The user explicitly requests characterization in the context of geophysics
...
4. The work involves geophysics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of geophysics principles and methods
...
2. **Methodology**: Follow established geophysics protocols and best practices
...
- Adjacent geophysics skills for comprehensive analysis
...
7. Stay current with geophysics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: geophysics
