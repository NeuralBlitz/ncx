# Cloud Computing Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of cloud-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to cloud-computing. This includes tasks such as:
- train models
- debug programs
- design systems
...
1. The user explicitly requests optimization in the context of cloud-computing
