# Semi Supervised Glaciology Calculation Skill

## Overview
This skill enables calculation in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to glaciology. This includes tasks such as:
- analyze samples
- analyze samples
- model processes
...
1. The user explicitly requests calculation in the context of glaciology
