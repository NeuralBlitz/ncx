# Linear Algebra Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to linear-algebra. This includes tasks such as:
- analyze functions
- calculate integrals
- prove theorems
...
1. The user explicitly requests characterization in the context of linear-algebra
...
4. The work involves linear-algebra methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of linear-algebra principles and methods
...
2. **Methodology**: Follow established linear-algebra protocols and best practices
...
- Adjacent linear-algebra skills for comprehensive analysis
...
7. Stay current with linear-algebra literature and methods
