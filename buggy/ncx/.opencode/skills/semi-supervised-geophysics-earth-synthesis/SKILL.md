# Semi Supervised Geophysics Earth Synthesis Skill

## Overview
This skill enables synthesis in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to geophysics-earth. This includes tasks such as:
- model processes
- interpret data
- measure properties
...
1. The user explicitly requests synthesis in the context of geophysics-earth
