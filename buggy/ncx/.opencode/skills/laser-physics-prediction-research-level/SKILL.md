# Laser Physics Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to laser-physics. This includes tasks such as:
- predict behavior
- calculate forces
- model systems
...
1. The user explicitly requests prediction in the context of laser-physics
