# Geochemistry Earth Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of geochemistry-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to geochemistry-earth. This includes tasks such as:
- map features
- measure properties
- analyze samples
...
1. The user explicitly requests synthesis in the context of geochemistry-earth
