# Optogenetics Design Expert Skill

## Overview
This skill enables design in the domain of optogenetics (neuroscience). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
