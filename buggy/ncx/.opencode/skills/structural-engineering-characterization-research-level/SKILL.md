# Structural Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of structural-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to structural-engineering. This includes tasks such as:
- optimize processes
- validate designs
- design components
...
1. The user explicitly requests characterization in the context of structural-engineering
...
4. The work involves structural-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of structural-engineering principles and methods
...
2. **Methodology**: Follow established structural-engineering protocols and best practices
...
- Adjacent structural-engineering skills for comprehensive analysis
...
7. Stay current with structural-engineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: structural-engineering
