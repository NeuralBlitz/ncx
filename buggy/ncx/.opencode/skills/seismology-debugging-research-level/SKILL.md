# Seismology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of seismology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to seismology. This includes tasks such as:
- interpret data
- measure properties
- interpret data
...
1. The user explicitly requests debugging in the context of seismology
