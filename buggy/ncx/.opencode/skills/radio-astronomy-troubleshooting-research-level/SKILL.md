# Radio Astronomy Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to radio-astronomy. This includes tasks such as:
- detect signals
- measure distances
- model phenomena
...
1. The user explicitly requests troubleshooting in the context of radio-astronomy
