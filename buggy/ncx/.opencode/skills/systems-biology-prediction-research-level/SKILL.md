# Systems Biology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of systems-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to systems-biology. This includes tasks such as:
- analyze proteins
- model populations
- classify organisms
...
1. The user explicitly requests prediction in the context of systems-biology
