# Mechanical Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of mechanical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to mechanical-engineering. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of mechanical-engineering
...
4. The work involves mechanical-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of mechanical-engineering principles and methods
...
2. **Methodology**: Follow established mechanical-engineering protocols and best practices
...
- Adjacent mechanical-engineering skills for comprehensive analysis
...
7. Stay current with mechanical-engineering literature and methods
