# Electrical Engineering Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of electrical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to electrical-engineering. This includes tasks such as:
- test prototypes
- optimize processes
- optimize processes
...
1. The user explicitly requests simulation in the context of electrical-engineering
