# Planetary Science Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to planetary-science. This includes tasks such as:
- map features
- analyze samples
- measure properties
...
1. The user explicitly requests prediction in the context of planetary-science
