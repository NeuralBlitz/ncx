# Systems Engineering Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to systems-engineering. This includes tasks such as:
- optimize processes
- design components
- test prototypes
...
1. The user explicitly requests synthesis in the context of systems-engineering
