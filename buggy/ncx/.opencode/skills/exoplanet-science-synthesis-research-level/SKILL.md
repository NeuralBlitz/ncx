# Exoplanet Science Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to exoplanet-science. This includes tasks such as:
- observe objects
- detect signals
- measure distances
...
1. The user explicitly requests synthesis in the context of exoplanet-science
