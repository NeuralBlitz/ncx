# Experimental Design Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to experimental-design. This includes tasks such as:
- predict outcomes
- visualize data
- visualize data
...
1. The user explicitly requests modeling in the context of experimental-design
