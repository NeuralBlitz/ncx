# Meteorology Debugging Expert Skill

## Overview
This skill enables debugging in the domain of meteorology (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
