# Discrete Math Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to discrete-math. This includes tasks such as:
- analyze functions
- analyze functions
- calculate integrals
...
1. The user explicitly requests optimization in the context of discrete-math
