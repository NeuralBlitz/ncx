# Distributed Systems Design Research Level Skill

## Overview
This skill enables design in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to distributed-systems. This includes tasks such as:
- debug programs
- design systems
- train models
...
1. The user explicitly requests design in the context of distributed-systems
