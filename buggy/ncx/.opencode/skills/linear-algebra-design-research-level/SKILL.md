# Linear Algebra Design Research Level Skill

## Overview
This skill enables design in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to linear-algebra. This includes tasks such as:
- compute derivatives
- calculate integrals
- solve equations
...
1. The user explicitly requests design in the context of linear-algebra
