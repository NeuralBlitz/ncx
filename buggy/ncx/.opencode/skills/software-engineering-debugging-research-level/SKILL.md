# Software Engineering Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of software-engineering (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to software-engineering. This includes tasks such as:
- design systems
...
1. The user explicitly requests debugging in the context of software-engineering
