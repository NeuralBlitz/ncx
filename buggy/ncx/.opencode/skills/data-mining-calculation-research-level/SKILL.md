# Data Mining Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of data-mining (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to data-mining. This includes tasks such as:
- visualize data
- visualize data
- visualize data
...
1. The user explicitly requests calculation in the context of data-mining
