# Optimization Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of optimization (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to optimization. This includes tasks such as:
- find eigenvalues
- analyze functions
- prove theorems
...
1. The user explicitly requests simulation in the context of optimization
