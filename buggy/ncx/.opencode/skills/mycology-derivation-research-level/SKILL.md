# Mycology Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of mycology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to mycology. This includes tasks such as:
- measure expression
- measure expression
- measure expression
...
1. The user explicitly requests derivation in the context of mycology
