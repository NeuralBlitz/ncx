# Zoology Classification Research Level Skill

## Overview
This skill enables classification in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to zoology. This includes tasks such as:
- classify organisms
- model populations
- classify organisms
...
1. The user explicitly requests classification in the context of zoology
