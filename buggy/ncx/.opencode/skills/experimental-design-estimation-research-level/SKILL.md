# Experimental Design Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to experimental-design. This includes tasks such as:
- build models
- test hypotheses
- build models
...
1. The user explicitly requests estimation in the context of experimental-design
