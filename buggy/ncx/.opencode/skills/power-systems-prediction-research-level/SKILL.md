# Power Systems Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to power-systems. This includes tasks such as:
- test prototypes
- design components
...
1. The user explicitly requests prediction in the context of power-systems
