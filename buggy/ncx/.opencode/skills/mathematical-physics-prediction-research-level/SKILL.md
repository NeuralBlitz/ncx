# Mathematical Physics Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of mathematical-physics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to mathematical-physics. This includes tasks such as:
- find eigenvalues
- calculate integrals
- solve equations
...
1. The user explicitly requests prediction in the context of mathematical-physics
