# Geology Optimization Intermediate Skill

## Overview
This skill enables optimization in the domain of geology (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to geology. This includes tasks such as:
- analyze samples
- model processes
- map features
...
1. The user explicitly requests optimization in the context of geology
