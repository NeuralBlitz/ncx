# Semi Supervised Genetics Optimization Skill

## Overview
This skill enables optimization in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to genetics. This includes tasks such as:
- classify organisms
- analyze proteins
- sequence DNA
...
1. The user explicitly requests optimization in the context of genetics
