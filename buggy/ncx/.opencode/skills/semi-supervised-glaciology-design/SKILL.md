# Semi Supervised Glaciology Design Skill

## Overview
This skill enables design in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to glaciology. This includes tasks such as:
- map features
- interpret data
- interpret data
...
1. The user explicitly requests design in the context of glaciology
