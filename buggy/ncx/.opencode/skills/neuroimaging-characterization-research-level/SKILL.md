# Neuroimaging Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of neuroimaging (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to neuroimaging. This includes tasks such as:
- map connections
...
1. The user explicitly requests characterization in the context of neuroimaging
2. The task requires research-level-level understanding of neuroscience principles
3. The output needs to be neural data
4. The work involves neuroimaging methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of neuroimaging principles and methods
...
2. **Methodology**: Follow established neuroimaging protocols and best practices
...
- Adjacent neuroimaging skills for comprehensive analysis
...
7. Stay current with neuroimaging literature and methods

## Version Information
- Complexity Level: research-level
- Domain: neuroscience
- Subdiscipline: neuroimaging
