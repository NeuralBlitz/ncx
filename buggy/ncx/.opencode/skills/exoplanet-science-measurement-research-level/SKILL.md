# Exoplanet Science Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to exoplanet-science. This includes tasks such as:
- observe objects
- detect signals
- model phenomena
...
1. The user explicitly requests measurement in the context of exoplanet-science
