# Exoplanet Science Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to exoplanet-science. This includes tasks such as:
- analyze spectra
- analyze spectra
- calculate orbits
...
1. The user explicitly requests implementation in the context of exoplanet-science
