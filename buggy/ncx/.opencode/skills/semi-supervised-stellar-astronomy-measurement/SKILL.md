# Semi Supervised Stellar Astronomy Measurement Skill

## Overview
This skill enables measurement in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to stellar-astronomy. This includes tasks such as:
- model phenomena
- analyze spectra
- analyze spectra
...
1. The user explicitly requests measurement in the context of stellar-astronomy
