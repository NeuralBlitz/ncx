# Thermodynamics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of thermodynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to thermodynamics. This includes tasks such as:
- predict behavior
- analyze motion
- calculate forces
...
1. The user explicitly requests characterization in the context of thermodynamics
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves thermodynamics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of thermodynamics principles and methods
...
2. **Methodology**: Follow established thermodynamics protocols and best practices
...
- Adjacent thermodynamics skills for comprehensive analysis
...
7. Stay current with thermodynamics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: thermodynamics
