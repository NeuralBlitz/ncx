# Environmental Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of environmental-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to environmental-engineering. This includes tasks such as:
- design components
...
1. The user explicitly requests characterization in the context of environmental-engineering
...
4. The work involves environmental-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of environmental-engineering principles and methods
...
2. **Methodology**: Follow established environmental-engineering protocols and best practices
...
- Adjacent environmental-engineering skills for comprehensive analysis
...
7. Stay current with environmental-engineering literature and methods
