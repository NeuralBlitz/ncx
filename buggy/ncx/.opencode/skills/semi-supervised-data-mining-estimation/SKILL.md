# Semi Supervised Data Mining Estimation Skill

## Overview
This skill enables estimation in the domain of data-mining (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to data-mining. This includes tasks such as:
- visualize data
- visualize data
- extract features
...
1. The user explicitly requests estimation in the context of data-mining
