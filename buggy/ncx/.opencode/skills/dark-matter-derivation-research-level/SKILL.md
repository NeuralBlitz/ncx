# Dark Matter Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to dark-matter. This includes tasks such as:
- measure distances
- measure distances
- analyze spectra
...
1. The user explicitly requests derivation in the context of dark-matter
