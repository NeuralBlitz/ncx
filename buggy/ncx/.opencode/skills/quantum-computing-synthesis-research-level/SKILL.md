# Quantum Computing Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of quantum-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to quantum-computing. This includes tasks such as:
- design systems
- train models
- optimize code
...
1. The user explicitly requests synthesis in the context of quantum-computing
