# Programming Languages Testing Research Level Skill

## Overview
This skill enables testing in the domain of programming-languages (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to programming-languages. This includes tasks such as:
- debug programs
- design systems
- design systems
...
1. The user explicitly requests testing in the context of programming-languages
