# Geophysics Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of geophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to geophysics. This includes tasks such as:
- analyze motion
- predict behavior
- measure quantities
...
1. The user explicitly requests interpretation in the context of geophysics
