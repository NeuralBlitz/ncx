# Recommender Systems Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of recommender-systems (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to recommender-systems. This includes tasks such as:
- visualize data
- test hypotheses
- extract features
...
1. The user explicitly requests estimation in the context of recommender-systems
