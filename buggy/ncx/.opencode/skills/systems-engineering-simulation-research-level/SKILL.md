# Systems Engineering Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to systems-engineering. This includes tasks such as:
- design components
- test prototypes
...
1. The user explicitly requests simulation in the context of systems-engineering
