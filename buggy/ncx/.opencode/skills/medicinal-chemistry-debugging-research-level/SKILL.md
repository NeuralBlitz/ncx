# Medicinal Chemistry Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of medicinal-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to medicinal-chemistry. This includes tasks such as:
- optimize yields
- predict reactions
...
1. The user explicitly requests debugging in the context of medicinal-chemistry
