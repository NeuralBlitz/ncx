# Molecular Biology Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of molecular-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to molecular-biology. This includes tasks such as:
- measure expression
- model populations
- classify organisms
...
1. The user explicitly requests measurement in the context of molecular-biology
