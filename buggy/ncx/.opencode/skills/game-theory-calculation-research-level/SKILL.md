# Game Theory Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of game-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to game-theory. This includes tasks such as:
- analyze functions
- find eigenvalues
- compute derivatives
...
1. The user explicitly requests calculation in the context of game-theory
