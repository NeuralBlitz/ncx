# Semi Supervised Neutron Stars Design Skill

## Overview
This skill enables design in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to neutron-stars. This includes tasks such as:
- model phenomena
- calculate orbits
- model phenomena
...
1. The user explicitly requests design in the context of neutron-stars
