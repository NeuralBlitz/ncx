# Virology Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of virology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to virology. This includes tasks such as:
- classify organisms
- analyze proteins
- sequence DNA
...
1. The user explicitly requests synthesis in the context of virology
