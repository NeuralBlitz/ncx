# Quantum Computing Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of quantum-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to quantum-computing. This includes tasks such as:
- debug programs
- debug programs
- analyze complexity
...
1. The user explicitly requests calculation in the context of quantum-computing
