# Semi Supervised Optimization Optimization Skill

## Overview
This skill enables optimization in the domain of optimization (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to optimization. This includes tasks such as:
- compute derivatives
- find eigenvalues
- solve equations
...
1. The user explicitly requests optimization in the context of optimization
