# Operating Systems Verification Research Level Skill

## Overview
This skill enables verification in the domain of operating-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to operating-systems. This includes tasks such as:
- debug programs
- train models
- debug programs
...
1. The user explicitly requests verification in the context of operating-systems
