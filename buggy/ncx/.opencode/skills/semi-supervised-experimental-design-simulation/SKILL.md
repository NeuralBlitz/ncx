# Semi Supervised Experimental Design Simulation Skill

## Overview
This skill enables simulation in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to experimental-design. This includes tasks such as:
- predict outcomes
- test hypotheses
- extract features
...
1. The user explicitly requests simulation in the context of experimental-design
