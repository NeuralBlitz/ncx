# Mineralogy Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of mineralogy (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to mineralogy. This includes tasks such as:
- measure properties
- model processes
- predict events
...
1. The user explicitly requests estimation in the context of mineralogy
