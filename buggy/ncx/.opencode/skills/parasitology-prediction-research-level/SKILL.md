# Parasitology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of parasitology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to parasitology. This includes tasks such as:
- analyze proteins
- analyze proteins
- analyze proteins
...
1. The user explicitly requests prediction in the context of parasitology
