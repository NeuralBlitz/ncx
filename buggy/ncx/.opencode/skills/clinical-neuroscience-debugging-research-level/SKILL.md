# Clinical Neuroscience Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of clinical-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to clinical-neuroscience. This includes tasks such as:
- measure responses
- study behavior
...
1. The user explicitly requests debugging in the context of clinical-neuroscience
