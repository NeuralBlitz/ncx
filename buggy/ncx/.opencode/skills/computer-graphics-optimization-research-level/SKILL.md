# Computer Graphics Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of computer-graphics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to computer-graphics. This includes tasks such as:
- train models
- train models
- train models
...
1. The user explicitly requests optimization in the context of computer-graphics
