# Planetary Science Testing Research Level Skill

## Overview
This skill enables testing in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to planetary-science. This includes tasks such as:
- interpret data
- map features
- interpret data
...
1. The user explicitly requests testing in the context of planetary-science
