# Semi Supervised Manufacturing Synthesis Skill

## Overview
This skill enables synthesis in the domain of manufacturing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to manufacturing. This includes tasks such as:
- validate designs
- analyze structures
- analyze structures
...
1. The user explicitly requests synthesis in the context of manufacturing
