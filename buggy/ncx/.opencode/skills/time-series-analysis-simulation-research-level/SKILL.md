# Time Series Analysis Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to time-series-analysis. This includes tasks such as:
- visualize data
- extract features
- test hypotheses
...
1. The user explicitly requests simulation in the context of time-series-analysis
