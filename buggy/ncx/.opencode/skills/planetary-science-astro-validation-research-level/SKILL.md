# Planetary Science Astro Validation Research Level Skill

## Overview
This skill enables validation in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to planetary-science-astro. This includes tasks such as:
- model phenomena
- model phenomena
- measure distances
...
1. The user explicitly requests validation in the context of planetary-science-astro
