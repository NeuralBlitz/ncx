# Semi Supervised Heat Transfer Characterization Skill

## Overview
This skill enables characterization in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to heat-transfer. This includes tasks such as:
- validate designs
- validate designs
- test prototypes
...
1. The user explicitly requests characterization in the context of heat-transfer
...
4. The work involves heat-transfer methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of heat-transfer principles and methods
...
2. **Methodology**: Follow established heat-transfer protocols and best practices
...
- Adjacent heat-transfer skills for comprehensive analysis
...
7. Stay current with heat-transfer literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: heat-transfer
