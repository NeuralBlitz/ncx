# Planetary Science Astro Design Research Level Skill

## Overview
This skill enables design in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to planetary-science-astro. This includes tasks such as:
- measure distances
- detect signals
- observe objects
...
1. The user explicitly requests design in the context of planetary-science-astro
