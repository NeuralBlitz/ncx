# Soil Science Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to soil-science. This includes tasks such as:
- measure properties
- model processes
- measure properties
...
1. The user explicitly requests measurement in the context of soil-science
