# Semi Supervised Mechatronics Derivation Skill

## Overview
This skill enables derivation in the domain of mechatronics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to mechatronics. This includes tasks such as:
- test prototypes
- design components
...
1. The user explicitly requests derivation in the context of mechatronics
