# Solar Physics Validation Research Level Skill

## Overview
This skill enables validation in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to solar-physics. This includes tasks such as:
- analyze spectra
- measure distances
- analyze spectra
...
1. The user explicitly requests validation in the context of solar-physics
