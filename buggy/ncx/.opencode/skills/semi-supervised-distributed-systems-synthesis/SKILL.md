# Semi Supervised Distributed Systems Synthesis Skill

## Overview
This skill enables synthesis in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to distributed-systems. This includes tasks such as:
- optimize code
- train models
- design systems
...
1. The user explicitly requests synthesis in the context of distributed-systems
