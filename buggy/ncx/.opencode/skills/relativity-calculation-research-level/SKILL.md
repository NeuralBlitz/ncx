# Relativity Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of relativity (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to relativity. This includes tasks such as:
- measure quantities
- calculate forces
- model systems
...
1. The user explicitly requests calculation in the context of relativity
