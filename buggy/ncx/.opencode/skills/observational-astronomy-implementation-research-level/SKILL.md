# Observational Astronomy Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of observational-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to observational-astronomy. This includes tasks such as:
- measure distances
- detect signals
- detect signals
...
1. The user explicitly requests implementation in the context of observational-astronomy
