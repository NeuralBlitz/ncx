# Tensor Calculus Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to tensor-calculus. This includes tasks such as:
- analyze functions
- analyze functions
- compute derivatives
...
1. The user explicitly requests estimation in the context of tensor-calculus
