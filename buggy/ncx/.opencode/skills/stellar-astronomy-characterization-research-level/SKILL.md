# Stellar Astronomy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to stellar-astronomy. This includes tasks such as:
- model phenomena
- calculate orbits
- observe objects
...
1. The user explicitly requests characterization in the context of stellar-astronomy
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be astronomical data
4. The work involves stellar-astronomy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of stellar-astronomy principles and methods
...
2. **Methodology**: Follow established stellar-astronomy protocols and best practices
...
- Adjacent stellar-astronomy skills for comprehensive analysis
...
7. Stay current with stellar-astronomy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: stellar-astronomy
