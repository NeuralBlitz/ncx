# Extragalactic Astronomy Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to extragalactic-astronomy. This includes tasks such as:
- detect signals
- measure distances
- analyze spectra
...
1. The user explicitly requests implementation in the context of extragalactic-astronomy
