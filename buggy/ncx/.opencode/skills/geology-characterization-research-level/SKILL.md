# Geology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of geology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to geology. This includes tasks such as:
- model processes
- analyze samples
- map features
...
1. The user explicitly requests characterization in the context of geology
...
4. The work involves geology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of geology principles and methods
...
2. **Methodology**: Follow established geology protocols and best practices
...
- Adjacent geology skills for comprehensive analysis
...
7. Stay current with geology literature and methods
