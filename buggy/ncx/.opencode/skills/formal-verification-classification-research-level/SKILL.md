# Formal Verification Classification Research Level Skill

## Overview
This skill enables classification in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to formal-verification. This includes tasks such as:
- design systems
- optimize code
- analyze complexity
...
1. The user explicitly requests classification in the context of formal-verification
