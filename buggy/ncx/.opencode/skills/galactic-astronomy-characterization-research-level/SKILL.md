# Galactic Astronomy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to galactic-astronomy. This includes tasks such as:
- detect signals
- model phenomena
- model phenomena
...
1. The user explicitly requests characterization in the context of galactic-astronomy
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves galactic-astronomy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of galactic-astronomy principles and methods
...
2. **Methodology**: Follow established galactic-astronomy protocols and best practices
...
- Adjacent galactic-astronomy skills for comprehensive analysis
...
7. Stay current with galactic-astronomy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: galactic-astronomy
