# Time Series Analysis Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to time-series-analysis. This includes tasks such as:
- test hypotheses
- analyze datasets
- extract features
...
1. The user explicitly requests optimization in the context of time-series-analysis
