# Semi Supervised Dark Matter Optimization Skill

## Overview
This skill enables optimization in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to dark-matter. This includes tasks such as:
- observe objects
- calculate orbits
- detect signals
...
1. The user explicitly requests optimization in the context of dark-matter
