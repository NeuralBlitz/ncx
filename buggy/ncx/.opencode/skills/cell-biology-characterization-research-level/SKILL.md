# Cell Biology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of cell-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to cell-biology. This includes tasks such as:
- study interactions
- measure expression
- study interactions
...
1. The user explicitly requests characterization in the context of cell-biology
