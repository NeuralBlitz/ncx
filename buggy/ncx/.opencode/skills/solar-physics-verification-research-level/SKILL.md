# Solar Physics Verification Research Level Skill

## Overview
This skill enables verification in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to solar-physics. This includes tasks such as:
- detect signals
- analyze spectra
- analyze spectra
...
1. The user explicitly requests verification in the context of solar-physics
