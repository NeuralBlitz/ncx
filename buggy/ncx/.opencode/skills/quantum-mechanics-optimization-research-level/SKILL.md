# Quantum Mechanics Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of quantum-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to quantum-mechanics. This includes tasks such as:
- calculate forces
- calculate forces
- predict behavior
...
1. The user explicitly requests optimization in the context of quantum-mechanics
