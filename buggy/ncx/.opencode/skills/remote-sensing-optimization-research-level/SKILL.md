# Remote Sensing Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to remote-sensing. This includes tasks such as:
- measure properties
- model processes
- analyze samples
...
1. The user explicitly requests optimization in the context of remote-sensing
