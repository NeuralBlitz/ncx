# Geology Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of geology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to geology. This includes tasks such as:
- analyze samples
- model processes
- predict events
...
1. The user explicitly requests implementation in the context of geology
