# Data Governance Design Research Level Skill

## Overview
This skill enables design in the domain of data-governance (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to data-governance. This includes tasks such as:
- analyze datasets
- visualize data
- build models
...
1. The user explicitly requests design in the context of data-governance
