# Photochemistry Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of photochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to photochemistry. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of photochemistry
...
4. The work involves photochemistry methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of photochemistry principles and methods
...
2. **Methodology**: Follow established photochemistry protocols and best practices
...
- Adjacent photochemistry skills for comprehensive analysis
...
7. Stay current with photochemistry literature and methods

## Version Information
- Complexity Level: research-level
- Domain: chemistry
- Subdiscipline: photochemistry
