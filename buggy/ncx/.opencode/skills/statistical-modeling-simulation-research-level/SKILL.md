# Statistical Modeling Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to statistical-modeling. This includes tasks such as:
- visualize data
- predict outcomes
- extract features
...
1. The user explicitly requests simulation in the context of statistical-modeling
