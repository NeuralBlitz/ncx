# Statistical Modeling Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to statistical-modeling. This includes tasks such as:
- predict outcomes
- predict outcomes
- analyze datasets
...
1. The user explicitly requests debugging in the context of statistical-modeling
