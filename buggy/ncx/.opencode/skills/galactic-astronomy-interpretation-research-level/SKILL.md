# Galactic Astronomy Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to galactic-astronomy. This includes tasks such as:
- analyze spectra
- observe objects
- detect signals
...
1. The user explicitly requests interpretation in the context of galactic-astronomy
