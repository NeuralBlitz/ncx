# Systems Neuroscience Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of systems-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to systems-neuroscience. This includes tasks such as:
- measure responses
- measure responses
- study behavior
...
1. The user explicitly requests characterization in the context of systems-neuroscience
2. The task requires research-level-level understanding of neuroscience principles
3. The output needs to be neural data
4. The work involves systems-neuroscience methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of systems-neuroscience principles and methods
...
2. **Methodology**: Follow established systems-neuroscience protocols and best practices
...
- Adjacent systems-neuroscience skills for comprehensive analysis
...
7. Stay current with systems-neuroscience literature and methods

## Version Information
- Complexity Level: research-level
- Domain: neuroscience
- Subdiscipline: systems-neuroscience
