# Paleontology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of paleontology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to paleontology. This includes tasks such as:
- measure properties
- measure properties
- interpret data
...
1. The user explicitly requests characterization in the context of paleontology
...
4. The work involves paleontology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of paleontology principles and methods
...
2. **Methodology**: Follow established paleontology protocols and best practices
...
- Adjacent paleontology skills for comprehensive analysis
...
7. Stay current with paleontology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: paleontology
