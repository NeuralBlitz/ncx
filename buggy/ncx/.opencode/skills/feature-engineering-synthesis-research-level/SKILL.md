# Feature Engineering Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to feature-engineering. This includes tasks such as:
- analyze datasets
- visualize data
- build models
...
1. The user explicitly requests synthesis in the context of feature-engineering
