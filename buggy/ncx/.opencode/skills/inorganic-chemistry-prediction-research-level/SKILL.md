# Inorganic Chemistry Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of inorganic-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to inorganic-chemistry. This includes tasks such as:
- predict reactions
- predict reactions
...
1. The user explicitly requests prediction in the context of inorganic-chemistry
