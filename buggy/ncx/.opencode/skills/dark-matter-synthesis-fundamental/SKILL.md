# Dark Matter Synthesis Fundamental Skill

## Overview
This skill enables synthesis in the domain of dark-matter (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
