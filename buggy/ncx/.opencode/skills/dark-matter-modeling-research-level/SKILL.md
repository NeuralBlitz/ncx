# Dark Matter Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to dark-matter. This includes tasks such as:
- measure distances
- detect signals
- calculate orbits
...
1. The user explicitly requests modeling in the context of dark-matter
