# Probability Validation Research Level Skill

## Overview
This skill enables validation in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to probability. This includes tasks such as:
- calculate integrals
- calculate integrals
- solve equations
...
1. The user explicitly requests validation in the context of probability
