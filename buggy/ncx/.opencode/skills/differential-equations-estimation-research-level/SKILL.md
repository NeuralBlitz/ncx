# Differential Equations Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to differential-equations. This includes tasks such as:
- calculate integrals
- calculate integrals
- prove theorems
...
1. The user explicitly requests estimation in the context of differential-equations
