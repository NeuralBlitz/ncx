# Computational Nuclear Physics Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of nuclear-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to nuclear-physics. This includes tasks such as:
- predict behavior
- calculate forces
- predict behavior
...
1. The user explicitly requests troubleshooting in the context of nuclear-physics
