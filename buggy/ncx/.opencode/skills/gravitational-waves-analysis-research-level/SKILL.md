# Gravitational Waves Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to gravitational-waves. This includes tasks such as:
- detect signals
- model phenomena
- measure distances
...
1. The user explicitly requests analysis in the context of gravitational-waves
