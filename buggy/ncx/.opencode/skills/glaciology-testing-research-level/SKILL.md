# Glaciology Testing Research Level Skill

## Overview
This skill enables testing in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to glaciology. This includes tasks such as:
- measure properties
- interpret data
- analyze samples
...
1. The user explicitly requests testing in the context of glaciology
