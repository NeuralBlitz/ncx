# Semi Supervised Exoplanet Science Debugging Skill

## Overview
This skill enables debugging in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to exoplanet-science. This includes tasks such as:
- calculate orbits
- model phenomena
- calculate orbits
...
1. The user explicitly requests debugging in the context of exoplanet-science
