# Multivariate Linear Algebra Synthesis Skill

## Overview
This skill enables synthesis in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to linear-algebra. This includes tasks such as:
- compute derivatives
- prove theorems
- find eigenvalues
...
1. The user explicitly requests synthesis in the context of linear-algebra
