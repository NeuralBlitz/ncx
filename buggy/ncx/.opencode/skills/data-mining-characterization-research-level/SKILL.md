# Data Mining Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of data-mining (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to data-mining. This includes tasks such as:
- analyze datasets
- build models
- extract features
...
1. The user explicitly requests characterization in the context of data-mining
