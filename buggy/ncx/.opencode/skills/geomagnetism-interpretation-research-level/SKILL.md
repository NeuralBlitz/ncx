# Geomagnetism Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to geomagnetism. This includes tasks such as:
- interpret data
- analyze samples
- predict events
...
1. The user explicitly requests interpretation in the context of geomagnetism
