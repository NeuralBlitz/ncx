# Human Computer Interaction Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of human-computer-interaction (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to human-computer-interaction. This includes tasks such as:
- debug programs
- design systems
...
1. The user explicitly requests derivation in the context of human-computer-interaction
