# Time Series Analysis Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to time-series-analysis. This includes tasks such as:
- test hypotheses
- predict outcomes
- analyze datasets
...
1. The user explicitly requests modeling in the context of time-series-analysis
