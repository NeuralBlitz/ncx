# Statistical Modeling Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to statistical-modeling. This includes tasks such as:
- test hypotheses
- test hypotheses
- visualize data
...
1. The user explicitly requests derivation in the context of statistical-modeling
