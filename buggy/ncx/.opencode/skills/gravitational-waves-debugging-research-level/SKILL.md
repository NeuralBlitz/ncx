# Gravitational Waves Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to gravitational-waves. This includes tasks such as:
- detect signals
- observe objects
- detect signals
...
1. The user explicitly requests debugging in the context of gravitational-waves
