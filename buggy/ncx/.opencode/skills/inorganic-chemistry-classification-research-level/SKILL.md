# Inorganic Chemistry Classification Research Level Skill

## Overview
This skill enables classification in the domain of inorganic-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to inorganic-chemistry. This includes tasks such as:
- analyze spectra
- predict reactions
- predict reactions
...
1. The user explicitly requests classification in the context of inorganic-chemistry
