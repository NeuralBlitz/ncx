# Environmental Chemistry Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of environmental-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to environmental-chemistry. This includes tasks such as:
...
1. The user explicitly requests derivation in the context of environmental-chemistry
