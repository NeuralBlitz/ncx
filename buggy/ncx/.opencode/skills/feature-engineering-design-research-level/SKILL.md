# Feature Engineering Design Research Level Skill

## Overview
This skill enables design in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to feature-engineering. This includes tasks such as:
- predict outcomes
- analyze datasets
- extract features
...
1. The user explicitly requests design in the context of feature-engineering
