# Time Series Analysis Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to time-series-analysis. This includes tasks such as:
- extract features
- predict outcomes
- extract features
...
1. The user explicitly requests derivation in the context of time-series-analysis
