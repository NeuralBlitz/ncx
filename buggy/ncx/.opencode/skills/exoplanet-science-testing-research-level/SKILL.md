# Exoplanet Science Testing Research Level Skill

## Overview
This skill enables testing in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to exoplanet-science. This includes tasks such as:
- detect signals
- detect signals
- analyze spectra
...
1. The user explicitly requests testing in the context of exoplanet-science
