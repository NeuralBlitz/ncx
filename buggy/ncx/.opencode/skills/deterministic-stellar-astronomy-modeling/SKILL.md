# Deterministic Stellar Astronomy Modeling Skill

## Overview
This skill enables modeling in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to stellar-astronomy. This includes tasks such as:
- observe objects
- model phenomena
- model phenomena
...
1. The user explicitly requests modeling in the context of stellar-astronomy
