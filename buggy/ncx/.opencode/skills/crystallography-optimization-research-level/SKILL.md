# Crystallography Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of crystallography (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to crystallography. This includes tasks such as:
- analyze spectra
- predict reactions
- predict reactions
...
1. The user explicitly requests optimization in the context of crystallography
