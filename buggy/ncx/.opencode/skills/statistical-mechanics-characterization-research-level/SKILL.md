# Statistical Mechanics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of statistical-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to statistical-mechanics. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of statistical-mechanics
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves statistical-mechanics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of statistical-mechanics principles and methods
...
2. **Methodology**: Follow established statistical-mechanics protocols and best practices
...
- Adjacent statistical-mechanics skills for comprehensive analysis
...
7. Stay current with statistical-mechanics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: statistical-mechanics
