# Zoology Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to zoology. This includes tasks such as:
- sequence DNA
- model populations
- measure expression
...
1. The user explicitly requests optimization in the context of zoology
