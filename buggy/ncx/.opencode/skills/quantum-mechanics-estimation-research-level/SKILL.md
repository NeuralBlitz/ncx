# Quantum Mechanics Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of quantum-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to quantum-mechanics. This includes tasks such as:
- calculate forces
- predict behavior
- model systems
...
1. The user explicitly requests estimation in the context of quantum-mechanics
