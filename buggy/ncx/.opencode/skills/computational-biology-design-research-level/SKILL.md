# Computational Biology Design Research Level Skill

## Overview
This skill enables design in the domain of computational-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to computational-biology. This includes tasks such as:
- study interactions
- classify organisms
- model populations
...
1. The user explicitly requests design in the context of computational-biology
