# Soil Science Design Fundamental Skill

## Overview
This skill enables design in the domain of soil-science (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
