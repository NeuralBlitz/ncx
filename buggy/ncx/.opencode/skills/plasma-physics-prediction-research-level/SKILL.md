# Plasma Physics Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of plasma-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to plasma-physics. This includes tasks such as:
- calculate forces
- calculate forces
- calculate forces
...
1. The user explicitly requests prediction in the context of plasma-physics
