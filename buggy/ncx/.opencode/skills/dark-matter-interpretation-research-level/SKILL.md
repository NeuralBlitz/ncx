# Dark Matter Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to dark-matter. This includes tasks such as:
- observe objects
- measure distances
- measure distances
...
1. The user explicitly requests interpretation in the context of dark-matter
