# Semi Supervised Connectomics Synthesis Skill

## Overview
This skill enables synthesis in the domain of connectomics (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to connectomics. This includes tasks such as:
- measure responses
- measure responses
...
1. The user explicitly requests synthesis in the context of connectomics
