# Meteorology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of meteorology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to meteorology. This includes tasks such as:
- interpret data
- predict events
- measure properties
...
1. The user explicitly requests debugging in the context of meteorology
