# Distributed Systems Testing Research Level Skill

## Overview
This skill enables testing in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to distributed-systems. This includes tasks such as:
- optimize code
- analyze complexity
- debug programs
...
1. The user explicitly requests testing in the context of distributed-systems
