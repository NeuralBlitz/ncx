# Machine Learning Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to machine-learning. This includes tasks such as:
- design systems
- optimize code
- optimize code
...
1. The user explicitly requests derivation in the context of machine-learning
