# Formal Verification Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to formal-verification. This includes tasks such as:
- train models
- optimize code
- debug programs
...
1. The user explicitly requests optimization in the context of formal-verification
