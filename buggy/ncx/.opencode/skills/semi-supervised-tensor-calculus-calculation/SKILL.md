# Semi Supervised Tensor Calculus Calculation Skill

## Overview
This skill enables calculation in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to tensor-calculus. This includes tasks such as:
- calculate integrals
- solve equations
- compute derivatives
...
1. The user explicitly requests calculation in the context of tensor-calculus
