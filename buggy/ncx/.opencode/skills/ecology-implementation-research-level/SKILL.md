# Ecology Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of ecology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to ecology. This includes tasks such as:
- study interactions
- study interactions
- sequence DNA
...
1. The user explicitly requests implementation in the context of ecology
