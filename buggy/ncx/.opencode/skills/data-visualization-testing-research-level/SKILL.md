# Data Visualization Testing Research Level Skill

## Overview
This skill enables testing in the domain of data-visualization (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to data-visualization. This includes tasks such as:
- analyze datasets
- analyze datasets
- extract features
...
1. The user explicitly requests testing in the context of data-visualization
