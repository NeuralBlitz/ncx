# Environmental Engineering Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of environmental-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to environmental-engineering. This includes tasks such as:
- validate designs
- design components
- validate designs
...
1. The user explicitly requests troubleshooting in the context of environmental-engineering
