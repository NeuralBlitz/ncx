# Time Series Analysis Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to time-series-analysis. This includes tasks such as:
- build models
- test hypotheses
- predict outcomes
...
1. The user explicitly requests troubleshooting in the context of time-series-analysis
