# Fluid Dynamics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of fluid-dynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to fluid-dynamics. This includes tasks such as:
- model systems
- predict behavior
- predict behavior
...
1. The user explicitly requests characterization in the context of fluid-dynamics
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves fluid-dynamics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of fluid-dynamics principles and methods
...
2. **Methodology**: Follow established fluid-dynamics protocols and best practices
...
- Adjacent fluid-dynamics skills for comprehensive analysis
...
7. Stay current with fluid-dynamics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: fluid-dynamics
