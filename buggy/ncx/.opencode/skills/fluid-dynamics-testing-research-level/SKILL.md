# Fluid Dynamics Testing Research Level Skill

## Overview
This skill enables testing in the domain of fluid-dynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to fluid-dynamics. This includes tasks such as:
- calculate forces
- model systems
- calculate forces
...
1. The user explicitly requests testing in the context of fluid-dynamics
