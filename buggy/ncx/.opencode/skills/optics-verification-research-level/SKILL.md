# Optics Verification Research Level Skill

## Overview
This skill enables verification in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to optics. This includes tasks such as:
- model systems
- measure quantities
- analyze motion
...
1. The user explicitly requests verification in the context of optics
