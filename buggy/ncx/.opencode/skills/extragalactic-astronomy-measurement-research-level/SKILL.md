# Extragalactic Astronomy Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to extragalactic-astronomy. This includes tasks such as:
- analyze spectra
- detect signals
- calculate orbits
...
1. The user explicitly requests measurement in the context of extragalactic-astronomy
