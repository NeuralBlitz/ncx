# Discrete Math Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to discrete-math. This includes tasks such as:
- solve equations
- solve equations
- compute derivatives
...
1. The user explicitly requests debugging in the context of discrete-math
