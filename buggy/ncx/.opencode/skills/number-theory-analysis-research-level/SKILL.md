# Number Theory Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to number-theory. This includes tasks such as:
- calculate integrals
- prove theorems
- analyze functions
...
1. The user explicitly requests analysis in the context of number-theory
