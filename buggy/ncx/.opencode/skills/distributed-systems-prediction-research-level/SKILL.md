# Distributed Systems Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to distributed-systems. This includes tasks such as:
- optimize code
- train models
- optimize code
...
1. The user explicitly requests prediction in the context of distributed-systems
