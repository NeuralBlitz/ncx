# Statistical Cell Biology Design Skill

## Overview
This skill enables design in the domain of cell-biology (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
