# Computational Atmospheric Science Synthesis Skill

## Overview
This skill enables synthesis in the domain of atmospheric-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to atmospheric-science. This includes tasks such as:
- predict events
- measure properties
- model processes
...
1. The user explicitly requests synthesis in the context of atmospheric-science
