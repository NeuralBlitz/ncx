# Remote Sensing Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to remote-sensing. This includes tasks such as:
- measure properties
- analyze samples
- model processes
...
1. The user explicitly requests analysis in the context of remote-sensing
