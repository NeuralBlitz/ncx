# Neuropsychology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of neuropsychology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to neuropsychology. This includes tasks such as:
- map connections
- map connections
- model circuits
...
1. The user explicitly requests characterization in the context of neuropsychology
...
4. The work involves neuropsychology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of neuropsychology principles and methods
...
2. **Methodology**: Follow established neuropsychology protocols and best practices
...
- Adjacent neuropsychology skills for comprehensive analysis
...
7. Stay current with neuropsychology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: neuroscience
- Subdiscipline: neuropsychology
