# Condensed Matter Design Research Level Skill

## Overview
This skill enables design in the domain of condensed-matter (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to condensed-matter. This includes tasks such as:
- calculate forces
- model systems
- predict behavior
...
1. The user explicitly requests design in the context of condensed-matter
