# Measure Theory Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of measure-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to measure-theory. This includes tasks such as:
- prove theorems
- find eigenvalues
- calculate integrals
...
1. The user explicitly requests modeling in the context of measure-theory
