# Computational Neuroscience Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of computational-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to computational-neuroscience. This includes tasks such as:
- map connections
- model circuits
...
1. The user explicitly requests simulation in the context of computational-neuroscience
