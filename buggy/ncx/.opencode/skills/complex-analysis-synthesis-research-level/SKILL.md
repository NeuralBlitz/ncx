# Complex Analysis Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of complex-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to complex-analysis. This includes tasks such as:
- compute derivatives
- prove theorems
- find eigenvalues
...
1. The user explicitly requests synthesis in the context of complex-analysis
