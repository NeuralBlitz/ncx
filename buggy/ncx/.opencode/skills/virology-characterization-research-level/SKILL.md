# Virology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of virology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to virology. This includes tasks such as:
- analyze proteins
- measure expression
- model populations
...
1. The user explicitly requests characterization in the context of virology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be biological insights
4. The work involves virology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of virology principles and methods
...
2. **Methodology**: Follow established virology protocols and best practices
...
- Adjacent virology skills for comprehensive analysis
...
7. Stay current with virology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: virology
