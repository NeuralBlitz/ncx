# Synthetic Biology Design Research Level Skill

## Overview
This skill enables design in the domain of synthetic-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to synthetic-biology. This includes tasks such as:
- measure expression
- sequence DNA
- study interactions
...
1. The user explicitly requests design in the context of synthetic-biology
