# Planetary Science Astro Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to planetary-science-astro. This includes tasks such as:
- calculate orbits
- observe objects
- analyze spectra
...
1. The user explicitly requests prediction in the context of planetary-science-astro
