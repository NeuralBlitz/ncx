# Soil Science Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to soil-science. This includes tasks such as:
- predict events
- predict events
- model processes
...
1. The user explicitly requests debugging in the context of soil-science
