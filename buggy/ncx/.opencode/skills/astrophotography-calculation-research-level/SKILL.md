# Astrophotography Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of astrophotography (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to astrophotography. This includes tasks such as:
- analyze spectra
- observe objects
- model phenomena
...
1. The user explicitly requests calculation in the context of astrophotography
