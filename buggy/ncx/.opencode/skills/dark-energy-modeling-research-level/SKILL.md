# Dark Energy Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to dark-energy. This includes tasks such as:
- measure distances
- measure distances
- model phenomena
...
1. The user explicitly requests modeling in the context of dark-energy
