# Analytical Seismology Design Skill

## Overview
This skill enables design in the domain of seismology (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
