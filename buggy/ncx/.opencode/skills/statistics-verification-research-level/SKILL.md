# Statistics Verification Research Level Skill

## Overview
This skill enables verification in the domain of statistics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to statistics. This includes tasks such as:
- calculate integrals
- prove theorems
- analyze functions
...
1. The user explicitly requests verification in the context of statistics
