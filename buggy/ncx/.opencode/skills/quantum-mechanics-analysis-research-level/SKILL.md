# Quantum Mechanics Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of quantum-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to quantum-mechanics. This includes tasks such as:
- calculate forces
- model systems
- analyze motion
...
1. The user explicitly requests analysis in the context of quantum-mechanics
