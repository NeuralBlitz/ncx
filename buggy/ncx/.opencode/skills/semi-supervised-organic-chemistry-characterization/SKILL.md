# Semi Supervised Organic Chemistry Characterization Skill

## Overview
This skill enables characterization in the domain of organic-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to organic-chemistry. This includes tasks such as:
- analyze spectra
...
1. The user explicitly requests characterization in the context of organic-chemistry
...
4. The work involves organic-chemistry methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of organic-chemistry principles and methods
...
2. **Methodology**: Follow established organic-chemistry protocols and best practices
...
- Adjacent organic-chemistry skills for comprehensive analysis
...
7. Stay current with organic-chemistry literature and methods
