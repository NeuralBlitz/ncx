# Neurochemistry Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of neurochemistry (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to neurochemistry. This includes tasks such as:
- model circuits
- measure responses
- measure responses
...
1. The user explicitly requests modeling in the context of neurochemistry
