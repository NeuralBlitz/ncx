# Data Mining Verification Research Level Skill

## Overview
This skill enables verification in the domain of data-mining (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to data-mining. This includes tasks such as:
- build models
- visualize data
- predict outcomes
...
1. The user explicitly requests verification in the context of data-mining
