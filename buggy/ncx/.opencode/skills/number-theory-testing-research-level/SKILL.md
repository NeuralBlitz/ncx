# Number Theory Testing Research Level Skill

## Overview
This skill enables testing in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to number-theory. This includes tasks such as:
- analyze functions
- find eigenvalues
- find eigenvalues
...
1. The user explicitly requests testing in the context of number-theory
