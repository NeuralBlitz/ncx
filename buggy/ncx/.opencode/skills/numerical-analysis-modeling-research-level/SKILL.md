# Numerical Analysis Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to numerical-analysis. This includes tasks such as:
- analyze functions
- solve equations
- calculate integrals
...
1. The user explicitly requests modeling in the context of numerical-analysis
