# Semi Supervised Electrical Engineering Verification Skill

## Overview
This skill enables verification in the domain of electrical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to electrical-engineering. This includes tasks such as:
- design components
- design components
- design components
...
1. The user explicitly requests verification in the context of electrical-engineering
