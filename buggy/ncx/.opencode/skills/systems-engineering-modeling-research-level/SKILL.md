# Systems Engineering Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to systems-engineering. This includes tasks such as:
- validate designs
...
1. The user explicitly requests modeling in the context of systems-engineering
