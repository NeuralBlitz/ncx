# Epidemiology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of epidemiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to epidemiology. This includes tasks such as:
- model populations
- analyze proteins
- sequence DNA
...
1. The user explicitly requests characterization in the context of epidemiology
