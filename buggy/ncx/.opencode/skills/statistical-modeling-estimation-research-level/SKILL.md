# Statistical Modeling Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to statistical-modeling. This includes tasks such as:
- build models
- analyze datasets
- extract features
...
1. The user explicitly requests estimation in the context of statistical-modeling
