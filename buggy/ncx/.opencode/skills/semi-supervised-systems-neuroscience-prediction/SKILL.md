# Semi Supervised Systems Neuroscience Prediction Skill

## Overview
This skill enables prediction in the domain of systems-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to systems-neuroscience. This includes tasks such as:
- map connections
- study behavior
- model circuits
...
1. The user explicitly requests prediction in the context of systems-neuroscience
