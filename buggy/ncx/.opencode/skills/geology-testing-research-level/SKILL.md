# Geology Testing Research Level Skill

## Overview
This skill enables testing in the domain of geology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to geology. This includes tasks such as:
- measure properties
- map features
- interpret data
...
1. The user explicitly requests testing in the context of geology
