# Semi Supervised Organic Chemistry Estimation Skill

## Overview
This skill enables estimation in the domain of organic-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to organic-chemistry. This includes tasks such as:
...
1. The user explicitly requests estimation in the context of organic-chemistry
