# Botany Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of botany (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to botany. This includes tasks such as:
- model populations
- measure expression
- study interactions
...
1. The user explicitly requests measurement in the context of botany
