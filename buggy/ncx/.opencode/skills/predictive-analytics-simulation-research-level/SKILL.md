# Predictive Analytics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to predictive-analytics. This includes tasks such as:
- extract features
- predict outcomes
- build models
...
1. The user explicitly requests simulation in the context of predictive-analytics
