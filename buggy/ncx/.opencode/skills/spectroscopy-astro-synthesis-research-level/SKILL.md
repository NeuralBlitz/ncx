# Spectroscopy Astro Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to spectroscopy-astro. This includes tasks such as:
- model phenomena
- calculate orbits
- analyze spectra
...
1. The user explicitly requests synthesis in the context of spectroscopy-astro
