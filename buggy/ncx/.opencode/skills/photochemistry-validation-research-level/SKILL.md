# Photochemistry Validation Research Level Skill

## Overview
This skill enables validation in the domain of photochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to photochemistry. This includes tasks such as:
- analyze spectra
- predict reactions
...
1. The user explicitly requests validation in the context of photochemistry
