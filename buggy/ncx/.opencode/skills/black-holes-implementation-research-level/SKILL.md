# Black Holes Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to black-holes. This includes tasks such as:
- observe objects
- observe objects
- observe objects
...
1. The user explicitly requests implementation in the context of black-holes
