# Systems Engineering Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to systems-engineering. This includes tasks such as:
- design components
- analyze structures
- analyze structures
...
1. The user explicitly requests prediction in the context of systems-engineering
