# Semi Supervised Number Theory Verification Skill

## Overview
This skill enables verification in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to number-theory. This includes tasks such as:
- analyze functions
- prove theorems
- analyze functions
...
1. The user explicitly requests verification in the context of number-theory
