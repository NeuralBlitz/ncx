# Photonics Engineering Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of photonics-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to photonics-engineering. This includes tasks such as:
- design components
- test prototypes
- analyze structures
...
1. The user explicitly requests analysis in the context of photonics-engineering
