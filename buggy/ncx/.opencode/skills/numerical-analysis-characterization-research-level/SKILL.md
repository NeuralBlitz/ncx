# Numerical Analysis Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to numerical-analysis. This includes tasks such as:
- find eigenvalues
- analyze functions
- solve equations
...
1. The user explicitly requests characterization in the context of numerical-analysis
...
4. The work involves numerical-analysis methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of numerical-analysis principles and methods
...
2. **Methodology**: Follow established numerical-analysis protocols and best practices
...
- Adjacent numerical-analysis skills for comprehensive analysis
...
7. Stay current with numerical-analysis literature and methods

## Version Information
- Complexity Level: research-level
- Domain: mathematics
- Subdiscipline: numerical-analysis
