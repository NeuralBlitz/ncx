# Geophysics Earth Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to geophysics-earth. This includes tasks such as:
- predict events
- predict events
- map features
...
1. The user explicitly requests characterization in the context of geophysics-earth
...
4. The work involves geophysics-earth methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of geophysics-earth principles and methods
...
2. **Methodology**: Follow established geophysics-earth protocols and best practices
...
- Adjacent geophysics-earth skills for comprehensive analysis
...
7. Stay current with geophysics-earth literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: geophysics-earth
