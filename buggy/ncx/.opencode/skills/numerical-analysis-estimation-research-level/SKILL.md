# Numerical Analysis Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to numerical-analysis. This includes tasks such as:
- calculate integrals
- compute derivatives
- find eigenvalues
...
1. The user explicitly requests estimation in the context of numerical-analysis
