# Zoology Design Research Level Skill

## Overview
This skill enables design in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to zoology. This includes tasks such as:
- study interactions
- sequence DNA
- sequence DNA
...
1. The user explicitly requests design in the context of zoology
