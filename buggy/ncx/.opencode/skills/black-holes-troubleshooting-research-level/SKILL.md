# Black Holes Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to black-holes. This includes tasks such as:
- calculate orbits
- detect signals
- calculate orbits
...
1. The user explicitly requests troubleshooting in the context of black-holes
