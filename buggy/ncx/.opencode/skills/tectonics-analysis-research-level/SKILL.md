# Tectonics Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of tectonics (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to tectonics. This includes tasks such as:
- map features
- model processes
- measure properties
...
1. The user explicitly requests analysis in the context of tectonics
