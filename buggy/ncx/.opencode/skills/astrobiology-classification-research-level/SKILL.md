# Astrobiology Classification Research Level Skill

## Overview
This skill enables classification in the domain of astrobiology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to astrobiology. This includes tasks such as:
- model phenomena
- analyze spectra
- detect signals
...
1. The user explicitly requests classification in the context of astrobiology
