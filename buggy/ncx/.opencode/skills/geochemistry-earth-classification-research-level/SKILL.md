# Geochemistry Earth Classification Research Level Skill

## Overview
This skill enables classification in the domain of geochemistry-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to geochemistry-earth. This includes tasks such as:
- interpret data
- measure properties
- measure properties
...
1. The user explicitly requests classification in the context of geochemistry-earth
