# Human Computer Interaction Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of human-computer-interaction (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to human-computer-interaction. This includes tasks such as:
- analyze complexity
- optimize code
- train models
...
1. The user explicitly requests simulation in the context of human-computer-interaction
