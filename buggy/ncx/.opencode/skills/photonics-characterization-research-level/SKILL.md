# Photonics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of photonics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to photonics. This includes tasks such as:
- calculate forces
- predict behavior
- model systems
...
1. The user explicitly requests characterization in the context of photonics
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves photonics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of photonics principles and methods
...
2. **Methodology**: Follow established photonics protocols and best practices
...
- Adjacent photonics skills for comprehensive analysis
...
7. Stay current with photonics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: photonics
