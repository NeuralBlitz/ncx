# Remote Sensing Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to remote-sensing. This includes tasks such as:
- analyze samples
- interpret data
- measure properties
...
1. The user explicitly requests troubleshooting in the context of remote-sensing
