# Remote Sensing Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to remote-sensing. This includes tasks such as:
- map features
- model processes
- map features
...
1. The user explicitly requests estimation in the context of remote-sensing
