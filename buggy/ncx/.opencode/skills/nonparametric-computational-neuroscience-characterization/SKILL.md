# Nonparametric Computational Neuroscience Characterization Skill

## Overview
This skill enables characterization in the domain of computational-neuroscience (neuroscience). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to computational-neuroscience. This includes tasks such as:
- model circuits
...
1. The user explicitly requests characterization in the context of computational-neuroscience
2. The task requires intermediate-level understanding of neuroscience principles
3. The output needs to be neural data
4. The work involves computational-neuroscience methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of computational-neuroscience principles and methods
...
2. **Methodology**: Follow established computational-neuroscience protocols and best practices
...
- Adjacent computational-neuroscience skills for comprehensive analysis
...
7. Stay current with computational-neuroscience literature and methods
