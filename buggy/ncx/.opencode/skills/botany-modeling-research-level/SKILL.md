# Botany Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of botany (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to botany. This includes tasks such as:
- measure expression
- analyze proteins
- study interactions
...
1. The user explicitly requests modeling in the context of botany
