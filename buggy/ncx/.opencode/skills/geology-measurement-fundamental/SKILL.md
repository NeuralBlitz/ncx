# Geology Measurement Fundamental Skill

## Overview
This skill enables measurement in the domain of geology (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
