# Chemical Engineering Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of chemical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to chemical-engineering. This includes tasks such as:
- test prototypes
- test prototypes
- validate designs
...
1. The user explicitly requests troubleshooting in the context of chemical-engineering
