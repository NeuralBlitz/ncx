# Semi Supervised Climate Science Testing Skill

## Overview
This skill enables testing in the domain of climate-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to climate-science. This includes tasks such as:
- interpret data
- measure properties
- map features
...
1. The user explicitly requests testing in the context of climate-science
