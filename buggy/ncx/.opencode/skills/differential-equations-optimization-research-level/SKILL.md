# Differential Equations Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to differential-equations. This includes tasks such as:
- prove theorems
- calculate integrals
- analyze functions
...
1. The user explicitly requests optimization in the context of differential-equations
