# Software Engineering Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of software-engineering (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to software-engineering. This includes tasks such as:
- analyze complexity
- train models
...
1. The user explicitly requests calculation in the context of software-engineering
