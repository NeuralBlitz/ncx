# Galactic Astronomy Verification Research Level Skill

## Overview
This skill enables verification in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to galactic-astronomy. This includes tasks such as:
- model phenomena
- detect signals
- calculate orbits
...
1. The user explicitly requests verification in the context of galactic-astronomy
