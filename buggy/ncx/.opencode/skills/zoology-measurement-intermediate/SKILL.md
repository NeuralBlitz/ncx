# Zoology Measurement Intermediate Skill

## Overview
This skill enables measurement in the domain of zoology (biology). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.
