# Probability Testing Research Level Skill

## Overview
This skill enables testing in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to probability. This includes tasks such as:
- solve equations
- prove theorems
- solve equations
...
1. The user explicitly requests testing in the context of probability
