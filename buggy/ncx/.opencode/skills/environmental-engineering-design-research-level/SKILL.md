# Environmental Engineering Design Research Level Skill

## Overview
This skill enables design in the domain of environmental-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to environmental-engineering. This includes tasks such as:
- optimize processes
- validate designs
...
1. The user explicitly requests design in the context of environmental-engineering
