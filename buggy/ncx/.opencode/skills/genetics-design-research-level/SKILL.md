# Genetics Design Research Level Skill

## Overview
This skill enables design in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to genetics. This includes tasks such as:
- analyze proteins
- study interactions
- sequence DNA
...
1. The user explicitly requests design in the context of genetics
