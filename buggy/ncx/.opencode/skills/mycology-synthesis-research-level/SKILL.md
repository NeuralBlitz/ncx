# Mycology Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of mycology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to mycology. This includes tasks such as:
- model populations
- classify organisms
- classify organisms
...
1. The user explicitly requests synthesis in the context of mycology
