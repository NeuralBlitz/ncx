# Semi Supervised Soil Science Simulation Skill

## Overview
This skill enables simulation in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to soil-science. This includes tasks such as:
- analyze samples
- analyze samples
- analyze samples
...
1. The user explicitly requests simulation in the context of soil-science
