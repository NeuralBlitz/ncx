# Geophysics Earth Classification Research Level Skill

## Overview
This skill enables classification in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to geophysics-earth. This includes tasks such as:
- measure properties
- predict events
- interpret data
...
1. The user explicitly requests classification in the context of geophysics-earth
