# Extragalactic Astronomy Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to extragalactic-astronomy. This includes tasks such as:
- measure distances
- model phenomena
- observe objects
...
1. The user explicitly requests calculation in the context of extragalactic-astronomy
