# Stochastic Linear Algebra Characterization Skill

## Overview
This skill enables characterization in the domain of linear-algebra (mathematics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
