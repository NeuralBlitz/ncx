# Quantum Computing Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of quantum-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to quantum-computing. This includes tasks such as:
- design systems
- debug programs
- design systems
...
1. The user explicitly requests derivation in the context of quantum-computing
