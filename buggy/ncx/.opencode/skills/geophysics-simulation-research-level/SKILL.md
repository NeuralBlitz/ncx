# Geophysics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of geophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to geophysics. This includes tasks such as:
- predict behavior
- analyze motion
- analyze motion
...
1. The user explicitly requests simulation in the context of geophysics
