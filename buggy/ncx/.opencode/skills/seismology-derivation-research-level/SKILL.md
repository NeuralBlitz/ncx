# Seismology Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of seismology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to seismology. This includes tasks such as:
- predict events
- predict events
- measure properties
...
1. The user explicitly requests derivation in the context of seismology
