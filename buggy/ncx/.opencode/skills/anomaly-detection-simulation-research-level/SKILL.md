# Anomaly Detection Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to anomaly-detection. This includes tasks such as:
- build models
- predict outcomes
- visualize data
...
1. The user explicitly requests simulation in the context of anomaly-detection
