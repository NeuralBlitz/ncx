# Structural Biology Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of structural-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to structural-biology. This includes tasks such as:
- measure expression
- measure expression
- model populations
...
1. The user explicitly requests synthesis in the context of structural-biology
