# Relativity Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of relativity (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to relativity. This includes tasks such as:
- predict behavior
- model systems
- predict behavior
...
1. The user explicitly requests derivation in the context of relativity
