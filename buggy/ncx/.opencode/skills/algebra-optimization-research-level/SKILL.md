# Algebra Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to algebra. This includes tasks such as:
- calculate integrals
- solve equations
- find eigenvalues
...
1. The user explicitly requests optimization in the context of algebra
