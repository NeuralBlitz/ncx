# Microbiology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of microbiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to microbiology. This includes tasks such as:
- measure expression
- model populations
- measure expression
...
1. The user explicitly requests modeling in the context of microbiology
