# Automotive Engineering Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of automotive-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to automotive-engineering. This includes tasks such as:
- analyze structures
- analyze structures
- test prototypes
...
1. The user explicitly requests calculation in the context of automotive-engineering
