# Etl Processes Design Research Level Skill

## Overview
This skill enables design in the domain of etl-processes (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to etl-processes. This includes tasks such as:
- build models
- test hypotheses
- build models
...
1. The user explicitly requests design in the context of etl-processes
