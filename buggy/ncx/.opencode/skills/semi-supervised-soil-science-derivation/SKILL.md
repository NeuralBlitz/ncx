# Semi Supervised Soil Science Derivation Skill

## Overview
This skill enables derivation in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to soil-science. This includes tasks such as:
- analyze samples
- predict events
- predict events
...
1. The user explicitly requests derivation in the context of soil-science
