# Parasitology Testing Research Level Skill

## Overview
This skill enables testing in the domain of parasitology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to parasitology. This includes tasks such as:
- model populations
- analyze proteins
- classify organisms
...
1. The user explicitly requests testing in the context of parasitology
