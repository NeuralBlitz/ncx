# Dark Matter Classification Research Level Skill

## Overview
This skill enables classification in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to dark-matter. This includes tasks such as:
- measure distances
- detect signals
- calculate orbits
...
1. The user explicitly requests classification in the context of dark-matter
