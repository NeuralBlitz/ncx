# Exoplanet Science Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to exoplanet-science. This includes tasks such as:
- measure distances
- model phenomena
- analyze spectra
...
1. The user explicitly requests simulation in the context of exoplanet-science
