# Semi Supervised Parasitology Estimation Skill

## Overview
This skill enables estimation in the domain of parasitology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to parasitology. This includes tasks such as:
- measure expression
- measure expression
- classify organisms
...
1. The user explicitly requests estimation in the context of parasitology
