# Human Computer Interaction Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of human-computer-interaction (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to human-computer-interaction. This includes tasks such as:
- debug programs
...
1. The user explicitly requests modeling in the context of human-computer-interaction
