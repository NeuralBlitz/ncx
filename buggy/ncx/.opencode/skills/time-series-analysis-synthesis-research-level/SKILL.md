# Time Series Analysis Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to time-series-analysis. This includes tasks such as:
- extract features
- visualize data
- predict outcomes
...
1. The user explicitly requests synthesis in the context of time-series-analysis
