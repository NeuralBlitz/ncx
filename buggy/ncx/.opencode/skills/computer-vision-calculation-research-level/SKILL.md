# Computer Vision Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of computer-vision (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to computer-vision. This includes tasks such as:
- optimize code
- debug programs
- debug programs
...
1. The user explicitly requests calculation in the context of computer-vision
