# Helioseismology Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to helioseismology. This includes tasks such as:
- analyze spectra
- analyze spectra
- calculate orbits
...
1. The user explicitly requests troubleshooting in the context of helioseismology
