# Solar Physics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to solar-physics. This includes tasks such as:
- calculate orbits
- detect signals
- measure distances
...
1. The user explicitly requests simulation in the context of solar-physics
