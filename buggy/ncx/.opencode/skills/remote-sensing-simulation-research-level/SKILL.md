# Remote Sensing Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to remote-sensing. This includes tasks such as:
- measure properties
- measure properties
- model processes
...
1. The user explicitly requests simulation in the context of remote-sensing
