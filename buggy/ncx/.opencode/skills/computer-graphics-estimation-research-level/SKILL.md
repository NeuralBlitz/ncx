# Computer Graphics Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of computer-graphics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to computer-graphics. This includes tasks such as:
- train models
- design systems
- design systems
...
1. The user explicitly requests estimation in the context of computer-graphics
