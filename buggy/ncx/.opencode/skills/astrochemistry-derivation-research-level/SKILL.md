# Astrochemistry Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of astrochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to astrochemistry. This includes tasks such as:
- predict reactions
- analyze spectra
- predict reactions
...
1. The user explicitly requests derivation in the context of astrochemistry
