# Quantum Field Theory Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to quantum-field-theory. This includes tasks such as:
- calculate forces
- calculate forces
- calculate forces
...
1. The user explicitly requests characterization in the context of quantum-field-theory
...
4. The work involves quantum-field-theory methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of quantum-field-theory principles and methods
...
2. **Methodology**: Follow established quantum-field-theory protocols and best practices
...
- Adjacent quantum-field-theory skills for comprehensive analysis
...
7. Stay current with quantum-field-theory literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: quantum-field-theory
