# Volcanology Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of volcanology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to volcanology. This includes tasks such as:
- model processes
- map features
- model processes
...
1. The user explicitly requests estimation in the context of volcanology
