# Synthetic Biology Verification Research Level Skill

## Overview
This skill enables verification in the domain of synthetic-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to synthetic-biology. This includes tasks such as:
- classify organisms
- model populations
- sequence DNA
...
1. The user explicitly requests verification in the context of synthetic-biology
