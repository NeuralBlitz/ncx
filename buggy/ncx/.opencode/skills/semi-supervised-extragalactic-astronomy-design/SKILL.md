# Semi Supervised Extragalactic Astronomy Design Skill

## Overview
This skill enables design in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to extragalactic-astronomy. This includes tasks such as:
- measure distances
- calculate orbits
- analyze spectra
...
1. The user explicitly requests design in the context of extragalactic-astronomy
