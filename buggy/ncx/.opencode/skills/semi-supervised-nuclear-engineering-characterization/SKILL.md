# Semi Supervised Nuclear Engineering Characterization Skill

## Overview
This skill enables characterization in the domain of nuclear-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to nuclear-engineering. This includes tasks such as:
- test prototypes
- validate designs
- test prototypes
...
1. The user explicitly requests characterization in the context of nuclear-engineering
...
4. The work involves nuclear-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of nuclear-engineering principles and methods
...
2. **Methodology**: Follow established nuclear-engineering protocols and best practices
...
- Adjacent nuclear-engineering skills for comprehensive analysis
...
7. Stay current with nuclear-engineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: nuclear-engineering
