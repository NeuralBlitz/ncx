# Semi Supervised Probability Synthesis Skill

## Overview
This skill enables synthesis in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to probability. This includes tasks such as:
- prove theorems
- analyze functions
- prove theorems
...
1. The user explicitly requests synthesis in the context of probability
