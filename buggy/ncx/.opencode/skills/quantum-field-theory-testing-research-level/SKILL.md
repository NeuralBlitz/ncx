# Quantum Field Theory Testing Research Level Skill

## Overview
This skill enables testing in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to quantum-field-theory. This includes tasks such as:
- analyze motion
- calculate forces
- analyze motion
...
1. The user explicitly requests testing in the context of quantum-field-theory
