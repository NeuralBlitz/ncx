# Distributed Systems Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to distributed-systems. This includes tasks such as:
- train models
- debug programs
- design systems
...
1. The user explicitly requests troubleshooting in the context of distributed-systems
