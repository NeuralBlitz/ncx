# Distributed Systems Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to distributed-systems. This includes tasks such as:
- design systems
- optimize code
- design systems
...
1. The user explicitly requests optimization in the context of distributed-systems
