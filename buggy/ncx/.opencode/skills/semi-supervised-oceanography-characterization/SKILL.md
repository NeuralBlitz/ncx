# Semi Supervised Oceanography Characterization Skill

## Overview
This skill enables characterization in the domain of oceanography (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to oceanography. This includes tasks such as:
- model processes
- interpret data
- model processes
...
1. The user explicitly requests characterization in the context of oceanography
...
4. The work involves oceanography methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of oceanography principles and methods
...
2. **Methodology**: Follow established oceanography protocols and best practices
...
- Adjacent oceanography skills for comprehensive analysis
...
7. Stay current with oceanography literature and methods
