# Semi Supervised Radio Astronomy Estimation Skill

## Overview
This skill enables estimation in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to radio-astronomy. This includes tasks such as:
- observe objects
- detect signals
- measure distances
...
1. The user explicitly requests estimation in the context of radio-astronomy
