# Time Series Analysis Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to time-series-analysis. This includes tasks such as:
- extract features
- analyze datasets
- test hypotheses
...
1. The user explicitly requests characterization in the context of time-series-analysis
...
4. The work involves time-series-analysis methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of time-series-analysis principles and methods
...
2. **Methodology**: Follow established time-series-analysis protocols and best practices
...
- Adjacent time-series-analysis skills for comprehensive analysis
...
7. Stay current with time-series-analysis literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: time-series-analysis
