# Exoplanet Science Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to exoplanet-science. This includes tasks such as:
- measure distances
- measure distances
- model phenomena
...
1. The user explicitly requests derivation in the context of exoplanet-science
