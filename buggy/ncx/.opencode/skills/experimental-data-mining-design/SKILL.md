# Experimental Data Mining Design Skill

## Overview
This skill enables design in the domain of data-mining (data-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
