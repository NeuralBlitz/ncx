# Robotics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of robotics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to robotics. This includes tasks such as:
- design systems
...
1. The user explicitly requests characterization in the context of robotics
...
4. The work involves robotics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of robotics principles and methods
...
2. **Methodology**: Follow established robotics protocols and best practices
...
- Adjacent robotics skills for comprehensive analysis
...
7. Stay current with robotics literature and methods
