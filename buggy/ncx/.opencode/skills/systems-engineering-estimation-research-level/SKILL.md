# Systems Engineering Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to systems-engineering. This includes tasks such as:
- design components
- validate designs
- design components
...
1. The user explicitly requests estimation in the context of systems-engineering
