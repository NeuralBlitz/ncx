# Computational Cosmology Measurement Skill

## Overview
This skill enables measurement in the domain of cosmology (physics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
