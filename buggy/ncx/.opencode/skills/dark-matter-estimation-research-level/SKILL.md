# Dark Matter Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to dark-matter. This includes tasks such as:
- detect signals
- detect signals
- calculate orbits
...
1. The user explicitly requests estimation in the context of dark-matter
