# Systems Neuroscience Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of systems-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to systems-neuroscience. This includes tasks such as:
- study behavior
- measure responses
...
1. The user explicitly requests measurement in the context of systems-neuroscience
