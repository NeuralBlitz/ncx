# Theoretical Optics Characterization Skill

## Overview
This skill enables characterization in the domain of optics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.
