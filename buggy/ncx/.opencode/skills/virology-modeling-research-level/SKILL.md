# Virology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of virology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to virology. This includes tasks such as:
- sequence DNA
- study interactions
- classify organisms
...
1. The user explicitly requests modeling in the context of virology
