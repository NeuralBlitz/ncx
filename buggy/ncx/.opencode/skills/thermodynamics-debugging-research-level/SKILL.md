# Thermodynamics Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of thermodynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to thermodynamics. This includes tasks such as:
- predict behavior
- measure quantities
- model systems
...
1. The user explicitly requests debugging in the context of thermodynamics
