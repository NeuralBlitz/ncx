# Cognitive Neuroscience Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of cognitive-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to cognitive-neuroscience. This includes tasks such as:
- model circuits
- measure responses
...
1. The user explicitly requests interpretation in the context of cognitive-neuroscience
