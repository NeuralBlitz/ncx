# Semi Supervised Optimization Analysis Skill

## Overview
This skill enables analysis in the domain of optimization (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to optimization. This includes tasks such as:
- compute derivatives
- calculate integrals
- find eigenvalues
...
1. The user explicitly requests analysis in the context of optimization
