# Extragalactic Astronomy Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to extragalactic-astronomy. This includes tasks such as:
- measure distances
- observe objects
- calculate orbits
...
1. The user explicitly requests interpretation in the context of extragalactic-astronomy
