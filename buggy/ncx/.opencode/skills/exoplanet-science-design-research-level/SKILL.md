# Exoplanet Science Design Research Level Skill

## Overview
This skill enables design in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to exoplanet-science. This includes tasks such as:
- observe objects
- calculate orbits
- calculate orbits
...
1. The user explicitly requests design in the context of exoplanet-science
