# Semi Supervised Power Systems Design Skill

## Overview
This skill enables design in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to power-systems. This includes tasks such as:
- validate designs
- test prototypes
- validate designs
...
1. The user explicitly requests design in the context of power-systems
