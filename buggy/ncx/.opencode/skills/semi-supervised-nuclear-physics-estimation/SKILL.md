# Semi Supervised Nuclear Physics Estimation Skill

## Overview
This skill enables estimation in the domain of nuclear-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to nuclear-physics. This includes tasks such as:
- calculate forces
- predict behavior
- analyze motion
...
1. The user explicitly requests estimation in the context of nuclear-physics
