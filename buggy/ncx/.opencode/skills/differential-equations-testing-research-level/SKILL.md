# Differential Equations Testing Research Level Skill

## Overview
This skill enables testing in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to differential-equations. This includes tasks such as:
- find eigenvalues
- analyze functions
- prove theorems
...
1. The user explicitly requests testing in the context of differential-equations
