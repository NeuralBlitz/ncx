# Semi Supervised Clustering Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of clustering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to clustering. This includes tasks such as:
- extract features
- test hypotheses
- test hypotheses
...
1. The user explicitly requests troubleshooting in the context of clustering
