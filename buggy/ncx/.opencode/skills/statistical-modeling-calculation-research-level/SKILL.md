# Statistical Modeling Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to statistical-modeling. This includes tasks such as:
- build models
- predict outcomes
- build models
...
1. The user explicitly requests calculation in the context of statistical-modeling
