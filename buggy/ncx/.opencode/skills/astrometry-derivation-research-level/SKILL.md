# Astrometry Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of astrometry (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to astrometry. This includes tasks such as:
- analyze spectra
- calculate orbits
- analyze spectra
...
1. The user explicitly requests derivation in the context of astrometry
