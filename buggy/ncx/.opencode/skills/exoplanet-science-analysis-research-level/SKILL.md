# Exoplanet Science Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to exoplanet-science. This includes tasks such as:
- measure distances
- calculate orbits
- measure distances
...
1. The user explicitly requests analysis in the context of exoplanet-science
