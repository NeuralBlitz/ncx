# Discrete Math Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to discrete-math. This includes tasks such as:
- prove theorems
- compute derivatives
- prove theorems
...
1. The user explicitly requests measurement in the context of discrete-math
