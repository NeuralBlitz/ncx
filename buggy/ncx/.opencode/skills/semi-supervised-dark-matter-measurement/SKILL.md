# Semi Supervised Dark Matter Measurement Skill

## Overview
This skill enables measurement in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to dark-matter. This includes tasks such as:
- analyze spectra
- observe objects
- analyze spectra
...
1. The user explicitly requests measurement in the context of dark-matter
