# Ecology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of ecology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to ecology. This includes tasks such as:
- classify organisms
- analyze proteins
- analyze proteins
...
1. The user explicitly requests modeling in the context of ecology
