# Hydrology Design Research Level Skill

## Overview
This skill enables design in the domain of hydrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to hydrology. This includes tasks such as:
- measure properties
- model processes
- predict events
...
1. The user explicitly requests design in the context of hydrology
