# Unsupervised Mycology Modeling Skill

## Overview
This skill enables modeling in the domain of mycology (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
