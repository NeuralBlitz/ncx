# Molecular Neuroscience Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of molecular-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to molecular-neuroscience. This includes tasks such as:
- model circuits
...
1. The user explicitly requests simulation in the context of molecular-neuroscience
