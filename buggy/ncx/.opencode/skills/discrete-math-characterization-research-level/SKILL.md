# Discrete Math Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to discrete-math. This includes tasks such as:
- calculate integrals
- analyze functions
- compute derivatives
...
1. The user explicitly requests characterization in the context of discrete-math
...
4. The work involves discrete-math methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of discrete-math principles and methods
...
2. **Methodology**: Follow established discrete-math protocols and best practices
...
- Adjacent discrete-math skills for comprehensive analysis
...
7. Stay current with discrete-math literature and methods

## Version Information
- Complexity Level: research-level
- Domain: mathematics
- Subdiscipline: discrete-math
