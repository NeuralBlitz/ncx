# Statistics Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of statistics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to statistics. This includes tasks such as:
- prove theorems
- calculate integrals
- solve equations
...
1. The user explicitly requests measurement in the context of statistics
