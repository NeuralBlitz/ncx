# Game Theory Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of game-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to game-theory. This includes tasks such as:
- compute derivatives
- prove theorems
- prove theorems
...
1. The user explicitly requests troubleshooting in the context of game-theory
