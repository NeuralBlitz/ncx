# Semi Supervised Extragalactic Astronomy Prediction Skill

## Overview
This skill enables prediction in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to extragalactic-astronomy. This includes tasks such as:
- observe objects
- analyze spectra
- observe objects
...
1. The user explicitly requests prediction in the context of extragalactic-astronomy
