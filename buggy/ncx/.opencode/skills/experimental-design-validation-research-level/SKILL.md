# Experimental Design Validation Research Level Skill

## Overview
This skill enables validation in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to experimental-design. This includes tasks such as:
- extract features
- extract features
- visualize data
...
1. The user explicitly requests validation in the context of experimental-design
