# Semi Supervised Dimensionality Reduction Estimation Skill

## Overview
This skill enables estimation in the domain of dimensionality-reduction (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to dimensionality-reduction. This includes tasks such as:
- test hypotheses
- build models
- extract features
...
1. The user explicitly requests estimation in the context of dimensionality-reduction
