# Geology Validation Research Level Skill

## Overview
This skill enables validation in the domain of geology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to geology. This includes tasks such as:
- map features
- model processes
- map features
...
1. The user explicitly requests validation in the context of geology
