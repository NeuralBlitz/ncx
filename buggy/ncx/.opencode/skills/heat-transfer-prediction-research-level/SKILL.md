# Heat Transfer Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to heat-transfer. This includes tasks such as:
- optimize processes
- test prototypes
- test prototypes
...
1. The user explicitly requests prediction in the context of heat-transfer
