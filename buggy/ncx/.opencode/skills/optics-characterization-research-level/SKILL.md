# Optics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to optics. This includes tasks such as:
- predict behavior
- model systems
- analyze motion
...
1. The user explicitly requests characterization in the context of optics
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves optics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of optics principles and methods
...
2. **Methodology**: Follow established optics protocols and best practices
...
- Adjacent optics skills for comprehensive analysis
...
7. Stay current with optics literature and methods
