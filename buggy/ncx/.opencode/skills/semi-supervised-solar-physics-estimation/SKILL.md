# Semi Supervised Solar Physics Estimation Skill

## Overview
This skill enables estimation in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to solar-physics. This includes tasks such as:
- measure distances
- detect signals
- observe objects
...
1. The user explicitly requests estimation in the context of solar-physics
