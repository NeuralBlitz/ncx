# Dark Matter Simulation Intermediate Skill

## Overview
This skill enables simulation in the domain of dark-matter (astronomy). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.
...
1. The user explicitly requests simulation in the context of dark-matter
