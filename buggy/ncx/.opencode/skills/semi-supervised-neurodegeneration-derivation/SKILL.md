# Semi Supervised Neurodegeneration Derivation Skill

## Overview
This skill enables derivation in the domain of neurodegeneration (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to neurodegeneration. This includes tasks such as:
- study behavior
...
1. The user explicitly requests derivation in the context of neurodegeneration
