# Extragalactic Astronomy Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to extragalactic-astronomy. This includes tasks such as:
- observe objects
- model phenomena
- analyze spectra
...
1. The user explicitly requests synthesis in the context of extragalactic-astronomy
