# Semi Supervised Neuropharmacology Verification Skill

## Overview
This skill enables verification in the domain of neuropharmacology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to neuropharmacology. This includes tasks such as:
- model circuits
- map connections
- model circuits
...
1. The user explicitly requests verification in the context of neuropharmacology
