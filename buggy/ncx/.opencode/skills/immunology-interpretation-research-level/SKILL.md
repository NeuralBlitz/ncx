# Immunology Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of immunology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to immunology. This includes tasks such as:
- model populations
- measure expression
- study interactions
...
1. The user explicitly requests interpretation in the context of immunology
