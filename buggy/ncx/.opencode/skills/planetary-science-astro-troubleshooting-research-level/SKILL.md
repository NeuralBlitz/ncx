# Planetary Science Astro Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to planetary-science-astro. This includes tasks such as:
- model phenomena
- calculate orbits
- calculate orbits
...
1. The user explicitly requests troubleshooting in the context of planetary-science-astro
