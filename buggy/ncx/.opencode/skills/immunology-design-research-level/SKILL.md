# Immunology Design Research Level Skill

## Overview
This skill enables design in the domain of immunology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to immunology. This includes tasks such as:
- study interactions
- sequence DNA
- model populations
...
1. The user explicitly requests design in the context of immunology
