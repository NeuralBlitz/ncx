# Helioseismology Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to helioseismology. This includes tasks such as:
- measure distances
- model phenomena
- detect signals
...
1. The user explicitly requests derivation in the context of helioseismology
