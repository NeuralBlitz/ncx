# Cloud Computing Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of cloud-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to cloud-computing. This includes tasks such as:
- analyze complexity
- debug programs
- optimize code
...
1. The user explicitly requests measurement in the context of cloud-computing
