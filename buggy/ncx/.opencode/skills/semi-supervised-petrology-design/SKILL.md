# Semi Supervised Petrology Design Skill

## Overview
This skill enables design in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to petrology. This includes tasks such as:
- model processes
- interpret data
- predict events
...
1. The user explicitly requests design in the context of petrology
