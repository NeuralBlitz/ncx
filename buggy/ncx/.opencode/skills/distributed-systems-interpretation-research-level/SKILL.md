# Distributed Systems Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to distributed-systems. This includes tasks such as:
- optimize code
- optimize code
- design systems
...
1. The user explicitly requests interpretation in the context of distributed-systems
