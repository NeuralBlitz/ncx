# Dark Energy Testing Research Level Skill

## Overview
This skill enables testing in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to dark-energy. This includes tasks such as:
- analyze spectra
- observe objects
- calculate orbits
...
1. The user explicitly requests testing in the context of dark-energy
