# Bayesian Statistics Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of bayesian-statistics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to bayesian-statistics. This includes tasks such as:
- visualize data
- extract features
- build models
...
1. The user explicitly requests estimation in the context of bayesian-statistics
