# Planetary Science Astro Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to planetary-science-astro. This includes tasks such as:
- measure distances
- calculate orbits
- calculate orbits
...
1. The user explicitly requests characterization in the context of planetary-science-astro
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves planetary-science-astro methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of planetary-science-astro principles and methods
...
2. **Methodology**: Follow established planetary-science-astro protocols and best practices
...
- Adjacent planetary-science-astro skills for comprehensive analysis
...
7. Stay current with planetary-science-astro literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: planetary-science-astro
