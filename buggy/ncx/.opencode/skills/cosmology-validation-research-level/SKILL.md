# Cosmology Validation Research Level Skill

## Overview
This skill enables validation in the domain of cosmology (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to cosmology. This includes tasks such as:
- predict behavior
- measure quantities
- model systems
...
1. The user explicitly requests validation in the context of cosmology
