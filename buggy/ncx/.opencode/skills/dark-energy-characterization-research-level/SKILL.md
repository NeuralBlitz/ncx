# Dark Energy Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to dark-energy. This includes tasks such as:
- detect signals
- analyze spectra
- detect signals
...
1. The user explicitly requests characterization in the context of dark-energy
...
4. The work involves dark-energy methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of dark-energy principles and methods
...
2. **Methodology**: Follow established dark-energy protocols and best practices
...
- Adjacent dark-energy skills for comprehensive analysis
...
7. Stay current with dark-energy literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: dark-energy
