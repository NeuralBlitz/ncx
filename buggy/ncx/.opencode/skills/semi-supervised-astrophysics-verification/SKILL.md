# Semi Supervised Astrophysics Verification Skill

## Overview
This skill enables verification in the domain of astrophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to astrophysics. This includes tasks such as:
- predict behavior
- calculate forces
...
1. The user explicitly requests verification in the context of astrophysics
