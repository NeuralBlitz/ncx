# Quantum Field Theory Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to quantum-field-theory. This includes tasks such as:
- measure quantities
...
1. The user explicitly requests calculation in the context of quantum-field-theory
