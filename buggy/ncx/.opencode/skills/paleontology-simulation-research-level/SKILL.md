# Paleontology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of paleontology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to paleontology. This includes tasks such as:
- map features
- map features
- measure properties
...
1. The user explicitly requests simulation in the context of paleontology
