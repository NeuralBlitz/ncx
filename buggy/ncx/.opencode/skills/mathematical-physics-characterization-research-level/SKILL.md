# Mathematical Physics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of mathematical-physics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to mathematical-physics. This includes tasks such as:
- prove theorems
- solve equations
- calculate integrals
...
1. The user explicitly requests characterization in the context of mathematical-physics
...
4. The work involves mathematical-physics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of mathematical-physics principles and methods
...
2. **Methodology**: Follow established mathematical-physics protocols and best practices
...
- Adjacent mathematical-physics skills for comprehensive analysis
...
7. Stay current with mathematical-physics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: mathematics
- Subdiscipline: mathematical-physics
