# Black Holes Validation Research Level Skill

## Overview
This skill enables validation in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to black-holes. This includes tasks such as:
- model phenomena
- analyze spectra
- detect signals
...
1. The user explicitly requests validation in the context of black-holes
