# Geology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of geology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to geology. This includes tasks such as:
- measure properties
- interpret data
- measure properties
...
1. The user explicitly requests modeling in the context of geology
