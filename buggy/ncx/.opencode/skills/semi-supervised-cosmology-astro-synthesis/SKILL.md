# Semi Supervised Cosmology Astro Synthesis Skill

## Overview
This skill enables synthesis in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to cosmology-astro. This includes tasks such as:
- model phenomena
- detect signals
- detect signals
...
1. The user explicitly requests synthesis in the context of cosmology-astro
