# Statistical Condensed Matter Design Skill

## Overview
This skill enables design in the domain of condensed-matter (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
