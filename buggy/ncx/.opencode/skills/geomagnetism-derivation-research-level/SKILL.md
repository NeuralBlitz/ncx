# Geomagnetism Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to geomagnetism. This includes tasks such as:
- analyze samples
- interpret data
- analyze samples
...
1. The user explicitly requests derivation in the context of geomagnetism
