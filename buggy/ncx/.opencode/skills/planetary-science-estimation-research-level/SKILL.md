# Planetary Science Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to planetary-science. This includes tasks such as:
- map features
- map features
- measure properties
...
1. The user explicitly requests estimation in the context of planetary-science
