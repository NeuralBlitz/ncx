# Connectomics Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of connectomics (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to connectomics. This includes tasks such as:
- model circuits
- measure responses
- model circuits
...
1. The user explicitly requests prediction in the context of connectomics
