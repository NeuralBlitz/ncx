# Mechanical Engineering Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of mechanical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to mechanical-engineering. This includes tasks such as:
- test prototypes
- analyze structures
...
1. The user explicitly requests measurement in the context of mechanical-engineering
