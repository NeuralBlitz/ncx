# Semi Supervised Mineralogy Prediction Skill

## Overview
This skill enables prediction in the domain of mineralogy (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to mineralogy. This includes tasks such as:
- model processes
- interpret data
- interpret data
...
1. The user explicitly requests prediction in the context of mineralogy
