# Semi Supervised Neuroanatomy Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of neuroanatomy (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to neuroanatomy. This includes tasks such as:
- study behavior
...
1. The user explicitly requests troubleshooting in the context of neuroanatomy
