# Neuroscience Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of neuroscience (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to neuroscience. This includes tasks such as:
- sequence DNA
- analyze proteins
- measure expression
...
1. The user explicitly requests prediction in the context of neuroscience
