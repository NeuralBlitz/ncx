# Neuroanatomy Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of neuroanatomy (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to neuroanatomy. This includes tasks such as:
- study behavior
- map connections
- map connections
...
1. The user explicitly requests interpretation in the context of neuroanatomy
