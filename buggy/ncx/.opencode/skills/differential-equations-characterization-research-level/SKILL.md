# Differential Equations Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to differential-equations. This includes tasks such as:
- find eigenvalues
- compute derivatives
- calculate integrals
...
1. The user explicitly requests characterization in the context of differential-equations
...
4. The work involves differential-equations methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of differential-equations principles and methods
...
2. **Methodology**: Follow established differential-equations protocols and best practices
...
- Adjacent differential-equations skills for comprehensive analysis
...
7. Stay current with differential-equations literature and methods

## Version Information
- Complexity Level: research-level
- Domain: mathematics
- Subdiscipline: differential-equations
