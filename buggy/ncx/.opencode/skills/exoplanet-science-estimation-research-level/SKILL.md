# Exoplanet Science Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to exoplanet-science. This includes tasks such as:
- calculate orbits
- model phenomena
- observe objects
...
1. The user explicitly requests estimation in the context of exoplanet-science
