# Evolutionary Biology Design Research Level Skill

## Overview
This skill enables design in the domain of evolutionary-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to evolutionary-biology. This includes tasks such as:
- study interactions
- model populations
- classify organisms
...
1. The user explicitly requests design in the context of evolutionary-biology
