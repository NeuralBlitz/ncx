# Planetary Science Astro Verification Research Level Skill

## Overview
This skill enables verification in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to planetary-science-astro. This includes tasks such as:
- model phenomena
- model phenomena
- observe objects
...
1. The user explicitly requests verification in the context of planetary-science-astro
