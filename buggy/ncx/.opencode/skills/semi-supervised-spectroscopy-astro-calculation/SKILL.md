# Semi Supervised Spectroscopy Astro Calculation Skill

## Overview
This skill enables calculation in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to spectroscopy-astro. This includes tasks such as:
- observe objects
- analyze spectra
- model phenomena
...
1. The user explicitly requests calculation in the context of spectroscopy-astro
