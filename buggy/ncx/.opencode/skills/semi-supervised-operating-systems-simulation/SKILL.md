# Semi Supervised Operating Systems Simulation Skill

## Overview
This skill enables simulation in the domain of operating-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to operating-systems. This includes tasks such as:
- optimize code
- debug programs
- optimize code
...
1. The user explicitly requests simulation in the context of operating-systems
