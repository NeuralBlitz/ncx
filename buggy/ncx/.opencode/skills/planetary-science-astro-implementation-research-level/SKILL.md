# Planetary Science Astro Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to planetary-science-astro. This includes tasks such as:
- observe objects
- detect signals
- detect signals
...
1. The user explicitly requests implementation in the context of planetary-science-astro
