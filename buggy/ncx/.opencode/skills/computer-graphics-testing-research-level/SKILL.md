# Computer Graphics Testing Research Level Skill

## Overview
This skill enables testing in the domain of computer-graphics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to computer-graphics. This includes tasks such as:
- analyze complexity
- optimize code
- analyze complexity
...
1. The user explicitly requests testing in the context of computer-graphics
