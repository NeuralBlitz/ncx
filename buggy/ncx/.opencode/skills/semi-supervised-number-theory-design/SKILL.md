# Semi Supervised Number Theory Design Skill

## Overview
This skill enables design in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to number-theory. This includes tasks such as:
- solve equations
- calculate integrals
- prove theorems
...
1. The user explicitly requests design in the context of number-theory
