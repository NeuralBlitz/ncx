# Laser Physics Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to laser-physics. This includes tasks such as:
- calculate forces
- calculate forces
- calculate forces
...
1. The user explicitly requests interpretation in the context of laser-physics
