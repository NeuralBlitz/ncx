# Nonparametric Algorithms Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of algorithms (computer-science). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
...
1. The user explicitly requests troubleshooting in the context of algorithms
