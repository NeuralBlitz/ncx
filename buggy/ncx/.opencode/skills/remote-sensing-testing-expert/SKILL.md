# Remote Sensing Testing Expert Skill

## Overview
This skill enables testing in the domain of remote-sensing (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
