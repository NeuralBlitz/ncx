# Gravitational Waves Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to gravitational-waves. This includes tasks such as:
- observe objects
- measure distances
- detect signals
...
1. The user explicitly requests modeling in the context of gravitational-waves
