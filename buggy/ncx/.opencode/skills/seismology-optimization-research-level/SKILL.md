# Seismology Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of seismology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to seismology. This includes tasks such as:
- predict events
- analyze samples
- map features
...
1. The user explicitly requests optimization in the context of seismology
