# Statistical Mechanics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of statistical-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to statistical-mechanics. This includes tasks such as:
- analyze motion
- model systems
- predict behavior
...
1. The user explicitly requests simulation in the context of statistical-mechanics
