# Gravitational Waves Design Research Level Skill

## Overview
This skill enables design in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to gravitational-waves. This includes tasks such as:
- detect signals
- detect signals
- detect signals
...
1. The user explicitly requests design in the context of gravitational-waves
