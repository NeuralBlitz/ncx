# Soil Science Design Research Level Skill

## Overview
This skill enables design in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to soil-science. This includes tasks such as:
- map features
- map features
- measure properties
...
1. The user explicitly requests design in the context of soil-science
