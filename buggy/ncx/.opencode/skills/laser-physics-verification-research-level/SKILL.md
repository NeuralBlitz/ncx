# Laser Physics Verification Research Level Skill

## Overview
This skill enables verification in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to laser-physics. This includes tasks such as:
- model systems
- calculate forces
- predict behavior
...
1. The user explicitly requests verification in the context of laser-physics
