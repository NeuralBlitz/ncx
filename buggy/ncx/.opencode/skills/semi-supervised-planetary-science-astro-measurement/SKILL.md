# Semi Supervised Planetary Science Astro Measurement Skill

## Overview
This skill enables measurement in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to planetary-science-astro. This includes tasks such as:
- calculate orbits
- model phenomena
- observe objects
...
1. The user explicitly requests measurement in the context of planetary-science-astro
