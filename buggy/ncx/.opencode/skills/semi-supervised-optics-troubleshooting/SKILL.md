# Semi Supervised Optics Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to optics. This includes tasks such as:
- analyze motion
- calculate forces
- model systems
...
1. The user explicitly requests troubleshooting in the context of optics
