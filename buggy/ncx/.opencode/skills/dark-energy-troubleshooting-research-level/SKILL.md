# Dark Energy Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to dark-energy. This includes tasks such as:
- calculate orbits
- detect signals
- observe objects
...
1. The user explicitly requests troubleshooting in the context of dark-energy
