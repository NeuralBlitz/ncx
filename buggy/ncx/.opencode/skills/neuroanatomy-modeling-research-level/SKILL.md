# Neuroanatomy Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of neuroanatomy (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to neuroanatomy. This includes tasks such as:
- study behavior
- model circuits
- model circuits
...
1. The user explicitly requests modeling in the context of neuroanatomy
