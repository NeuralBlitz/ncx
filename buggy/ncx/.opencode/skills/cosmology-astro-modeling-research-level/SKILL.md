# Cosmology Astro Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to cosmology-astro. This includes tasks such as:
- observe objects
- analyze spectra
- calculate orbits
...
1. The user explicitly requests modeling in the context of cosmology-astro
