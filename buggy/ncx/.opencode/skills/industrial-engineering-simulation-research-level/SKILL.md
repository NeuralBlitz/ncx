# Industrial Engineering Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of industrial-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to industrial-engineering. This includes tasks such as:
- design components
- design components
- design components
...
1. The user explicitly requests simulation in the context of industrial-engineering
