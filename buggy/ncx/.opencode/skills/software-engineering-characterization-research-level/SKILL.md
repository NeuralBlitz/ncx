# Software Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of software-engineering (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to software-engineering. This includes tasks such as:
- debug programs
- analyze complexity
- analyze complexity
...
1. The user explicitly requests characterization in the context of software-engineering
...
4. The work involves software-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of software-engineering principles and methods
...
2. **Methodology**: Follow established software-engineering protocols and best practices
...
- Adjacent software-engineering skills for comprehensive analysis
...
7. Stay current with software-engineering literature and methods
