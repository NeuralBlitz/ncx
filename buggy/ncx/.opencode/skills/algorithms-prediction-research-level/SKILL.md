# Algorithms Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of algorithms (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to algorithms. This includes tasks such as:
- analyze complexity
- optimize code
- analyze complexity
...
1. The user explicitly requests prediction in the context of algorithms
