# Systems Neuroscience Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of systems-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to systems-neuroscience. This includes tasks such as:
- measure responses
...
1. The user explicitly requests synthesis in the context of systems-neuroscience
