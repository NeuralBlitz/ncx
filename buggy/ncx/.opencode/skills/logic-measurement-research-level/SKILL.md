# Logic Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of logic (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to logic. This includes tasks such as:
- compute derivatives
- prove theorems
- analyze functions
...
1. The user explicitly requests measurement in the context of logic
