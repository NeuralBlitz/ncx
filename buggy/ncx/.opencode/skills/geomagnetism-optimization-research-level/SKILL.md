# Geomagnetism Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to geomagnetism. This includes tasks such as:
- interpret data
- analyze samples
- interpret data
...
1. The user explicitly requests optimization in the context of geomagnetism
