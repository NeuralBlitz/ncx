# Discrete Math Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to discrete-math. This includes tasks such as:
- find eigenvalues
- prove theorems
- calculate integrals
...
1. The user explicitly requests synthesis in the context of discrete-math
