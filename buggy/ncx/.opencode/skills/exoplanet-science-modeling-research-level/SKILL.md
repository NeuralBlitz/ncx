# Exoplanet Science Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to exoplanet-science. This includes tasks such as:
- observe objects
- analyze spectra
- model phenomena
...
1. The user explicitly requests modeling in the context of exoplanet-science
