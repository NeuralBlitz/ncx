# Measure Theory Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of measure-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to measure-theory. This includes tasks such as:
- calculate integrals
- calculate integrals
- compute derivatives
...
1. The user explicitly requests calculation in the context of measure-theory
