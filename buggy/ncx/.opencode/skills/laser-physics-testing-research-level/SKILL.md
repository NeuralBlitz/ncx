# Laser Physics Testing Research Level Skill

## Overview
This skill enables testing in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to laser-physics. This includes tasks such as:
- predict behavior
- measure quantities
- model systems
...
1. The user explicitly requests testing in the context of laser-physics
