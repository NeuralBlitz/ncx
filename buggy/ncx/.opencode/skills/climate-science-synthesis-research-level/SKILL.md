# Climate Science Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of climate-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to climate-science. This includes tasks such as:
- predict events
- map features
- map features
...
1. The user explicitly requests synthesis in the context of climate-science
