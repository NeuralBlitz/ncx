# Semi Supervised Computational Biology Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of computational-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to computational-biology. This includes tasks such as:
- measure expression
- classify organisms
- sequence DNA
...
1. The user explicitly requests troubleshooting in the context of computational-biology
