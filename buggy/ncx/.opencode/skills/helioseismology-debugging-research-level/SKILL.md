# Helioseismology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to helioseismology. This includes tasks such as:
- calculate orbits
- measure distances
- analyze spectra
...
1. The user explicitly requests debugging in the context of helioseismology
