# Semi Supervised Data Mining Optimization Skill

## Overview
This skill enables optimization in the domain of data-mining (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to data-mining. This includes tasks such as:
- predict outcomes
- build models
- extract features
...
1. The user explicitly requests optimization in the context of data-mining
