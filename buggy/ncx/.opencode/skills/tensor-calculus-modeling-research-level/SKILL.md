# Tensor Calculus Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to tensor-calculus. This includes tasks such as:
- calculate integrals
- compute derivatives
- compute derivatives
...
1. The user explicitly requests modeling in the context of tensor-calculus
