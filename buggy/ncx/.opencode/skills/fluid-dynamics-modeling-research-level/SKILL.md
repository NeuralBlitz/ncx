# Fluid Dynamics Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of fluid-dynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to fluid-dynamics. This includes tasks such as:
- model systems
- model systems
- model systems
...
1. The user explicitly requests modeling in the context of fluid-dynamics
