# Microbiology Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of microbiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to microbiology. This includes tasks such as:
- classify organisms
- classify organisms
- model populations
...
1. The user explicitly requests implementation in the context of microbiology
