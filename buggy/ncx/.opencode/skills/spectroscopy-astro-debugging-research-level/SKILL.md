# Spectroscopy Astro Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to spectroscopy-astro. This includes tasks such as:
- observe objects
- analyze spectra
- detect signals
...
1. The user explicitly requests debugging in the context of spectroscopy-astro
