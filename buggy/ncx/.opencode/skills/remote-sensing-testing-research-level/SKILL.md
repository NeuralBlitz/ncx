# Remote Sensing Testing Research Level Skill

## Overview
This skill enables testing in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to remote-sensing. This includes tasks such as:
- predict events
- interpret data
- measure properties
...
1. The user explicitly requests testing in the context of remote-sensing
