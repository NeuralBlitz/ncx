# Solar Physics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to solar-physics. This includes tasks such as:
- detect signals
- detect signals
- detect signals
...
1. The user explicitly requests derivation in the context of solar-physics
