# Cryptography Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of cryptography (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to cryptography. This includes tasks such as:
- compute derivatives
- compute derivatives
- analyze functions
...
1. The user explicitly requests modeling in the context of cryptography
