# Glaciology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to glaciology. This includes tasks such as:
- predict events
- model processes
- analyze samples
...
1. The user explicitly requests simulation in the context of glaciology
