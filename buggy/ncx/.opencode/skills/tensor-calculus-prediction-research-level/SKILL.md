# Tensor Calculus Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to tensor-calculus. This includes tasks such as:
- prove theorems
- analyze functions
- compute derivatives
...
1. The user explicitly requests prediction in the context of tensor-calculus
