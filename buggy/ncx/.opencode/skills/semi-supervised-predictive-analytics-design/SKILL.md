# Semi Supervised Predictive Analytics Design Skill

## Overview
This skill enables design in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to predictive-analytics. This includes tasks such as:
- predict outcomes
- predict outcomes
- extract features
...
1. The user explicitly requests design in the context of predictive-analytics
