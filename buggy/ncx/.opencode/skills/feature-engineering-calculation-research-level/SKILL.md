# Feature Engineering Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to feature-engineering. This includes tasks such as:
- extract features
- build models
- predict outcomes
...
1. The user explicitly requests calculation in the context of feature-engineering
