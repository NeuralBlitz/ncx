# Cosmology Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of cosmology (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to cosmology. This includes tasks such as:
- analyze motion
- model systems
- analyze motion
...
1. The user explicitly requests prediction in the context of cosmology
