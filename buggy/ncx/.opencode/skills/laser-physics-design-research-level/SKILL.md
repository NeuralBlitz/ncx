# Laser Physics Design Research Level Skill

## Overview
This skill enables design in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to laser-physics. This includes tasks such as:
- measure quantities
- measure quantities
- predict behavior
...
1. The user explicitly requests design in the context of laser-physics
