# Multivariate Cell Biology Measurement Skill

## Overview
This skill enables measurement in the domain of cell-biology (biology). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
