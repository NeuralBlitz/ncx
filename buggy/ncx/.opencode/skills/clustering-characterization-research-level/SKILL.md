# Clustering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of clustering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to clustering. This includes tasks such as:
- extract features
- test hypotheses
- extract features
...
1. The user explicitly requests characterization in the context of clustering
...
4. The work involves clustering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of clustering principles and methods
...
2. **Methodology**: Follow established clustering protocols and best practices
...
- Adjacent clustering skills for comprehensive analysis
...
7. Stay current with clustering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: clustering
