# Formal Verification Design Research Level Skill

## Overview
This skill enables design in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to formal-verification. This includes tasks such as:
- train models
- train models
- train models
...
1. The user explicitly requests design in the context of formal-verification
