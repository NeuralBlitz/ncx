# Semi Supervised Tectonics Characterization Skill

## Overview
This skill enables characterization in the domain of tectonics (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to tectonics. This includes tasks such as:
- analyze samples
- map features
- measure properties
...
1. The user explicitly requests characterization in the context of tectonics
...
4. The work involves tectonics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of tectonics principles and methods
...
2. **Methodology**: Follow established tectonics protocols and best practices
...
- Adjacent tectonics skills for comprehensive analysis
...
7. Stay current with tectonics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: tectonics
