# Logic Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of logic (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.
...
1. The user explicitly requests estimation in the context of logic
