# Microbiology Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of microbiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to microbiology. This includes tasks such as:
- model populations
- classify organisms
- sequence DNA
...
1. The user explicitly requests optimization in the context of microbiology
