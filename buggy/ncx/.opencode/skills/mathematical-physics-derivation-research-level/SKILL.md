# Mathematical Physics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of mathematical-physics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to mathematical-physics. This includes tasks such as:
- analyze functions
- prove theorems
- find eigenvalues
...
1. The user explicitly requests derivation in the context of mathematical-physics
