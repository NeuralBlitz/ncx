# Linear Algebra Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to linear-algebra. This includes tasks such as:
- calculate integrals
- prove theorems
- compute derivatives
...
1. The user explicitly requests analysis in the context of linear-algebra
