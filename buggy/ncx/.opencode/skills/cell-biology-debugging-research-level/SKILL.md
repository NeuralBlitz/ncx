# Cell Biology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of cell-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to cell-biology. This includes tasks such as:
- classify organisms
- analyze proteins
- measure expression
...
1. The user explicitly requests debugging in the context of cell-biology
