# Gravitational Waves Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to gravitational-waves. This includes tasks such as:
- calculate orbits
- calculate orbits
- measure distances
...
1. The user explicitly requests prediction in the context of gravitational-waves
