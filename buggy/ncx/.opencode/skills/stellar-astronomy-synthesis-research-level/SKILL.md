# Stellar Astronomy Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to stellar-astronomy. This includes tasks such as:
- observe objects
- measure distances
- observe objects
...
1. The user explicitly requests synthesis in the context of stellar-astronomy
