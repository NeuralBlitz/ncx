# Gravitational Waves Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to gravitational-waves. This includes tasks such as:
- detect signals
- calculate orbits
- detect signals
...
1. The user explicitly requests measurement in the context of gravitational-waves
