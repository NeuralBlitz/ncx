# Geomagnetism Design Advanced Skill

## Overview
This skill enables design in the domain of geomagnetism (earth-sciences). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.
