# Genetics Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to genetics. This includes tasks such as:
- analyze proteins
- model populations
- classify organisms
...
1. The user explicitly requests modeling in the context of genetics
