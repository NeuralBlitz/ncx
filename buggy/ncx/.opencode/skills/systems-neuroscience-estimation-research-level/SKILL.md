# Systems Neuroscience Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of systems-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to systems-neuroscience. This includes tasks such as:
- study behavior
- study behavior
- model circuits
...
1. The user explicitly requests estimation in the context of systems-neuroscience
