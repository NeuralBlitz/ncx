# Machine Learning Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to machine-learning. This includes tasks such as:
- design systems
- train models
- design systems
...
1. The user explicitly requests measurement in the context of machine-learning
