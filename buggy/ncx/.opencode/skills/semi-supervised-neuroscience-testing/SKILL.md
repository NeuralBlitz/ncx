# Semi Supervised Neuroscience Testing Skill

## Overview
This skill enables testing in the domain of neuroscience (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to neuroscience. This includes tasks such as:
- sequence DNA
- study interactions
- study interactions
...
1. The user explicitly requests testing in the context of neuroscience
