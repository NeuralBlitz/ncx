# Topology Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of topology (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to topology. This includes tasks such as:
- find eigenvalues
- calculate integrals
- prove theorems
...
1. The user explicitly requests interpretation in the context of topology
