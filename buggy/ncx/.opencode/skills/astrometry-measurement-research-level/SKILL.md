# Astrometry Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of astrometry (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to astrometry. This includes tasks such as:
- analyze spectra
- observe objects
- model phenomena
...
1. The user explicitly requests measurement in the context of astrometry
