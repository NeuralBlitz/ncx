# Connectomics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of connectomics (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to connectomics. This includes tasks such as:
- model circuits
...
1. The user explicitly requests derivation in the context of connectomics
