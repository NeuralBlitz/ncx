# Data Pipelines Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to data-pipelines. This includes tasks such as:
- extract features
- test hypotheses
- extract features
...
1. The user explicitly requests derivation in the context of data-pipelines
