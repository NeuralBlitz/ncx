# Programming Languages Validation Research Level Skill

## Overview
This skill enables validation in the domain of programming-languages (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to programming-languages. This includes tasks such as:
- design systems
- design systems
- analyze complexity
...
1. The user explicitly requests validation in the context of programming-languages
