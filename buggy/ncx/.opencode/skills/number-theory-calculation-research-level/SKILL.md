# Number Theory Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to number-theory. This includes tasks such as:
- compute derivatives
- prove theorems
- compute derivatives
...
1. The user explicitly requests calculation in the context of number-theory
