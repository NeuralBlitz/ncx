# Causal Inference Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to causal-inference. This includes tasks such as:
- build models
- predict outcomes
- extract features
...
1. The user explicitly requests optimization in the context of causal-inference
