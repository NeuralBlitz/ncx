# Natural Language Processing Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of natural-language-processing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to natural-language-processing. This includes tasks such as:
- train models
...
1. The user explicitly requests characterization in the context of natural-language-processing
...
4. The work involves natural-language-processing methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of natural-language-processing principles and methods
...
2. **Methodology**: Follow established natural-language-processing protocols and best practices
...
- Adjacent natural-language-processing skills for comprehensive analysis
...
7. Stay current with natural-language-processing literature and methods
