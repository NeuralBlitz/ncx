# Time Series Analysis Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of time-series-analysis (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to time-series-analysis. This includes tasks such as:
- extract features
- build models
- visualize data
...
1. The user explicitly requests calculation in the context of time-series-analysis
