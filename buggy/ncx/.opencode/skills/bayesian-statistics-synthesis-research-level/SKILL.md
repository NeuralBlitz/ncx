# Bayesian Statistics Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of bayesian-statistics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to bayesian-statistics. This includes tasks such as:
- predict outcomes
- visualize data
- extract features
...
1. The user explicitly requests synthesis in the context of bayesian-statistics
