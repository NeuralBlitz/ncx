# Linear Algebra Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to linear-algebra. This includes tasks such as:
- find eigenvalues
- solve equations
- compute derivatives
...
1. The user explicitly requests estimation in the context of linear-algebra
