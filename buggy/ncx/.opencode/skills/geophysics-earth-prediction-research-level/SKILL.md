# Geophysics Earth Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to geophysics-earth. This includes tasks such as:
- measure properties
- predict events
- map features
...
1. The user explicitly requests prediction in the context of geophysics-earth
