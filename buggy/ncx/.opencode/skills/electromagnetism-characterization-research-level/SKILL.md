# Electromagnetism Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of electromagnetism (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to electromagnetism. This includes tasks such as:
- predict behavior
- predict behavior
- predict behavior
...
1. The user explicitly requests characterization in the context of electromagnetism
...
4. The work involves electromagnetism methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of electromagnetism principles and methods
...
2. **Methodology**: Follow established electromagnetism protocols and best practices
...
- Adjacent electromagnetism skills for comprehensive analysis
...
7. Stay current with electromagnetism literature and methods
