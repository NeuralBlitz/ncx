# Dark Energy Verification Research Level Skill

## Overview
This skill enables verification in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to dark-energy. This includes tasks such as:
- model phenomena
- analyze spectra
- model phenomena
...
1. The user explicitly requests verification in the context of dark-energy
