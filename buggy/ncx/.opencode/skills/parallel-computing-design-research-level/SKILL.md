# Parallel Computing Design Research Level Skill

## Overview
This skill enables design in the domain of parallel-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to parallel-computing. This includes tasks such as:
- optimize code
- debug programs
- debug programs
...
1. The user explicitly requests design in the context of parallel-computing
