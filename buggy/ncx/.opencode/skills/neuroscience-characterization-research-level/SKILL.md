# Neuroscience Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of neuroscience (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to neuroscience. This includes tasks such as:
- classify organisms
- measure expression
- classify organisms
...
1. The user explicitly requests characterization in the context of neuroscience
2. The task requires research-level-level understanding of biology principles
3. The output needs to be genetic data
4. The work involves neuroscience methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of neuroscience principles and methods
...
2. **Methodology**: Follow established neuroscience protocols and best practices
...
- Adjacent neuroscience skills for comprehensive analysis
...
7. Stay current with neuroscience literature and methods
