# Data Pipelines Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to data-pipelines. This includes tasks such as:
- test hypotheses
- predict outcomes
- build models
...
1. The user explicitly requests troubleshooting in the context of data-pipelines
