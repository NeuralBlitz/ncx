# Laser Physics Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to laser-physics. This includes tasks such as:
- model systems
- model systems
- measure quantities
...
1. The user explicitly requests optimization in the context of laser-physics
