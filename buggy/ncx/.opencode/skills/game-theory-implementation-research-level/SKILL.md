# Game Theory Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of game-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to game-theory. This includes tasks such as:
- solve equations
- solve equations
- compute derivatives
...
1. The user explicitly requests implementation in the context of game-theory
