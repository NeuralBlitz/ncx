# Photonics Engineering Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of photonics-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to photonics-engineering. This includes tasks such as:
- test prototypes
- analyze structures
- analyze structures
...
1. The user explicitly requests modeling in the context of photonics-engineering
