# Optics Design Research Level Skill

## Overview
This skill enables design in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to optics. This includes tasks such as:
- calculate forces
- calculate forces
- model systems
...
1. The user explicitly requests design in the context of optics
