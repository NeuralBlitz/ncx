# Microbiology Simulation Fundamental Skill

## Overview
This skill enables simulation in the domain of microbiology (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
