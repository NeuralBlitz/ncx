# Black Holes Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to black-holes. This includes tasks such as:
- calculate orbits
- observe objects
- detect signals
...
1. The user explicitly requests interpretation in the context of black-holes
