# Number Theory Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to number-theory. This includes tasks such as:
- analyze functions
- compute derivatives
- analyze functions
...
1. The user explicitly requests measurement in the context of number-theory
