# Numerical Analysis Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to numerical-analysis. This includes tasks such as:
- calculate integrals
- find eigenvalues
- calculate integrals
...
1. The user explicitly requests analysis in the context of numerical-analysis
