# Power Systems Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to power-systems. This includes tasks such as:
- test prototypes
...
1. The user explicitly requests modeling in the context of power-systems
