# Tensor Calculus Testing Research Level Skill

## Overview
This skill enables testing in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to tensor-calculus. This includes tasks such as:
- calculate integrals
- solve equations
- calculate integrals
...
1. The user explicitly requests testing in the context of tensor-calculus
