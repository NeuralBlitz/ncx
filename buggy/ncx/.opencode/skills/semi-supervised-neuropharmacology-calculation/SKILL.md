# Semi Supervised Neuropharmacology Calculation Skill

## Overview
This skill enables calculation in the domain of neuropharmacology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to neuropharmacology. This includes tasks such as:
- model circuits
- model circuits
- map connections
...
1. The user explicitly requests calculation in the context of neuropharmacology
