# Numerical Analysis Verification Research Level Skill

## Overview
This skill enables verification in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to numerical-analysis. This includes tasks such as:
- solve equations
- solve equations
- find eigenvalues
...
1. The user explicitly requests verification in the context of numerical-analysis
