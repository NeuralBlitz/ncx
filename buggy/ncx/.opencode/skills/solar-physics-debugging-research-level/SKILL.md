# Solar Physics Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to solar-physics. This includes tasks such as:
- calculate orbits
- observe objects
- model phenomena
...
1. The user explicitly requests debugging in the context of solar-physics
