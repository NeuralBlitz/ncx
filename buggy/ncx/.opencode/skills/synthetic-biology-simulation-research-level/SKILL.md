# Synthetic Biology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of synthetic-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to synthetic-biology. This includes tasks such as:
- model populations
- analyze proteins
- analyze proteins
...
1. The user explicitly requests simulation in the context of synthetic-biology
