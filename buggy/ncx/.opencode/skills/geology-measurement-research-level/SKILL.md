# Geology Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of geology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to geology. This includes tasks such as:
- interpret data
- interpret data
- interpret data
...
1. The user explicitly requests measurement in the context of geology
