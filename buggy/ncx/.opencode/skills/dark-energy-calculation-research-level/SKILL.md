# Dark Energy Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to dark-energy. This includes tasks such as:
- analyze spectra
- measure distances
- calculate orbits
...
1. The user explicitly requests calculation in the context of dark-energy
