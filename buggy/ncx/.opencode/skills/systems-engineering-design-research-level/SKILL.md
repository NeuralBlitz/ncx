# Systems Engineering Design Research Level Skill

## Overview
This skill enables design in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to systems-engineering. This includes tasks such as:
- validate designs
- optimize processes
- optimize processes
...
1. The user explicitly requests design in the context of systems-engineering
