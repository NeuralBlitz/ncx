# Solar Physics Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to solar-physics. This includes tasks such as:
- model phenomena
- analyze spectra
- calculate orbits
...
1. The user explicitly requests modeling in the context of solar-physics
