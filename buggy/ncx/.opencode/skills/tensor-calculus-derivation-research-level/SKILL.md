# Tensor Calculus Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to tensor-calculus. This includes tasks such as:
- calculate integrals
- prove theorems
- solve equations
...
1. The user explicitly requests derivation in the context of tensor-calculus
