# Clinical Neuroscience Verification Research Level Skill

## Overview
This skill enables verification in the domain of clinical-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to clinical-neuroscience. This includes tasks such as:
- measure responses
- map connections
- study behavior
...
1. The user explicitly requests verification in the context of clinical-neuroscience
