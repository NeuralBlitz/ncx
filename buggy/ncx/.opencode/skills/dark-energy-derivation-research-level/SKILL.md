# Dark Energy Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to dark-energy. This includes tasks such as:
- observe objects
- calculate orbits
- observe objects
...
1. The user explicitly requests derivation in the context of dark-energy
