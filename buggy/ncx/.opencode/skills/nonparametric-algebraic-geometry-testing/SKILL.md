# Nonparametric Algebraic Geometry Testing Skill

## Overview
This skill enables testing in the domain of algebraic-geometry (mathematics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
...
1. The user explicitly requests testing in the context of algebraic-geometry
