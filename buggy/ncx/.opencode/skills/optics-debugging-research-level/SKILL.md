# Optics Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to optics. This includes tasks such as:
- measure quantities
- predict behavior
...
1. The user explicitly requests debugging in the context of optics
