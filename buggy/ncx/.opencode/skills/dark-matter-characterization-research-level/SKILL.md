# Dark Matter Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of dark-matter (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to dark-matter. This includes tasks such as:
- calculate orbits
- model phenomena
- model phenomena
...
1. The user explicitly requests characterization in the context of dark-matter
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves dark-matter methodologies or techniques
...
2. **Methodology**: Follow established dark-matter protocols and best practices
...
7. Stay current with dark-matter literature and methods
