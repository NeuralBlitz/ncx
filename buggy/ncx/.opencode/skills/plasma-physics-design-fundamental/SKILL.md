# Plasma Physics Design Fundamental Skill

## Overview
This skill enables design in the domain of plasma-physics (physics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
