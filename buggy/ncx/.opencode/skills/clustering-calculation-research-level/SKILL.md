# Clustering Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of clustering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to clustering. This includes tasks such as:
- analyze datasets
- predict outcomes
- extract features
...
1. The user explicitly requests calculation in the context of clustering
