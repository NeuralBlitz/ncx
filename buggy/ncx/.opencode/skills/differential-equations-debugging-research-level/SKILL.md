# Differential Equations Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of differential-equations (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to differential-equations. This includes tasks such as:
- compute derivatives
- compute derivatives
- analyze functions
...
1. The user explicitly requests debugging in the context of differential-equations
