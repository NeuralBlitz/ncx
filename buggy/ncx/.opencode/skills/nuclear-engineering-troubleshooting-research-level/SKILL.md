# Nuclear Engineering Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of nuclear-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to nuclear-engineering. This includes tasks such as:
- design components
- design components
...
1. The user explicitly requests troubleshooting in the context of nuclear-engineering
