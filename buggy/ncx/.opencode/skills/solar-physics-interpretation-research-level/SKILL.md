# Solar Physics Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to solar-physics. This includes tasks such as:
- detect signals
- calculate orbits
- detect signals
...
1. The user explicitly requests interpretation in the context of solar-physics
