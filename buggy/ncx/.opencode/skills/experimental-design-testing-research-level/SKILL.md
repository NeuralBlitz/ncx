# Experimental Design Testing Research Level Skill

## Overview
This skill enables testing in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to experimental-design. This includes tasks such as:
- analyze datasets
- build models
- test hypotheses
...
1. The user explicitly requests testing in the context of experimental-design
