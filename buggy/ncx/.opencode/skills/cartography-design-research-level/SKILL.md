# Cartography Design Research Level Skill

## Overview
This skill enables design in the domain of cartography (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to cartography. This includes tasks such as:
- measure properties
- predict events
- interpret data
...
1. The user explicitly requests design in the context of cartography
