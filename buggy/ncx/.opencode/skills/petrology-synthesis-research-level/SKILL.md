# Petrology Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to petrology. This includes tasks such as:
- analyze samples
- measure properties
- model processes
...
1. The user explicitly requests synthesis in the context of petrology
