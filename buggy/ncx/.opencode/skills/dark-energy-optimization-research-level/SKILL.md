# Dark Energy Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to dark-energy. This includes tasks such as:
- detect signals
- observe objects
- calculate orbits
...
1. The user explicitly requests optimization in the context of dark-energy
