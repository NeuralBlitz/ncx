# Semi Supervised Clustering Synthesis Skill

## Overview
This skill enables synthesis in the domain of clustering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to clustering. This includes tasks such as:
- visualize data
- extract features
- analyze datasets
...
1. The user explicitly requests synthesis in the context of clustering
