# Heat Transfer Design Research Level Skill

## Overview
This skill enables design in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to heat-transfer. This includes tasks such as:
- optimize processes
- test prototypes
- design components
...
1. The user explicitly requests design in the context of heat-transfer
