# Glaciology Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to glaciology. This includes tasks such as:
- interpret data
- analyze samples
- model processes
...
1. The user explicitly requests measurement in the context of glaciology
