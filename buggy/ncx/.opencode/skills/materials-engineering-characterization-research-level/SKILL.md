# Materials Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of materials-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to materials-engineering. This includes tasks such as:
- optimize processes
- test prototypes
- analyze structures
...
1. The user explicitly requests characterization in the context of materials-engineering
...
4. The work involves materials-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of materials-engineering principles and methods
...
2. **Methodology**: Follow established materials-engineering protocols and best practices
...
- Adjacent materials-engineering skills for comprehensive analysis
...
7. Stay current with materials-engineering literature and methods
