# Semi Supervised Mechanical Engineering Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of mechanical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to mechanical-engineering. This includes tasks such as:
- design components
- analyze structures
- analyze structures
...
1. The user explicitly requests troubleshooting in the context of mechanical-engineering
