# Neurophysiology Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of neurophysiology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to neurophysiology. This includes tasks such as:
- measure responses
- model circuits
- measure responses
...
1. The user explicitly requests modeling in the context of neurophysiology
