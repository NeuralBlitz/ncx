# Statistical Mechanics Classification Research Level Skill

## Overview
This skill enables classification in the domain of statistical-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to statistical-mechanics. This includes tasks such as:
- analyze motion
- model systems
...
1. The user explicitly requests classification in the context of statistical-mechanics
