# Dark Energy Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of dark-energy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to dark-energy. This includes tasks such as:
- observe objects
- model phenomena
- calculate orbits
...
1. The user explicitly requests analysis in the context of dark-energy
