# Climate Science Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of climate-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to climate-science. This includes tasks such as:
- model processes
- interpret data
- predict events
...
1. The user explicitly requests measurement in the context of climate-science
