# Statistical Modeling Classification Research Level Skill

## Overview
This skill enables classification in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to statistical-modeling. This includes tasks such as:
- test hypotheses
- extract features
- predict outcomes
...
1. The user explicitly requests classification in the context of statistical-modeling
