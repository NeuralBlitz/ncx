# Volcanology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of volcanology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to volcanology. This includes tasks such as:
- map features
- interpret data
- map features
...
1. The user explicitly requests simulation in the context of volcanology
