# Cryptography Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of cryptography (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to cryptography. This includes tasks such as:
- compute derivatives
- analyze functions
- compute derivatives
...
1. The user explicitly requests characterization in the context of cryptography
...
4. The work involves cryptography methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of cryptography principles and methods
...
2. **Methodology**: Follow established cryptography protocols and best practices
...
- Adjacent cryptography skills for comprehensive analysis
...
7. Stay current with cryptography literature and methods

## Version Information
- Complexity Level: research-level
- Domain: mathematics
- Subdiscipline: cryptography
