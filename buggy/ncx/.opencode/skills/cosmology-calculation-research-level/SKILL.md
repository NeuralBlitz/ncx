# Cosmology Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of cosmology (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to cosmology. This includes tasks such as:
- calculate forces
- predict behavior
- calculate forces
...
1. The user explicitly requests calculation in the context of cosmology
