# Neuroinformatics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of neuroinformatics (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to neuroinformatics. This includes tasks such as:
- measure responses
- map connections
- measure responses
...
1. The user explicitly requests characterization in the context of neuroinformatics
...
4. The work involves neuroinformatics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of neuroinformatics principles and methods
...
2. **Methodology**: Follow established neuroinformatics protocols and best practices
...
- Adjacent neuroinformatics skills for comprehensive analysis
...
7. Stay current with neuroinformatics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: neuroscience
- Subdiscipline: neuroinformatics
