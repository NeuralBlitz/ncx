# Electromagnetism Validation Research Level Skill

## Overview
This skill enables validation in the domain of electromagnetism (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to electromagnetism. This includes tasks such as:
- analyze motion
- calculate forces
...
1. The user explicitly requests validation in the context of electromagnetism
