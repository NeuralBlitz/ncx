# Botany Characterization Fundamental Skill

## Overview
This skill enables characterization in the domain of botany (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
