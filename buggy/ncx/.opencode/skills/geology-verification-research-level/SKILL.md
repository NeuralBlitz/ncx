# Geology Verification Research Level Skill

## Overview
This skill enables verification in the domain of geology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to geology. This includes tasks such as:
- predict events
- predict events
- map features
...
1. The user explicitly requests verification in the context of geology
