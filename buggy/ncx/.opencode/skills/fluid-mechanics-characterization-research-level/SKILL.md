# Fluid Mechanics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of fluid-mechanics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to fluid-mechanics. This includes tasks such as:
- design components
- design components
- analyze structures
...
1. The user explicitly requests characterization in the context of fluid-mechanics
...
4. The work involves fluid-mechanics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of fluid-mechanics principles and methods
...
2. **Methodology**: Follow established fluid-mechanics protocols and best practices
...
- Adjacent fluid-mechanics skills for comprehensive analysis
...
7. Stay current with fluid-mechanics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: fluid-mechanics
