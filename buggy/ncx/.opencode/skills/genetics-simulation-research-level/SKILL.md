# Genetics Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to genetics. This includes tasks such as:
- classify organisms
- sequence DNA
- sequence DNA
...
1. The user explicitly requests simulation in the context of genetics
