# Computer Graphics Validation Research Level Skill

## Overview
This skill enables validation in the domain of computer-graphics (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to computer-graphics. This includes tasks such as:
- train models
- optimize code
- train models
...
1. The user explicitly requests validation in the context of computer-graphics
