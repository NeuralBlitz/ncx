# Photonics Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of photonics-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to photonics-engineering. This includes tasks such as:
- optimize processes
- analyze structures
- optimize processes
...
1. The user explicitly requests characterization in the context of photonics-engineering
...
4. The work involves photonics-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of photonics-engineering principles and methods
...
2. **Methodology**: Follow established photonics-engineering protocols and best practices
...
- Adjacent photonics-engineering skills for comprehensive analysis
...
7. Stay current with photonics-engineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: photonics-engineering
