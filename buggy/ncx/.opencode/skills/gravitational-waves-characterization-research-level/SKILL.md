# Gravitational Waves Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to gravitational-waves. This includes tasks such as:
- calculate orbits
- observe objects
- observe objects
...
1. The user explicitly requests characterization in the context of gravitational-waves
2. The task requires research-level-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves gravitational-waves methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of gravitational-waves principles and methods
...
2. **Methodology**: Follow established gravitational-waves protocols and best practices
...
- Adjacent gravitational-waves skills for comprehensive analysis
...
7. Stay current with gravitational-waves literature and methods

## Version Information
- Complexity Level: research-level
- Domain: astronomy
- Subdiscipline: gravitational-waves
