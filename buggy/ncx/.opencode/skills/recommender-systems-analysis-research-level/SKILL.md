# Recommender Systems Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of recommender-systems (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to recommender-systems. This includes tasks such as:
- predict outcomes
- build models
- extract features
...
1. The user explicitly requests analysis in the context of recommender-systems
