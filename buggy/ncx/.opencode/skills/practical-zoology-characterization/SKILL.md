# Practical Zoology Characterization Skill

## Overview
This skill enables characterization in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to zoology. This includes tasks such as:
- model populations
- study interactions
- measure expression
...
1. The user explicitly requests characterization in the context of zoology
