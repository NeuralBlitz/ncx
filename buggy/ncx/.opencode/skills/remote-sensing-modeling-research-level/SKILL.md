# Remote Sensing Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of remote-sensing (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to remote-sensing. This includes tasks such as:
- predict events
- analyze samples
- analyze samples
...
1. The user explicitly requests modeling in the context of remote-sensing
