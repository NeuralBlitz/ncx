# Number Theory Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to number-theory. This includes tasks such as:
- calculate integrals
- calculate integrals
- find eigenvalues
...
1. The user explicitly requests interpretation in the context of number-theory
