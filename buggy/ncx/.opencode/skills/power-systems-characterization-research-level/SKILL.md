# Power Systems Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to power-systems. This includes tasks such as:
- test prototypes
- validate designs
- validate designs
...
1. The user explicitly requests characterization in the context of power-systems
