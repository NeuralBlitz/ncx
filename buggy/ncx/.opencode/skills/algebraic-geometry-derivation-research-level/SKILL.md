# Algebraic Geometry Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of algebraic-geometry (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to algebraic-geometry. This includes tasks such as:
- calculate integrals
- find eigenvalues
- solve equations
...
1. The user explicitly requests derivation in the context of algebraic-geometry
