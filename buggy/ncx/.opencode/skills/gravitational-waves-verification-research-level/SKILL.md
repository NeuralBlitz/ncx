# Gravitational Waves Verification Research Level Skill

## Overview
This skill enables verification in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to gravitational-waves. This includes tasks such as:
- calculate orbits
- calculate orbits
- model phenomena
...
1. The user explicitly requests verification in the context of gravitational-waves
