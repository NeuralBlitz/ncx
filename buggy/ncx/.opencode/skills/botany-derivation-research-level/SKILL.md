# Botany Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of botany (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.
