# Quantum Field Theory Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to quantum-field-theory. This includes tasks such as:
- predict behavior
...
1. The user explicitly requests synthesis in the context of quantum-field-theory
