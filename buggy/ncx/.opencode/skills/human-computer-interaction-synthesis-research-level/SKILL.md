# Human Computer Interaction Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of human-computer-interaction (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to human-computer-interaction. This includes tasks such as:
- optimize code
- debug programs
- analyze complexity
...
1. The user explicitly requests synthesis in the context of human-computer-interaction
