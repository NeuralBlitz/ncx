# Condensed Matter Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of condensed-matter (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to condensed-matter. This includes tasks such as:
- analyze motion
...
1. The user explicitly requests modeling in the context of condensed-matter
