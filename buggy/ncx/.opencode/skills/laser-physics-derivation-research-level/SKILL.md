# Laser Physics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to laser-physics. This includes tasks such as:
- model systems
- model systems
- model systems
...
1. The user explicitly requests derivation in the context of laser-physics
