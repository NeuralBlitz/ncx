# Complex Analysis Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of complex-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to complex-analysis. This includes tasks such as:
- calculate integrals
- find eigenvalues
- calculate integrals
...
1. The user explicitly requests debugging in the context of complex-analysis
