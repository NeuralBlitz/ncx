# Semi Supervised Meteorology Interpretation Skill

## Overview
This skill enables interpretation in the domain of meteorology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to meteorology. This includes tasks such as:
- interpret data
- model processes
- map features
...
1. The user explicitly requests interpretation in the context of meteorology
