# Exoplanet Science Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of exoplanet-science (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to exoplanet-science. This includes tasks such as:
- model phenomena
- analyze spectra
- calculate orbits
...
1. The user explicitly requests calculation in the context of exoplanet-science
