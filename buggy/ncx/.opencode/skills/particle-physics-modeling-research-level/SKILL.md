# Particle Physics Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to particle-physics. This includes tasks such as:
- model systems
- predict behavior
- predict behavior
...
1. The user explicitly requests modeling in the context of particle-physics
