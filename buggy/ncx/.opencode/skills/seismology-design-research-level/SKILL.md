# Seismology Design Research Level Skill

## Overview
This skill enables design in the domain of seismology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to seismology. This includes tasks such as:
- interpret data
- predict events
- measure properties
...
1. The user explicitly requests design in the context of seismology
