# Industrial Engineering Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of industrial-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to industrial-engineering. This includes tasks such as:
- validate designs
- design components
- design components
...
1. The user explicitly requests calculation in the context of industrial-engineering
