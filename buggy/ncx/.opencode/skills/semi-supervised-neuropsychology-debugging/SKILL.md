# Semi Supervised Neuropsychology Debugging Skill

## Overview
This skill enables debugging in the domain of neuropsychology (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to neuropsychology. This includes tasks such as:
- study behavior
- model circuits
...
1. The user explicitly requests debugging in the context of neuropsychology
