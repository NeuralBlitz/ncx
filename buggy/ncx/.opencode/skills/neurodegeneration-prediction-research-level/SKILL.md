# Neurodegeneration Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of neurodegeneration (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to neurodegeneration. This includes tasks such as:
- measure responses
- measure responses
...
1. The user explicitly requests prediction in the context of neurodegeneration
