# Soil Science Classification Research Level Skill

## Overview
This skill enables classification in the domain of soil-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to soil-science. This includes tasks such as:
- interpret data
- predict events
- measure properties
...
1. The user explicitly requests classification in the context of soil-science
