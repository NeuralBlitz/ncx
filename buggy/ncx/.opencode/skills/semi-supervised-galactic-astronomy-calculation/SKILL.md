# Semi Supervised Galactic Astronomy Calculation Skill

## Overview
This skill enables calculation in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to galactic-astronomy. This includes tasks such as:
- calculate orbits
- measure distances
- observe objects
...
1. The user explicitly requests calculation in the context of galactic-astronomy
