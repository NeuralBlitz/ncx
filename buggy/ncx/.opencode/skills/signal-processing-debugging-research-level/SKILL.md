# Signal Processing Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of signal-processing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to signal-processing. This includes tasks such as:
- validate designs
- test prototypes
- validate designs
...
1. The user explicitly requests debugging in the context of signal-processing
