# Cosmology Astro Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to cosmology-astro. This includes tasks such as:
- analyze spectra
- model phenomena
- analyze spectra
...
1. The user explicitly requests calculation in the context of cosmology-astro
