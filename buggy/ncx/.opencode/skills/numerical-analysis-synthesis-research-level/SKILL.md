# Numerical Analysis Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of numerical-analysis (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to numerical-analysis. This includes tasks such as:
- analyze functions
- calculate integrals
- calculate integrals
...
1. The user explicitly requests synthesis in the context of numerical-analysis
