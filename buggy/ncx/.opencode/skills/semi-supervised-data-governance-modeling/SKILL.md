# Semi Supervised Data Governance Modeling Skill

## Overview
This skill enables modeling in the domain of data-governance (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to data-governance. This includes tasks such as:
- build models
- extract features
- extract features
...
1. The user explicitly requests modeling in the context of data-governance
