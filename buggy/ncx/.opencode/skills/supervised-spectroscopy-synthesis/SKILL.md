# Supervised Spectroscopy Synthesis Skill

## Overview
This skill enables synthesis in the domain of spectroscopy (chemistry). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.
