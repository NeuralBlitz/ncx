# Mathematical Physics Verification Research Level Skill

## Overview
This skill enables verification in the domain of mathematical-physics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to mathematical-physics. This includes tasks such as:
- find eigenvalues
- compute derivatives
- find eigenvalues
...
1. The user explicitly requests verification in the context of mathematical-physics
