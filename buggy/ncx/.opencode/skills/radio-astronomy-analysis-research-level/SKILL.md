# Radio Astronomy Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to radio-astronomy. This includes tasks such as:
- model phenomena
- measure distances
- analyze spectra
...
1. The user explicitly requests analysis in the context of radio-astronomy
