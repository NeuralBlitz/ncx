# Stochastic Mechatronics Analysis Skill

## Overview
This skill enables analysis in the domain of mechatronics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to mechatronics. This includes tasks such as:
- validate designs
...
1. The user explicitly requests analysis in the context of mechatronics
