# Semi Supervised Planetary Science Interpretation Skill

## Overview
This skill enables interpretation in the domain of planetary-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to planetary-science. This includes tasks such as:
- model processes
- map features
- model processes
...
1. The user explicitly requests interpretation in the context of planetary-science
