# Neutron Stars Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to neutron-stars. This includes tasks such as:
- model phenomena
- detect signals
- detect signals
...
1. The user explicitly requests optimization in the context of neutron-stars
