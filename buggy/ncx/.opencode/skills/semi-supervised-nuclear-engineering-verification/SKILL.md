# Semi Supervised Nuclear Engineering Verification Skill

## Overview
This skill enables verification in the domain of nuclear-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to nuclear-engineering. This includes tasks such as:
- validate designs
- optimize processes
- test prototypes
...
1. The user explicitly requests verification in the context of nuclear-engineering
