# Systems Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to systems-engineering. This includes tasks such as:
- test prototypes
- optimize processes
- analyze structures
...
1. The user explicitly requests characterization in the context of systems-engineering
...
4. The work involves systems-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of systems-engineering principles and methods
...
2. **Methodology**: Follow established systems-engineering protocols and best practices
...
- Adjacent systems-engineering skills for comprehensive analysis
...
7. Stay current with systems-engineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: systems-engineering
