# Marine Biology Verification Research Level Skill

## Overview
This skill enables verification in the domain of marine-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to marine-biology. This includes tasks such as:
- sequence DNA
- analyze proteins
- model populations
...
1. The user explicitly requests verification in the context of marine-biology
