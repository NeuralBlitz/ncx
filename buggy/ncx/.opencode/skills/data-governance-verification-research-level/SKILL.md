# Data Governance Verification Research Level Skill

## Overview
This skill enables verification in the domain of data-governance (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to data-governance. This includes tasks such as:
- extract features
- visualize data
- extract features
...
1. The user explicitly requests verification in the context of data-governance
