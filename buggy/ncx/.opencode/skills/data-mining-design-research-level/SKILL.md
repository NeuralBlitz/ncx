# Data Mining Design Research Level Skill

## Overview
This skill enables design in the domain of data-mining (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to data-mining. This includes tasks such as:
- build models
- analyze datasets
- predict outcomes
...
1. The user explicitly requests design in the context of data-mining
