# Manufacturing Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of manufacturing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to manufacturing. This includes tasks such as:
- analyze structures
- analyze structures
- analyze structures
...
1. The user explicitly requests estimation in the context of manufacturing
