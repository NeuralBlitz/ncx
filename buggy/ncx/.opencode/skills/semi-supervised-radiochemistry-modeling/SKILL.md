# Semi Supervised Radiochemistry Modeling Skill

## Overview
This skill enables modeling in the domain of radiochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to radiochemistry. This includes tasks such as:
- predict reactions
- optimize yields
- analyze spectra
...
1. The user explicitly requests modeling in the context of radiochemistry
