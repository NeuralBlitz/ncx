# Extragalactic Astronomy Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to extragalactic-astronomy. This includes tasks such as:
- observe objects
- calculate orbits
- observe objects
...
1. The user explicitly requests simulation in the context of extragalactic-astronomy
