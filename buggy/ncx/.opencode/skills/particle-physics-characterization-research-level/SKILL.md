# Particle Physics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of particle-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to particle-physics. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of particle-physics
...
4. The work involves particle-physics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of particle-physics principles and methods
...
2. **Methodology**: Follow established particle-physics protocols and best practices
...
- Adjacent particle-physics skills for comprehensive analysis
...
7. Stay current with particle-physics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: particle-physics
