# Environmental Science Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of environmental-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to environmental-science. This includes tasks such as:
- analyze samples
- predict events
- model processes
...
1. The user explicitly requests simulation in the context of environmental-science
