# Gravitational Waves Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to gravitational-waves. This includes tasks such as:
- measure distances
- calculate orbits
- calculate orbits
...
1. The user explicitly requests derivation in the context of gravitational-waves
