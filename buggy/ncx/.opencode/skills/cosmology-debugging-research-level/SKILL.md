# Cosmology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of cosmology (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to cosmology. This includes tasks such as:
- predict behavior
- model systems
- analyze motion
...
1. The user explicitly requests debugging in the context of cosmology
