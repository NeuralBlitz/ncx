# Computational Biology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of computational-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to computational-biology. This includes tasks such as:
- classify organisms
- model populations
- study interactions
...
1. The user explicitly requests characterization in the context of computational-biology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be phylogenetic trees
4. The work involves computational-biology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of computational-biology principles and methods
...
2. **Methodology**: Follow established computational-biology protocols and best practices
...
- Adjacent computational-biology skills for comprehensive analysis
...
7. Stay current with computational-biology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: computational-biology
