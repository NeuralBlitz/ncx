# Neutron Stars Classification Research Level Skill

## Overview
This skill enables classification in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to neutron-stars. This includes tasks such as:
- model phenomena
- calculate orbits
- observe objects
...
1. The user explicitly requests classification in the context of neutron-stars
