# Radio Astronomy Validation Research Level Skill

## Overview
This skill enables validation in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to radio-astronomy. This includes tasks such as:
- observe objects
- calculate orbits
- detect signals
...
1. The user explicitly requests validation in the context of radio-astronomy
