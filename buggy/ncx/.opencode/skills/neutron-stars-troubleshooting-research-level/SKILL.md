# Neutron Stars Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to neutron-stars. This includes tasks such as:
- measure distances
- measure distances
- observe objects
...
1. The user explicitly requests troubleshooting in the context of neutron-stars
