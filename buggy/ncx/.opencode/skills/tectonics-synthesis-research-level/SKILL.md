# Tectonics Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of tectonics (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to tectonics. This includes tasks such as:
- predict events
- interpret data
- model processes
...
1. The user explicitly requests synthesis in the context of tectonics
