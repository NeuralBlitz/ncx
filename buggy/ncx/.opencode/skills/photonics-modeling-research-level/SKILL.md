# Photonics Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of photonics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to photonics. This includes tasks such as:
- calculate forces
- calculate forces
- predict behavior
...
1. The user explicitly requests modeling in the context of photonics
