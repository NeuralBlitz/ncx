# Semi Supervised Microbiology Design Skill

## Overview
This skill enables design in the domain of microbiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to microbiology. This includes tasks such as:
- classify organisms
- analyze proteins
- classify organisms
...
1. The user explicitly requests design in the context of microbiology
