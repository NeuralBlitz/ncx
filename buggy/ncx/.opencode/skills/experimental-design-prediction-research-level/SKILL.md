# Experimental Design Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of experimental-design (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to experimental-design. This includes tasks such as:
- visualize data
- extract features
- build models
...
1. The user explicitly requests prediction in the context of experimental-design
