# Probability Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of probability (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to probability. This includes tasks such as:
- compute derivatives
- find eigenvalues
- analyze functions
...
1. The user explicitly requests implementation in the context of probability
