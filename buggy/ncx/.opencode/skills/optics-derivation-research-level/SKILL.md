# Optics Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to optics. This includes tasks such as:
- calculate forces
- analyze motion
- measure quantities
...
1. The user explicitly requests derivation in the context of optics
