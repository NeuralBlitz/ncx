# Semi Supervised Big Data Analysis Skill

## Overview
This skill enables analysis in the domain of big-data (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to big-data. This includes tasks such as:
- visualize data
- build models
- extract features
...
1. The user explicitly requests analysis in the context of big-data
