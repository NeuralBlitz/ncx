# Microbiology Testing Research Level Skill

## Overview
This skill enables testing in the domain of microbiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to microbiology. This includes tasks such as:
- measure expression
- model populations
- analyze proteins
...
1. The user explicitly requests testing in the context of microbiology
