# Seismology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of seismology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to seismology. This includes tasks such as:
- interpret data
- analyze samples
- model processes
...
1. The user explicitly requests characterization in the context of seismology
...
4. The work involves seismology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of seismology principles and methods
...
2. **Methodology**: Follow established seismology protocols and best practices
...
- Adjacent seismology skills for comprehensive analysis
...
7. Stay current with seismology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: seismology
