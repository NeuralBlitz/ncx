# Relativity Testing Research Level Skill

## Overview
This skill enables testing in the domain of relativity (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to relativity. This includes tasks such as:
- calculate forces
- predict behavior
- model systems
...
1. The user explicitly requests testing in the context of relativity
