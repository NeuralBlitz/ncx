# Volcanology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of volcanology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to volcanology. This includes tasks such as:
- analyze samples
- measure properties
- predict events
...
1. The user explicitly requests characterization in the context of volcanology
...
4. The work involves volcanology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of volcanology principles and methods
...
2. **Methodology**: Follow established volcanology protocols and best practices
...
- Adjacent volcanology skills for comprehensive analysis
...
7. Stay current with volcanology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: earth-sciences
- Subdiscipline: volcanology
