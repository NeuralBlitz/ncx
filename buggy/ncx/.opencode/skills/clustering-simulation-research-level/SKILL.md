# Clustering Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of clustering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to clustering. This includes tasks such as:
- extract features
- test hypotheses
- extract features
...
1. The user explicitly requests simulation in the context of clustering
