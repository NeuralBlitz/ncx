# Semi Supervised Astrophysics Debugging Skill

## Overview
This skill enables debugging in the domain of astrophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to astrophysics. This includes tasks such as:
- measure quantities
- predict behavior
- analyze motion
...
1. The user explicitly requests debugging in the context of astrophysics
