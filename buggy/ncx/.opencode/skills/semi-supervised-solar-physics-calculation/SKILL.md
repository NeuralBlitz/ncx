# Semi Supervised Solar Physics Calculation Skill

## Overview
This skill enables calculation in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to solar-physics. This includes tasks such as:
- calculate orbits
- detect signals
- detect signals
...
1. The user explicitly requests calculation in the context of solar-physics
