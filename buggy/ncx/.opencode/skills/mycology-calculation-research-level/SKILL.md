# Mycology Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of mycology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to mycology. This includes tasks such as:
- model populations
- measure expression
- measure expression
...
1. The user explicitly requests calculation in the context of mycology
