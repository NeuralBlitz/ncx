# Plasma Physics Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of plasma-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to plasma-physics. This includes tasks such as:
- analyze motion
...
1. The user explicitly requests modeling in the context of plasma-physics
