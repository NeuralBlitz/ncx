# Systems Engineering Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to systems-engineering. This includes tasks such as:
- optimize processes
- validate designs
- analyze structures
...
1. The user explicitly requests calculation in the context of systems-engineering
