# Cryptography Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of cryptography (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to cryptography. This includes tasks such as:
- solve equations
- solve equations
- calculate integrals
...
1. The user explicitly requests derivation in the context of cryptography
