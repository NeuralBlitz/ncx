# Immunology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of immunology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to immunology. This includes tasks such as:
- study interactions
- analyze proteins
- classify organisms
...
1. The user explicitly requests characterization in the context of immunology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be biological insights
4. The work involves immunology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of immunology principles and methods
...
2. **Methodology**: Follow established immunology protocols and best practices
...
- Adjacent immunology skills for comprehensive analysis
...
7. Stay current with immunology literature and methods
