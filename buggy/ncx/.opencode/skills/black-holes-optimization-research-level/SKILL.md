# Black Holes Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of black-holes (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to black-holes. This includes tasks such as:
- detect signals
- calculate orbits
- model phenomena
...
1. The user explicitly requests optimization in the context of black-holes
