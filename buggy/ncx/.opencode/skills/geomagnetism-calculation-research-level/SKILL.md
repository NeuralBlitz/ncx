# Geomagnetism Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to geomagnetism. This includes tasks such as:
- predict events
- analyze samples
- interpret data
...
1. The user explicitly requests calculation in the context of geomagnetism
