# Statistics Design Research Level Skill

## Overview
This skill enables design in the domain of statistics (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to statistics. This includes tasks such as:
- analyze functions
- calculate integrals
- solve equations
...
1. The user explicitly requests design in the context of statistics
