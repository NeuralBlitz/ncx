# Systems Biology Verification Research Level Skill

## Overview
This skill enables verification in the domain of systems-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to systems-biology. This includes tasks such as:
- analyze proteins
- classify organisms
- study interactions
...
1. The user explicitly requests verification in the context of systems-biology
