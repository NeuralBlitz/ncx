# Optics Testing Research Level Skill

## Overview
This skill enables testing in the domain of optics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to optics. This includes tasks such as:
- calculate forces
- calculate forces
- measure quantities
...
1. The user explicitly requests testing in the context of optics
