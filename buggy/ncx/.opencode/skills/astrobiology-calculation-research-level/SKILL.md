# Astrobiology Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of astrobiology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to astrobiology. This includes tasks such as:
- observe objects
- model phenomena
- detect signals
...
1. The user explicitly requests calculation in the context of astrobiology
