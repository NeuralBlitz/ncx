# Optimization Design Research Level Skill

## Overview
This skill enables design in the domain of optimization (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to optimization. This includes tasks such as:
- prove theorems
- analyze functions
- prove theorems
...
1. The user explicitly requests design in the context of optimization
