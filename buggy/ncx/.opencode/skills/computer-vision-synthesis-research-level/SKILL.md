# Computer Vision Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of computer-vision (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to computer-vision. This includes tasks such as:
- train models
- train models
- debug programs
...
1. The user explicitly requests synthesis in the context of computer-vision
