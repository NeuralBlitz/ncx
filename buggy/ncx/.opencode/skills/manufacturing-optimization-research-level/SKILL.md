# Manufacturing Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of manufacturing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to manufacturing. This includes tasks such as:
- validate designs
- test prototypes
- test prototypes
...
1. The user explicitly requests optimization in the context of manufacturing
