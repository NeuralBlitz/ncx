# Inorganic Chemistry Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of inorganic-chemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to inorganic-chemistry. This includes tasks such as:
- predict reactions
- predict reactions
...
1. The user explicitly requests derivation in the context of inorganic-chemistry
