# Data Visualization Design Research Level Skill

## Overview
This skill enables design in the domain of data-visualization (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to data-visualization. This includes tasks such as:
- build models
- predict outcomes
- build models
...
1. The user explicitly requests design in the context of data-visualization
