# Discrete Math Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to discrete-math. This includes tasks such as:
- analyze functions
- solve equations
- prove theorems
...
1. The user explicitly requests simulation in the context of discrete-math
