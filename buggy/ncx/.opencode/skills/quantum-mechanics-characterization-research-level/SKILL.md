# Quantum Mechanics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of quantum-mechanics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to quantum-mechanics. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of quantum-mechanics
...
4. The work involves quantum-mechanics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of quantum-mechanics principles and methods
...
2. **Methodology**: Follow established quantum-mechanics protocols and best practices
...
- Adjacent quantum-mechanics skills for comprehensive analysis
...
7. Stay current with quantum-mechanics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: physics
- Subdiscipline: quantum-mechanics
