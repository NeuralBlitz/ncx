# Semi Supervised Petrology Interpretation Skill

## Overview
This skill enables interpretation in the domain of petrology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to petrology. This includes tasks such as:
- analyze samples
- model processes
- interpret data
...
1. The user explicitly requests interpretation in the context of petrology
