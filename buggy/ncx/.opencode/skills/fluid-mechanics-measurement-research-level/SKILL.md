# Fluid Mechanics Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of fluid-mechanics (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to fluid-mechanics. This includes tasks such as:
- validate designs
...
1. The user explicitly requests measurement in the context of fluid-mechanics
