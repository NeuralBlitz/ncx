# Cartography Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of cartography (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to cartography. This includes tasks such as:
- interpret data
- interpret data
- predict events
...
1. The user explicitly requests estimation in the context of cartography
