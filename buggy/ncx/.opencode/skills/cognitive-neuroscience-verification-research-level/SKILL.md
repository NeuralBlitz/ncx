# Cognitive Neuroscience Verification Research Level Skill

## Overview
This skill enables verification in the domain of cognitive-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to cognitive-neuroscience. This includes tasks such as:
- measure responses
...
1. The user explicitly requests verification in the context of cognitive-neuroscience
