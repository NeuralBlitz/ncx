# Materials Engineering Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of materials-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to materials-engineering. This includes tasks such as:
- design components
- test prototypes
- validate designs
...
1. The user explicitly requests troubleshooting in the context of materials-engineering
