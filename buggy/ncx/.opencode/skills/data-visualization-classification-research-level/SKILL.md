# Data Visualization Classification Research Level Skill

## Overview
This skill enables classification in the domain of data-visualization (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to data-visualization. This includes tasks such as:
- analyze datasets
- predict outcomes
- build models
...
1. The user explicitly requests classification in the context of data-visualization
