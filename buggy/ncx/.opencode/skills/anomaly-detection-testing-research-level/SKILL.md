# Anomaly Detection Testing Research Level Skill

## Overview
This skill enables testing in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.
