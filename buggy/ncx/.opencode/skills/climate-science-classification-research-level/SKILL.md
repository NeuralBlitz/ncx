# Climate Science Classification Research Level Skill

## Overview
This skill enables classification in the domain of climate-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to climate-science. This includes tasks such as:
- predict events
- model processes
- measure properties
...
1. The user explicitly requests classification in the context of climate-science
