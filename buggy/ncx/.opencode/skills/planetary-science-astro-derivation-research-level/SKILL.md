# Planetary Science Astro Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to planetary-science-astro. This includes tasks such as:
- model phenomena
- observe objects
- detect signals
...
1. The user explicitly requests derivation in the context of planetary-science-astro
