# Parasitology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of parasitology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to parasitology. This includes tasks such as:
- study interactions
- sequence DNA
- model populations
...
1. The user explicitly requests characterization in the context of parasitology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be phylogenetic trees
4. The work involves parasitology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of parasitology principles and methods
...
2. **Methodology**: Follow established parasitology protocols and best practices
...
- Adjacent parasitology skills for comprehensive analysis
...
7. Stay current with parasitology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: parasitology
