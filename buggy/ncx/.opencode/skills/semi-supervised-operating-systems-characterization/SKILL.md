# Semi Supervised Operating Systems Characterization Skill

## Overview
This skill enables characterization in the domain of operating-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to operating-systems. This includes tasks such as:
- train models
- optimize code
- optimize code
...
1. The user explicitly requests characterization in the context of operating-systems
...
4. The work involves operating-systems methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of operating-systems principles and methods
...
2. **Methodology**: Follow established operating-systems protocols and best practices
...
- Adjacent operating-systems skills for comprehensive analysis
...
7. Stay current with operating-systems literature and methods

## Version Information
- Complexity Level: research-level
- Domain: computer-science
- Subdiscipline: operating-systems
