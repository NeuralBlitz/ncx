# Neuroengineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of neuroengineering (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to neuroengineering. This includes tasks such as:
- map connections
- map connections
- study behavior
...
1. The user explicitly requests characterization in the context of neuroengineering
2. The task requires research-level-level understanding of neuroscience principles
3. The output needs to be neural data
4. The work involves neuroengineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of neuroengineering principles and methods
...
2. **Methodology**: Follow established neuroengineering protocols and best practices
...
- Adjacent neuroengineering skills for comprehensive analysis
...
7. Stay current with neuroengineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: neuroscience
- Subdiscipline: neuroengineering
