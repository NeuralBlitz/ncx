# Civil Engineering Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of civil-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to civil-engineering. This includes tasks such as:
- design components
- analyze structures
- design components
...
1. The user explicitly requests estimation in the context of civil-engineering
