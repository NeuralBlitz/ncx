# Galactic Astronomy Troubleshooting Research Level Skill

## Overview
This skill enables troubleshooting in the domain of galactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to galactic-astronomy. This includes tasks such as:
- calculate orbits
- analyze spectra
- observe objects
...
1. The user explicitly requests troubleshooting in the context of galactic-astronomy
