# Number Theory Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to number-theory. This includes tasks such as:
- compute derivatives
- find eigenvalues
- prove theorems
...
1. The user explicitly requests estimation in the context of number-theory
