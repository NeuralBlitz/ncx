# Environmental Science Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of environmental-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to environmental-science. This includes tasks such as:
- measure properties
- analyze samples
- predict events
...
1. The user explicitly requests synthesis in the context of environmental-science
