# Radio Astronomy Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of radio-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to radio-astronomy. This includes tasks such as:
- observe objects
- model phenomena
- model phenomena
...
1. The user explicitly requests derivation in the context of radio-astronomy
