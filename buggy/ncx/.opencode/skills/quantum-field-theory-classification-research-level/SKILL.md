# Quantum Field Theory Classification Research Level Skill

## Overview
This skill enables classification in the domain of quantum-field-theory (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to quantum-field-theory. This includes tasks such as:
- calculate forces
- predict behavior
- predict behavior
...
1. The user explicitly requests classification in the context of quantum-field-theory
