# Computer Vision Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of computer-vision (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to computer-vision. This includes tasks such as:
- design systems
- debug programs
- analyze complexity
...
1. The user explicitly requests characterization in the context of computer-vision
...
4. The work involves computer-vision methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of computer-vision principles and methods
...
2. **Methodology**: Follow established computer-vision protocols and best practices
...
- Adjacent computer-vision skills for comprehensive analysis
...
7. Stay current with computer-vision literature and methods
