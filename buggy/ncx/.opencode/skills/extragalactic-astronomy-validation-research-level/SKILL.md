# Extragalactic Astronomy Validation Research Level Skill

## Overview
This skill enables validation in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to extragalactic-astronomy. This includes tasks such as:
- calculate orbits
- calculate orbits
- observe objects
...
1. The user explicitly requests validation in the context of extragalactic-astronomy
