# Causal Inference Testing Research Level Skill

## Overview
This skill enables testing in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to causal-inference. This includes tasks such as:
- extract features
- test hypotheses
- test hypotheses
...
1. The user explicitly requests testing in the context of causal-inference
