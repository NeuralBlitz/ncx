# Systems Neuroscience Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of systems-neuroscience (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to systems-neuroscience. This includes tasks such as:
...
1. The user explicitly requests debugging in the context of systems-neuroscience
