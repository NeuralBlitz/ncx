# Quantum Computing Design Research Level Skill

## Overview
This skill enables design in the domain of quantum-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to quantum-computing. This includes tasks such as:
- analyze complexity
- optimize code
...
1. The user explicitly requests design in the context of quantum-computing
