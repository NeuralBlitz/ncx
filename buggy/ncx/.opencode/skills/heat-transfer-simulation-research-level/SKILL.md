# Heat Transfer Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of heat-transfer (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to heat-transfer. This includes tasks such as:
- validate designs
- optimize processes
- test prototypes
...
1. The user explicitly requests simulation in the context of heat-transfer
