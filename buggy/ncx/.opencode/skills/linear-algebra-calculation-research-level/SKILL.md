# Linear Algebra Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to linear-algebra. This includes tasks such as:
- calculate integrals
- find eigenvalues
- find eigenvalues
...
1. The user explicitly requests calculation in the context of linear-algebra
