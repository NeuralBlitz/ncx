# Semi Supervised Hydrology Debugging Skill

## Overview
This skill enables debugging in the domain of hydrology (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to hydrology. This includes tasks such as:
- map features
- predict events
- map features
...
1. The user explicitly requests debugging in the context of hydrology
