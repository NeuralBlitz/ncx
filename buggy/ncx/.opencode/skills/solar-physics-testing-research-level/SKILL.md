# Solar Physics Testing Research Level Skill

## Overview
This skill enables testing in the domain of solar-physics (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to solar-physics. This includes tasks such as:
- detect signals
- measure distances
- analyze spectra
...
1. The user explicitly requests testing in the context of solar-physics
