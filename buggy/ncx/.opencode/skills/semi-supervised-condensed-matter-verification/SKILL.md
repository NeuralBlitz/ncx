# Semi Supervised Condensed Matter Verification Skill

## Overview
This skill enables verification in the domain of condensed-matter (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to condensed-matter. This includes tasks such as:
- predict behavior
...
1. The user explicitly requests verification in the context of condensed-matter
