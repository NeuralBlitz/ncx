# Cloud Computing Classification Research Level Skill

## Overview
This skill enables classification in the domain of cloud-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to cloud-computing. This includes tasks such as:
- design systems
- optimize code
- optimize code
...
1. The user explicitly requests classification in the context of cloud-computing
