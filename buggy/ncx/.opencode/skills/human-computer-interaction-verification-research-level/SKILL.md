# Human Computer Interaction Verification Research Level Skill

## Overview
This skill enables verification in the domain of human-computer-interaction (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to human-computer-interaction. This includes tasks such as:
- debug programs
- analyze complexity
...
1. The user explicitly requests verification in the context of human-computer-interaction
