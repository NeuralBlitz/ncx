# Systems Engineering Classification Research Level Skill

## Overview
This skill enables classification in the domain of systems-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to systems-engineering. This includes tasks such as:
- optimize processes
- validate designs
- design components
...
1. The user explicitly requests classification in the context of systems-engineering
