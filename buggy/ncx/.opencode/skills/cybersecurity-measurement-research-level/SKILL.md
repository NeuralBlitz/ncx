# Cybersecurity Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of cybersecurity (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to cybersecurity. This includes tasks such as:
- debug programs
- optimize code
- analyze complexity
...
1. The user explicitly requests measurement in the context of cybersecurity
