# Fluid Dynamics Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of fluid-dynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to fluid-dynamics. This includes tasks such as:
- predict behavior
...
1. The user explicitly requests analysis in the context of fluid-dynamics
