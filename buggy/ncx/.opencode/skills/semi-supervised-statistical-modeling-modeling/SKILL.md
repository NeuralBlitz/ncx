# Semi Supervised Statistical Modeling Modeling Skill

## Overview
This skill enables modeling in the domain of statistical-modeling (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to statistical-modeling. This includes tasks such as:
- build models
- build models
- predict outcomes
...
1. The user explicitly requests modeling in the context of statistical-modeling
