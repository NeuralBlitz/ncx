# Photonics Engineering Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of photonics-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to photonics-engineering. This includes tasks such as:
- design components
- analyze structures
- validate designs
...
1. The user explicitly requests simulation in the context of photonics-engineering
