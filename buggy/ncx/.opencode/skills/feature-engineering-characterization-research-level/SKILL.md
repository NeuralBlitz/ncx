# Feature Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to feature-engineering. This includes tasks such as:
- analyze datasets
- predict outcomes
- analyze datasets
...
1. The user explicitly requests characterization in the context of feature-engineering
...
4. The work involves feature-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of feature-engineering principles and methods
...
2. **Methodology**: Follow established feature-engineering protocols and best practices
...
- Adjacent feature-engineering skills for comprehensive analysis
...
7. Stay current with feature-engineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: feature-engineering
