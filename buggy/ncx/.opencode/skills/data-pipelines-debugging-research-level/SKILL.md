# Data Pipelines Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to data-pipelines. This includes tasks such as:
- visualize data
- predict outcomes
- build models
...
1. The user explicitly requests debugging in the context of data-pipelines
