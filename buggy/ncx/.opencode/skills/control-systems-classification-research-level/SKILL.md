# Control Systems Classification Research Level Skill

## Overview
This skill enables classification in the domain of control-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to control-systems. This includes tasks such as:
- test prototypes
- validate designs
...
1. The user explicitly requests classification in the context of control-systems
