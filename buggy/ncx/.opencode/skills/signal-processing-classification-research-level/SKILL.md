# Signal Processing Classification Research Level Skill

## Overview
This skill enables classification in the domain of signal-processing (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to signal-processing. This includes tasks such as:
- test prototypes
- validate designs
- validate designs
...
1. The user explicitly requests classification in the context of signal-processing
