# Condensed Matter Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of condensed-matter (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to condensed-matter. This includes tasks such as:
- model systems
- calculate forces
- predict behavior
...
1. The user explicitly requests simulation in the context of condensed-matter
