# Geomagnetism Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of geomagnetism (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to geomagnetism. This includes tasks such as:
- model processes
- predict events
- interpret data
...
1. The user explicitly requests estimation in the context of geomagnetism
