# Neuroimaging Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of neuroimaging (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to neuroimaging. This includes tasks such as:
...
1. The user explicitly requests simulation in the context of neuroimaging
