# Stellar Astronomy Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to stellar-astronomy. This includes tasks such as:
- measure distances
- measure distances
- detect signals
...
1. The user explicitly requests optimization in the context of stellar-astronomy
