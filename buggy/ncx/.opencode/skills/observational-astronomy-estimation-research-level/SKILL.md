# Observational Astronomy Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of observational-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to observational-astronomy. This includes tasks such as:
- measure distances
- observe objects
- observe objects
...
1. The user explicitly requests estimation in the context of observational-astronomy
