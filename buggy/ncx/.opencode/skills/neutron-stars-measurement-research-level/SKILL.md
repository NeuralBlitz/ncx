# Neutron Stars Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of neutron-stars (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to neutron-stars. This includes tasks such as:
- calculate orbits
- calculate orbits
- analyze spectra
...
1. The user explicitly requests measurement in the context of neutron-stars
