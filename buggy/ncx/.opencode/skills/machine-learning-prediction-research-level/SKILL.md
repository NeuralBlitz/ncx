# Machine Learning Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of machine-learning (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to machine-learning. This includes tasks such as:
- train models
- debug programs
- debug programs
...
1. The user explicitly requests prediction in the context of machine-learning
