# Databases Verification Research Level Skill

## Overview
This skill enables verification in the domain of databases (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to databases. This includes tasks such as:
- optimize code
- optimize code
- train models
...
1. The user explicitly requests verification in the context of databases
