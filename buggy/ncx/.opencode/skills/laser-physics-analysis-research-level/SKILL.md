# Laser Physics Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of laser-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to laser-physics. This includes tasks such as:
- predict behavior
- analyze motion
- calculate forces
...
1. The user explicitly requests analysis in the context of laser-physics
