# Glaciology Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to glaciology. This includes tasks such as:
- analyze samples
- analyze samples
- analyze samples
...
1. The user explicitly requests debugging in the context of glaciology
