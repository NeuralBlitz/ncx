# Causal Inference Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to causal-inference. This includes tasks such as:
- predict outcomes
- visualize data
- predict outcomes
...
1. The user explicitly requests simulation in the context of causal-inference
