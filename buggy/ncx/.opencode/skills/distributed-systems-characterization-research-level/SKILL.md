# Distributed Systems Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of distributed-systems (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to distributed-systems. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of distributed-systems
...
4. The work involves distributed-systems methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of distributed-systems principles and methods
...
2. **Methodology**: Follow established distributed-systems protocols and best practices
...
- Adjacent distributed-systems skills for comprehensive analysis
...
7. Stay current with distributed-systems literature and methods
