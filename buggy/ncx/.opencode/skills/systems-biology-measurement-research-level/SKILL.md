# Systems Biology Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of systems-biology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to systems-biology. This includes tasks such as:
- measure expression
- model populations
- study interactions
...
1. The user explicitly requests measurement in the context of systems-biology
