# Epidemiology Validation Research Level Skill

## Overview
This skill enables validation in the domain of epidemiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to epidemiology. This includes tasks such as:
- measure expression
- study interactions
- model populations
...
1. The user explicitly requests validation in the context of epidemiology
