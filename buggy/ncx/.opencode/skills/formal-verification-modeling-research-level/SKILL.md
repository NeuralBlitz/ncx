# Formal Verification Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of formal-verification (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to formal-verification. This includes tasks such as:
- train models
- optimize code
- analyze complexity
...
1. The user explicitly requests modeling in the context of formal-verification
