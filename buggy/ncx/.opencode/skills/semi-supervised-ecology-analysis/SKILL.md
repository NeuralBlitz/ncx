# Semi Supervised Ecology Analysis Skill

## Overview
This skill enables analysis in the domain of ecology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to ecology. This includes tasks such as:
- study interactions
- analyze proteins
- model populations
...
1. The user explicitly requests analysis in the context of ecology
