# Glaciology Validation Research Level Skill

## Overview
This skill enables validation in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to glaciology. This includes tasks such as:
- predict events
- model processes
- predict events
...
1. The user explicitly requests validation in the context of glaciology
