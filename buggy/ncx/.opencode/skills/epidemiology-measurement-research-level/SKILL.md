# Epidemiology Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of epidemiology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to epidemiology. This includes tasks such as:
- study interactions
- measure expression
- sequence DNA
...
1. The user explicitly requests measurement in the context of epidemiology
