# Semi Supervised Fluid Dynamics Calculation Skill

## Overview
This skill enables calculation in the domain of fluid-dynamics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to fluid-dynamics. This includes tasks such as:
- analyze motion
- measure quantities
- model systems
...
1. The user explicitly requests calculation in the context of fluid-dynamics
