# Glaciology Verification Research Level Skill

## Overview
This skill enables verification in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to glaciology. This includes tasks such as:
- measure properties
- map features
- map features
...
1. The user explicitly requests verification in the context of glaciology
