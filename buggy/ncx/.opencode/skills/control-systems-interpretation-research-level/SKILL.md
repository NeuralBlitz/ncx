# Control Systems Interpretation Research Level Skill

## Overview
This skill enables interpretation in the domain of control-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to control-systems. This includes tasks such as:
- design components
- design components
- validate designs
...
1. The user explicitly requests interpretation in the context of control-systems
