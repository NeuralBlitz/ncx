# Spatial Cloud Computing Design Skill

## Overview
This skill enables design in the domain of cloud-computing (computer-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
