# Environmental Engineering Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of environmental-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to environmental-engineering. This includes tasks such as:
- optimize processes
- analyze structures
- optimize processes
...
1. The user explicitly requests simulation in the context of environmental-engineering
