# Linear Algebra Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of linear-algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to linear-algebra. This includes tasks such as:
- solve equations
- analyze functions
- compute derivatives
...
1. The user explicitly requests debugging in the context of linear-algebra
