# Discrete Math Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to discrete-math. This includes tasks such as:
- solve equations
- prove theorems
- compute derivatives
...
1. The user explicitly requests modeling in the context of discrete-math
