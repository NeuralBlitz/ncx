# Environmental Science Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of environmental-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to environmental-science. This includes tasks such as:
- model processes
- interpret data
- analyze samples
...
1. The user explicitly requests characterization in the context of environmental-science
