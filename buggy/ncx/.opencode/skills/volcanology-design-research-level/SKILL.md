# Volcanology Design Research Level Skill

## Overview
This skill enables design in the domain of volcanology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to volcanology. This includes tasks such as:
- analyze samples
- analyze samples
- map features
...
1. The user explicitly requests design in the context of volcanology
