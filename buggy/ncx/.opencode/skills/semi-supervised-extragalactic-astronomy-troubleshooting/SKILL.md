# Semi Supervised Extragalactic Astronomy Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to extragalactic-astronomy. This includes tasks such as:
- detect signals
- calculate orbits
- analyze spectra
...
1. The user explicitly requests troubleshooting in the context of extragalactic-astronomy
