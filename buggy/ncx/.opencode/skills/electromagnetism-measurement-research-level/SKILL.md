# Electromagnetism Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of electromagnetism (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to electromagnetism. This includes tasks such as:
- predict behavior
- predict behavior
- analyze motion
...
1. The user explicitly requests measurement in the context of electromagnetism
