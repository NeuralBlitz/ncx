# Cryptography Testing Research Level Skill

## Overview
This skill enables testing in the domain of cryptography (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to cryptography. This includes tasks such as:
- prove theorems
- solve equations
- compute derivatives
...
1. The user explicitly requests testing in the context of cryptography
