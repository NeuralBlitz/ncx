# Discrete Math Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of discrete-math (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to discrete-math. This includes tasks such as:
- calculate integrals
- compute derivatives
- find eigenvalues
...
1. The user explicitly requests analysis in the context of discrete-math
