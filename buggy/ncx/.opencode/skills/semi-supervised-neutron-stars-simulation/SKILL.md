# Semi Supervised Neutron Stars Simulation Skill

## Overview
This skill enables simulation in the domain of neutron-stars (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to neutron-stars. This includes tasks such as:
- detect signals
- model phenomena
- detect signals
...
1. The user explicitly requests simulation in the context of neutron-stars
