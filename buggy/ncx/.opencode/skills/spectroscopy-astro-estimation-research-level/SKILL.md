# Spectroscopy Astro Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of spectroscopy-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to spectroscopy-astro. This includes tasks such as:
- detect signals
- calculate orbits
- analyze spectra
...
1. The user explicitly requests estimation in the context of spectroscopy-astro
