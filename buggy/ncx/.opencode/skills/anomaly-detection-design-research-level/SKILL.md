# Anomaly Detection Design Research Level Skill

## Overview
This skill enables design in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to anomaly-detection. This includes tasks such as:
- test hypotheses
- extract features
- analyze datasets
...
1. The user explicitly requests design in the context of anomaly-detection
