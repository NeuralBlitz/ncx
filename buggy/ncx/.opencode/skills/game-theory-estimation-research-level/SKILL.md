# Game Theory Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of game-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to game-theory. This includes tasks such as:
- prove theorems
- compute derivatives
- calculate integrals
...
1. The user explicitly requests estimation in the context of game-theory
