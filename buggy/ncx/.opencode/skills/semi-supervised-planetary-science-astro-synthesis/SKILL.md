# Semi Supervised Planetary Science Astro Synthesis Skill

## Overview
This skill enables synthesis in the domain of planetary-science-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to planetary-science-astro. This includes tasks such as:
- calculate orbits
- observe objects
- measure distances
...
1. The user explicitly requests synthesis in the context of planetary-science-astro
