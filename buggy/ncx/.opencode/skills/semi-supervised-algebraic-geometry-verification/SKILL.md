# Semi Supervised Algebraic Geometry Verification Skill

## Overview
This skill enables verification in the domain of algebraic-geometry (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to algebraic-geometry. This includes tasks such as:
- analyze functions
- calculate integrals
- calculate integrals
...
1. The user explicitly requests verification in the context of algebraic-geometry
