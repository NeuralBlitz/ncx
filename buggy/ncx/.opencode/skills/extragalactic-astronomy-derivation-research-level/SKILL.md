# Extragalactic Astronomy Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of extragalactic-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to extragalactic-astronomy. This includes tasks such as:
- model phenomena
- calculate orbits
- detect signals
...
1. The user explicitly requests derivation in the context of extragalactic-astronomy
