# Mycology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of mycology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to mycology. This includes tasks such as:
- measure expression
- analyze proteins
- study interactions
...
1. The user explicitly requests characterization in the context of mycology
2. The task requires research-level-level understanding of biology principles
3. The output needs to be biological insights
4. The work involves mycology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of mycology principles and methods
...
2. **Methodology**: Follow established mycology protocols and best practices
...
- Adjacent mycology skills for comprehensive analysis
...
7. Stay current with mycology literature and methods

## Version Information
- Complexity Level: research-level
- Domain: biology
- Subdiscipline: mycology
