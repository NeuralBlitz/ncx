# Feature Engineering Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of feature-engineering (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to feature-engineering. This includes tasks such as:
- extract features
- predict outcomes
- predict outcomes
...
1. The user explicitly requests optimization in the context of feature-engineering
