# Meteorology Design Research Level Skill

## Overview
This skill enables design in the domain of meteorology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to meteorology. This includes tasks such as:
- map features
- interpret data
- measure properties
...
1. The user explicitly requests design in the context of meteorology
