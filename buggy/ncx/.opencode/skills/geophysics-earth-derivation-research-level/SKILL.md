# Geophysics Earth Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to geophysics-earth. This includes tasks such as:
- model processes
- analyze samples
- interpret data
...
1. The user explicitly requests derivation in the context of geophysics-earth
