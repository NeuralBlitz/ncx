# Predictive Analytics Classification Research Level Skill

## Overview
This skill enables classification in the domain of predictive-analytics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to predictive-analytics. This includes tasks such as:
- build models
- visualize data
- analyze datasets
...
1. The user explicitly requests classification in the context of predictive-analytics
