# Number Theory Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of number-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to number-theory. This includes tasks such as:
- solve equations
- calculate integrals
- compute derivatives
...
1. The user explicitly requests prediction in the context of number-theory
