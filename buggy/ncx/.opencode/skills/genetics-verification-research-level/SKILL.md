# Genetics Verification Research Level Skill

## Overview
This skill enables verification in the domain of genetics (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to genetics. This includes tasks such as:
- analyze proteins
- study interactions
- measure expression
...
1. The user explicitly requests verification in the context of genetics
