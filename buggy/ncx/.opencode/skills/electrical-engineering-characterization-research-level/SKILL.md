# Electrical Engineering Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of electrical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to electrical-engineering. This includes tasks such as:
- optimize processes
- analyze structures
- test prototypes
...
1. The user explicitly requests characterization in the context of electrical-engineering
...
4. The work involves electrical-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of electrical-engineering principles and methods
...
2. **Methodology**: Follow established electrical-engineering protocols and best practices
...
- Adjacent electrical-engineering skills for comprehensive analysis
...
7. Stay current with electrical-engineering literature and methods

## Version Information
- Complexity Level: research-level
- Domain: engineering
- Subdiscipline: electrical-engineering
