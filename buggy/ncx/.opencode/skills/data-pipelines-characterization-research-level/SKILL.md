# Data Pipelines Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of data-pipelines (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to data-pipelines. This includes tasks such as:
- build models
- extract features
- visualize data
...
1. The user explicitly requests characterization in the context of data-pipelines
...
4. The work involves data-pipelines methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of data-pipelines principles and methods
...
2. **Methodology**: Follow established data-pipelines protocols and best practices
...
- Adjacent data-pipelines skills for comprehensive analysis
...
7. Stay current with data-pipelines literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: data-pipelines
