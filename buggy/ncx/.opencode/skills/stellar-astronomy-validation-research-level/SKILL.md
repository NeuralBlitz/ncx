# Stellar Astronomy Validation Research Level Skill

## Overview
This skill enables validation in the domain of stellar-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to stellar-astronomy. This includes tasks such as:
- calculate orbits
- analyze spectra
- model phenomena
...
1. The user explicitly requests validation in the context of stellar-astronomy
