# Cosmology Astro Design Research Level Skill

## Overview
This skill enables design in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to cosmology-astro. This includes tasks such as:
- measure distances
- analyze spectra
- observe objects
...
1. The user explicitly requests design in the context of cosmology-astro
