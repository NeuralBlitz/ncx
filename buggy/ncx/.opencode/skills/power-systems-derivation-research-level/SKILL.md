# Power Systems Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of power-systems (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to power-systems. This includes tasks such as:
- optimize processes
- optimize processes
- analyze structures
...
1. The user explicitly requests derivation in the context of power-systems
