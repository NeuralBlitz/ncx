# Cosmology Astro Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of cosmology-astro (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to cosmology-astro. This includes tasks such as:
- model phenomena
- observe objects
- analyze spectra
...
1. The user explicitly requests debugging in the context of cosmology-astro
