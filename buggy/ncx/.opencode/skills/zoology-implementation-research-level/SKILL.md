# Zoology Implementation Research Level Skill

## Overview
This skill enables implementation in the domain of zoology (biology). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to zoology. This includes tasks such as:
- sequence DNA
- analyze proteins
- classify organisms
...
1. The user explicitly requests implementation in the context of zoology
