# Semi Supervised Astrometry Prediction Skill

## Overview
This skill enables prediction in the domain of astrometry (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to astrometry. This includes tasks such as:
- analyze spectra
- model phenomena
- calculate orbits
...
1. The user explicitly requests prediction in the context of astrometry
