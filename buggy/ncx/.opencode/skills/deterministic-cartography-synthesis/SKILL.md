# Deterministic Cartography Synthesis Skill

## Overview
This skill enables synthesis in the domain of cartography (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
