# Causal Inference Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to causal-inference. This includes tasks such as:
- build models
- test hypotheses
- analyze datasets
...
1. The user explicitly requests prediction in the context of causal-inference
