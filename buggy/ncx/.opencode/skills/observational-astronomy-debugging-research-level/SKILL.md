# Observational Astronomy Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of observational-astronomy (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to observational-astronomy. This includes tasks such as:
- calculate orbits
- calculate orbits
- calculate orbits
...
1. The user explicitly requests debugging in the context of observational-astronomy
