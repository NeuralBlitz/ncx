# Electromagnetism Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of electromagnetism (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to electromagnetism. This includes tasks such as:
- analyze motion
- analyze motion
- predict behavior
...
1. The user explicitly requests debugging in the context of electromagnetism
