# Theoretical Exoplanet Science Design Skill

## Overview
This skill enables design in the domain of exoplanet-science (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.
