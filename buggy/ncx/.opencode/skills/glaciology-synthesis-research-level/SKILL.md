# Glaciology Synthesis Research Level Skill

## Overview
This skill enables synthesis in the domain of glaciology (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to glaciology. This includes tasks such as:
- predict events
- model processes
- interpret data
...
1. The user explicitly requests synthesis in the context of glaciology
