# Connectomics Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of connectomics (neuroscience). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to connectomics. This includes tasks such as:
- measure responses
...
1. The user explicitly requests characterization in the context of connectomics
...
4. The work involves connectomics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of connectomics principles and methods
...
2. **Methodology**: Follow established connectomics protocols and best practices
...
- Adjacent connectomics skills for comprehensive analysis
...
7. Stay current with connectomics literature and methods

## Version Information
- Complexity Level: research-level
- Domain: neuroscience
- Subdiscipline: connectomics
