# Gravitational Waves Validation Research Level Skill

## Overview
This skill enables validation in the domain of gravitational-waves (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to gravitational-waves. This includes tasks such as:
- analyze spectra
- model phenomena
- measure distances
...
1. The user explicitly requests validation in the context of gravitational-waves
