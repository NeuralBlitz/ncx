# Helioseismology Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to helioseismology. This includes tasks such as:
- detect signals
- calculate orbits
- detect signals
...
1. The user explicitly requests simulation in the context of helioseismology
