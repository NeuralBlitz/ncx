# Helioseismology Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of helioseismology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to helioseismology. This includes tasks such as:
- model phenomena
- model phenomena
- model phenomena
...
1. The user explicitly requests characterization in the context of helioseismology
