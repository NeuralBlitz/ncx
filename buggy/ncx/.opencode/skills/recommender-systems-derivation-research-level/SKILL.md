# Recommender Systems Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of recommender-systems (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to recommender-systems. This includes tasks such as:
- build models
- predict outcomes
- predict outcomes
...
1. The user explicitly requests derivation in the context of recommender-systems
