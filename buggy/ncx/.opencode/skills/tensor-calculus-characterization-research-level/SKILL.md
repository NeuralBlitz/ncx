# Tensor Calculus Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of tensor-calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to tensor-calculus. This includes tasks such as:
- compute derivatives
- solve equations
- find eigenvalues
...
1. The user explicitly requests characterization in the context of tensor-calculus
