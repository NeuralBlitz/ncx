# Atmospheric Science Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of atmospheric-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to atmospheric-science. This includes tasks such as:
- model processes
- model processes
- map features
...
1. The user explicitly requests measurement in the context of atmospheric-science
