# Natural Language Processing Analysis Research Level Skill

## Overview
This skill enables analysis in the domain of natural-language-processing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to natural-language-processing. This includes tasks such as:
- optimize code
- design systems
- analyze complexity
...
1. The user explicitly requests analysis in the context of natural-language-processing
