# Data Governance Characterization Research Level Skill

## Overview
This skill enables characterization in the domain of data-governance (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to data-governance. This includes tasks such as:
- predict outcomes
- predict outcomes
- extract features
...
1. The user explicitly requests characterization in the context of data-governance
...
4. The work involves data-governance methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of data-governance principles and methods
...
2. **Methodology**: Follow established data-governance protocols and best practices
...
- Adjacent data-governance skills for comprehensive analysis
...
7. Stay current with data-governance literature and methods

## Version Information
- Complexity Level: research-level
- Domain: data-science
- Subdiscipline: data-governance
