# Geophysics Earth Estimation Research Level Skill

## Overview
This skill enables estimation in the domain of geophysics-earth (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to geophysics-earth. This includes tasks such as:
- map features
- map features
- map features
...
1. The user explicitly requests estimation in the context of geophysics-earth
